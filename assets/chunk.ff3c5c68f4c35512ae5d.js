...
return n}function _(t,e){return Object.prototype.hasOwnProperty.call(t,e)}function C(t,e){return void 0!==t?t:e}function D(t,e){for(var n in t)if(Object.prototype.hasOwnProperty.call(t,n)){var r=Number(n)
...
throw new T(E.INVALID_ARGUMENT,"Invalid value "+f+" provided to function "+t+'() for option "'+n+'". Acceptable values: '+u.join(", "))}(t,0,n,r,i)}function V(t,e,n,i){if(!("object"===e?U(i):"non-empty string"===e?"string"==typeof i&&""!==i:r(i)===e)){var o=B(i)
...
return!0}function X(t){return t+"\0"}function J(){if("undefined"==typeof Uint8Array)throw new T(E.UNIMPLEMENTED,"Uint8Arrays are not available in this environment.")}function Z(){if(!b.getPlatform().base64Available)throw new T(E.UNIMPLEMENTED,"Blobs are unavailable in Firestore in this environment.")}var $,tt=function(){function t(t){Z(),this._binaryString=t}return t.fromBase64String=function(e){R("Blob.fromBase64String",arguments,1),O("Blob.fromBase64String","string",1,e),Z()
try{return new t(b.getPlatform().atob(e))}catch(t){throw new T(E.INVALID_ARGUMENT,"Failed to construct Blob from Base64 string: "+t)}},t.fromUint8Array=function(e){if(R("Blob.fromUint8Array",arguments,1),J(),!(e instanceof Uint8Array))throw j("Blob.fromUint8Array","Uint8Array",1,e)
...
case pt:n+=pt+gt
break
default:n+=o}}return n}function bt(t){return t+pt+yt}function St(t){var e=t.length
...
function Rt(){return kt}function xt(){return Rt()}var Mt=new It(ht.comparator)
function Ot(){return Mt}var Lt=new It(ht.comparator)
...
return t.forEach(function(t,i){r.push(e.call(n,t,i))}),this.waitFor(r)},t}(),jt=function(){function t(t,e,n,r){this.userId=t,this.serializer=e,this.indexManager=n,this.referenceDelegate=r,this.documentKeysByBatchId={}}return t.forUser=function(e,n,r,i){return w(""!==e.uid,"UserID must not be an empty string."),new t(e.isAuthenticated()?e.uid:"",n,r,i)},t.prototype.checkEmpty=function(t){var e=!0,n=IDBKeyRange.bound([this.userId,Number.NEGATIVE_INFINITY],[this.userId,Number.POSITIVE_INFINITY])
...
return Yt(t).iterate({range:i},function(r,i,a){var u=s.__read(r,3),c=u[0],h=u[1],l=u[2],f=St(h)
...
return e.forEach(function(e){var o=Le.prefixForPath(n.userId,e.path),a=IDBKeyRange.lowerBound(o),u=Yt(t).iterate({range:a},function(t,i,o){var a=s.__read(t,3),u=a[0],c=a[1],h=a[2],l=St(c)
...
return Yt(t).iterate({range:a},function(t,e,o){var a=s.__read(t,3),c=a[0],h=a[1],l=a[2],f=St(h)
...
i.push(o)}else r.done()}).next(function(){w(0===i.length,"Document leak -- detected dangling mutation references when queue is empty. Dangling keys: "+i.map(function(t){return t.canonicalString()}))})})},t.prototype.containsKey=function(t,e){return Gt(t,this.userId,e)},t.prototype.getMutationQueueMetadata=function(t){var e=this
...
o[2],u===e&&c===i&&(a=!0),r.done()}).next(function(){return a})}function Wt(t,e,n){var r,i,o=t.store(Oe.store),a=t.store(Le.store),u=[],c=IDBKeyRange.only(n.batchId),h=0,l=o.iterate({range:c},function(t,e,n){return h++,n.delete()})
...
o.push(a.put(_e(f),d)),u=u.add(f),o.push(this.indexManager.addToCollectionParentIndex(t,f.path.popLast()))}}catch(t){r={error:t}}finally{try{h&&!h.done&&(i=c.return)&&i.call(c)}finally{if(r)throw r.error}}this.keepDocumentChangeLog&&o.push(Ie(t).put({changes:this.serializer.toDbResourcePaths(u)})),o.push(this.updateSize(t,n))}return Kt.waitFor(o)},t.prototype.removeEntry=function(t,e){var n=Te(t),r=_e(e)
return n.get(r).next(function(t){return t?n.delete(r).next(function(){return Ce(t)}):Kt.resolve(0)})},t.prototype.getEntry=function(t,e){var n=this
return Te(t).get(_e(e)).next(function(t){return t?n.serializer.fromDbRemoteDocument(t):null})},t.prototype.getSizedEntry=function(t,e){var n=this
return Te(t).get(_e(e)).next(function(t){return t?{maybeDocument:n.serializer.fromDbRemoteDocument(t),size:Ce(t)}:null})},t.prototype.getEntries=function(t,e){var n=this,r=xt()
return this.forEachDbEntry(t,e,function(t,e){r=e?r.insert(t,n.serializer.fromDbRemoteDocument(e)):r.insert(t,null)}).next(function(){return r})},t.prototype.getSizedEntries=function(t,e){var n=this,r=xt(),i=new It(ht.comparator)
...
function Se(t){return pn.getStore(t,Ve.store)}var Ee=function(t){function e(e){var n=t.call(this)||this
...
function Te(t){return pn.getStore(t,Fe.store)}function Ie(t){return pn.getStore(t,We.store)}function _e(t){return t.path.toArray()}function Ce(t){var e
...
w(n<r&&n>=0&&r<=Ae,"Unexpected schema upgrade from v"+n+" to v{toVersion}."),n<1&&r>=1&&(function(t){t.createObjectStore(xe.store)}(t),function(t){t.createObjectStore(Me.store,{keyPath:Me.keyPath}),t.createObjectStore(Oe.store,{keyPath:Oe.keyPath,autoIncrement:!0}).createIndex(Oe.userMutationsIndex,Oe.userMutationsKeyPath,{unique:!0}),t.createObjectStore(Le.store)}(t),je(t),function(t){t.createObjectStore(Fe.store)}(t))
var o=Kt.resolve()
...
return t.store(Fe.store).iterate(function(t,n){e+=Ce(n)}).next(function(){var n=new Ve(e)
return t.store(Ve.store).put(Ve.key,n)})},t.prototype.removeAcknowledgedMutations=function(t){var e=this,n=t.store(Me.store),r=t.store(Oe.store)
...
n.push(St(u.parent))}}catch(t){r={error:t}}finally{try{a&&!a.done&&(i=o.return)&&i.call(o)}finally{if(r)throw r.error}}return n})},t}()
function $e(t){return pn.getStore(t,Ke.store)}!function(t){t[t.Listen=0]="Listen",t[t.ExistenceFilterMismatch=1]="ExistenceFilterMismatch",t[t.LimboResolution=2]="LimboResolution"}(Ge||(Ge={}))
var tn=function(){function t(t,e,n,r,i,o){void 0===i&&(i=Tt.MIN),void 0===o&&(o=S()),this.query=t,this.targetId=e,this.purpose=n,this.sequenceNumber=r,this.snapshotVersion=i,this.resumeToken=o}return t.prototype.copy=function(e){return new t(this.query,this.targetId,this.purpose,void 0===e.sequenceNumber?this.sequenceNumber:e.sequenceNumber,void 0===e.snapshotVersion?this.snapshotVersion:e.snapshotVersion,void 0===e.resumeToken?this.resumeToken:e.resumeToken)},t.prototype.isEqual=function(t){return this.targetId===t.targetId&&this.purpose===t.purpose&&this.sequenceNumber===t.sequenceNumber&&this.snapshotVersion.isEqual(t.snapshotVersion)&&this.resumeToken===t.resumeToken&&this.query.isEqual(t.query)},t}(),en=function(){function t(t){this.remoteSerializer=t}return t.prototype.fromDbRemoteDocument=function(t){if(t.document)return this.remoteSerializer.fromDocument(t.document,!!t.hasCommittedMutations)
...
r=r.add(new ht(St(a)))}}catch(t){e={error:t}}finally{try{o&&!o.done&&(n=i.return)&&n.call(i)}finally{if(e)throw e.error}}return r},t.prototype.fromDbTarget=function(t){var e,n=this.fromDbTimestamp(t.readTime)
return e=void 0!==t.query.documents?this.remoteSerializer.fromDocumentsTarget(t.query):this.remoteSerializer.fromQueryTarget(t.query),new tn(e,t.targetId,Ge.Listen,t.lastListenSequenceNumber,n,t.resumeToken)},t.prototype.toDbTarget=function(t){w(Ge.Listen===t.purpose,"Only queries with purpose "+Ge.Listen+" may be stored, got "+t.purpose)
...
return mn(t).get(xe.key).next(function(t){return Kt.resolve(e.isLocalClient(t))})},t.prototype.removeClientMetadata=function(t){return gn(t).delete(this.clientId)},t.prototype.maybeGarbageCollectMultiClientState=function(){return s.__awaiter(this,void 0,void 0,function(){var e,n,r=this
...
return mn(t).get(xe.key).next(function(n){if(null!==n&&e.isWithinAge(n.leaseTimestampMs,5e3)&&!e.isClientZombied(n.ownerId)){if(e.isLocalClient(n)&&e.networkEnabled)return!0
...
return s.__generator(this,function(e){switch(e.label){case 0:return this._started=!1,this.markClientZombied(),this.clientMetadataRefresher&&this.clientMetadataRefresher.cancel(),this.detachVisibilityHandler(),this.detachWindowUnloadHook(),[4,this.simpleDb.runTransaction("readwrite",[xe.store,ze.store],function(e){return t.releasePrimaryLeaseIfHeld(e).next(function(){return t.removeClientMetadata(e)})})]
...
case 1:return r.sent(),[2]}})})},Object.defineProperty(t.prototype,"started",{get:function(){return this._started},enumerable:!0,configurable:!0}),t.prototype.getMutationQueue=function(t){return w(this.started,"Cannot initialize MutationQueue before persistence is started."),jt.forUser(t,this.serializer,this.indexManager,this.referenceDelegate)},t.prototype.getQueryCache=function(){return w(this.started,"Cannot initialize QueryCache before persistence is started."),this.queryCache},t.prototype.getRemoteDocumentCache=function(){return w(this.started,"Cannot initialize RemoteDocumentCache before persistence is started."),this.remoteDocumentCache},t.prototype.getIndexManager=function(){return w(this.started,"Cannot initialize IndexManager before persistence is started."),this.indexManager},t.prototype.runTransaction=function(t,e,n){var r=this
...
return mn(t).get(xe.key).next(function(t){if(null!==t&&e.isWithinAge(t.leaseTimestampMs,5e3)&&!e.isClientZombied(t.ownerId)&&!e.isLocalClient(t)&&!t.allowTabSynchronization)throw new T(E.FAILED_PRECONDITION,ln)})},t.prototype.acquireOrExtendPrimaryLease=function(t){var e=new xe(this.clientId,this.allowTabSynchronization,Date.now())
return mn(t).put(xe.key,e)},t.isAvailable=function(){return ee.isAvailable()},t.buildStoragePrefix=function(t){var e=t.databaseId.projectId
...
return n.get(xe.key).next(function(t){return e.isLocalClient(t)?(y(cn,"Releasing primary lease."),n.delete(xe.key)):Kt.resolve()})},t.prototype.isWithinAge=function(t,e){var n=Date.now()
...
return y(cn,"Unexpectedly lost primary lease"),[2]})})}function mn(t){return t.store(xe.store)}function gn(t){return t.store(ze.store)}var vn,wn,bn=function(){function t(t,e){this.db=t,this.garbageCollector=new un(this,e)}return t.prototype.getSequenceNumberCount=function(t){var e=this.orphanedDocmentCount(t)
...
return this.forEachOrphanedDocumentSequenceNumber(t,function(t){e++}).next(function(){return e})},t.prototype.forEachTarget=function(t,e){return this.db.getQueryCache().forEachTarget(t,e)},t.prototype.forEachOrphanedDocumentSequenceNumber=function(t,e){return this.forEachOrphanedDocument(t,function(t,n){return e(n)})},t.prototype.setInMemoryPins=function(t){this.inMemoryPins=t},t.prototype.addReference=function(t,e){return Sn(t,e)},t.prototype.removeReference=function(t,e){return Sn(t,e)},t.prototype.removeTargets=function(t,e,n){return this.db.getQueryCache().removeTargets(t,e,n)},t.prototype.removeMutationReference=function(t,e){return Sn(t,e)},t.prototype.isPinned=function(t,e){return this.inMemoryPins.containsKey(e)?Kt.resolve(!0):function(t,e){var n=!1
...
return this.db.getQueryCache().updateQueryData(t,n)},t.prototype.updateLimboDocument=function(t,e){return Sn(t,e)},t.prototype.forEachOrphanedDocument=function(t,e){var n,r=fe(t),i=ot.INVALID
return r.iterate({index:Be.documentTargetsIndex},function(t,r){var o=s.__read(t,2),a=o[0],u=(o[1],r.path),c=r.sequenceNumber
0===a?(i!==ot.INVALID&&e(new ht(St(n)),i),i=c,n=u):i=ot.INVALID}).next(function(){i!==ot.INVALID&&e(new ht(St(n)),i)})},t.prototype.getCacheSize=function(t){return this.db.getRemoteDocumentCache().getSize(t)},t}()
function Sn(t,e){return fe(t).put(function(t,e){return new Be(0,vt(t.path),e)}(e,t.currentSequenceNumber))}!function(t){t[t.NullValue=0]="NullValue",t[t.BooleanValue=1]="BooleanValue",t[t.NumberValue=2]="NumberValue",t[t.TimestampValue=3]="TimestampValue",t[t.StringValue=4]="StringValue",t[t.BlobValue=5]="BlobValue",t[t.RefValue=6]="RefValue",t[t.GeoPointValue=7]="GeoPointValue",t[t.ArrayValue=8]="ArrayValue",t[t.ObjectValue=9]="ObjectValue"}(vn||(vn={})),function(t){t[t.Default=0]="Default",t[t.Estimate=1]="Estimate",t[t.Previous=2]="Previous"}(wn||(wn={}))
var En=function(){function t(t,e){this.serverTimestampBehavior=t,this.timestampsInSnapshots=e}return t.fromSnapshotOptions=function(e,n){switch(e.serverTimestamps){case"estimate":return new t(wn.Estimate,n)
...
var n,r},e}(Tn)
function Dn(t,e){return t===e?0!==t||1/t==1/e:t!=t&&e!=e}var Nn,An=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return s.__extends(e,t),e.prototype.isEqual=function(t){return t instanceof e&&Dn(this.internalValue,t.internalValue)},e}(Cn),kn=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return s.__extends(e,t),e.prototype.isEqual=function(t){return t instanceof e&&Dn(this.internalValue,t.internalValue)},e.NAN=new e(NaN),e.POSITIVE_INFINITY=new e(1/0),e.NEGATIVE_INFINITY=new e(-1/0),e}(Cn),Rn=function(t){function e(e){var n=t.call(this)||this
...
return new pe(this.key,r,this.value,{hasLocalMutations:!0})},e.prototype.extractBaseValue=function(t){return null},e.prototype.isEqual=function(t){return t instanceof e&&this.key.isEqual(t.key)&&this.value.isEqual(t.value)&&this.precondition.isEqual(t.precondition)},e}(Kn),Gn=function(t){function e(e,n,r,i){var o=t.call(this)||this
...
t=null!==r?t.set(n,r):t.delete(n)}}),t},e}(Kn),Wn=function(t){function e(e,n){var r=t.call(this)||this
...
try{for(var o=s.__values(n),a=o.next();!a.done;a=o.next())t=a.value.applyToLocalView(e,t)}catch(t){r={error:t}}finally{try{a&&!a.done&&(i=o.return)&&i.call(o)}finally{if(r)throw r.error}}return t})},t.prototype.applyLocalMutationsToDocuments=function(t,e,n){var r=xt()
...
try{for(var l=s.__values(h.mutations),f=l.next();!f.done;f=l.next()){var d=f.value,p=d.key
if(e.path.isImmediateParentOf(p.path)){var y=n.get(p),m=d.applyToLocalView(y,y,h.localWriteTime)
n=m instanceof pe?n.insert(p,m):n.remove(p)}}}catch(t){o={error:t}}finally{try{f&&!f.done&&(a=l.return)&&a.call(l)}finally{if(o)throw o.error}}}}catch(t){r={error:t}}finally{try{c&&!c.done&&(i=u.return)&&i.call(u)}finally{if(r)throw r.error}}}).next(function(){return n.forEach(function(t,r){e.matches(r)||(n=n.remove(t))}),n})},t}(),Yn=function(){function t(){this.refsByKey=new Nt(Xn.compareByKey),this.refsByTarget=new Nt(Xn.compareByTargetId)}return t.prototype.isEmpty=function(){return this.refsByKey.isEmpty()},t.prototype.addReference=function(t,e){var n=new Xn(t,e)
...
d.push(v.batchId)
try{for(var w=s.__values(v.mutations),b=w.next();!b.done;b=w.next()){var S=b.value
y=y.add(S.key)}}catch(t){a={error:t}}finally{try{b&&!b.done&&(u=w.return)&&u.call(w)}finally{if(a)throw a.error}}}}catch(t){i={error:t}}finally{try{g&&!g.done&&(o=m.return)&&o.call(m)}finally{if(i)throw i.error}}try{for(var E=s.__values(t),T=E.next();!T.done;T=E.next()){v=T.value,p.push(v.batchId)
try{for(var I=s.__values(v.mutations),_=I.next();!_.done;_=I.next())S=_.value,y=y.add(S.key)}catch(t){l={error:t}}finally{try{_&&!_.done&&(f=I.return)&&f.call(I)}finally{if(l)throw l.error}}}}catch(t){c={error:t}}finally{try{T&&!T.done&&(h=E.return)&&h.call(E)}finally{if(c)throw c.error}}return e.localDocuments.getDocuments(n,y).next(function(t){return{affectedDocuments:t,removedBatchIds:d,addedBatchIds:p}})})})},t.prototype.localWrite=function(t){var e=this,n=Et.now(),r=t.reduce(function(t,e){return t.add(e.key)},Ft())
...
null!=f&&u.push(new Gn(l.key,f,f.fieldMask(),Qn.exists(!0)))}}catch(t){o={error:t}}finally{try{h&&!h.done&&(a=c.return)&&a.call(c)}finally{if(o)throw o.error}}return e.mutationQueue.addMutationBatch(i,n,u,t).next(function(t){var e=t.applyToLocalDocumentSet(r)
...
return this.persistence.runTransaction("Get new document changes","readonly",function(e){return t.remoteDocuments.getNewDocumentChanges(e)})},t.RESUME_TOKEN_MAX_AGE_MICROS=3e8,t}(),Zn=function(){function t(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.nextBatchId=1,this.lastStreamToken=S(),this.batchesByDocumentKey=new Nt(Xn.compareByKey)}return t.prototype.checkEmpty=function(t){return Kt.resolve(0===this.mutationQueue.length)},t.prototype.acknowledgeBatch=function(t,e,n){var r=e.batchId,i=this.indexOfExistingBatchId(r,"acknowledged")
...
return Kt.resolve(n?n.maybeDocument:null)},t.prototype.getSizedEntry=function(t,e){return Kt.resolve(this.docs.get(e))},t.prototype.getEntries=function(t,e){var n=this,r=xt()
return e.forEach(function(t){var e=n.docs.get(t)
r=r.insert(t,e?e.maybeDocument:null)}),Kt.resolve(r)},t.prototype.getSizedEntries=function(t,e){var n=this,r=xt(),i=new It(ht.comparator)
return e.forEach(function(t){var e=n.docs.get(t)
...
this.isOpen()&&null===this.idleTimer&&(this.idleTimer=this.queue.enqueueAfterDelay(this.idleTimerId,6e4,function(){return t.handleIdleCloseTimer()}))},t.prototype.sendRequest=function(t){this.cancelIdleCheck(),this.stream.send(t)},t.prototype.handleIdleCloseTimer=function(){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(t){return this.isOpen()?[2,this.close(fr.Initial)]:[2]})})},t.prototype.cancelIdleCheck=function(){this.idleTimer&&(this.idleTimer.cancel(),this.idleTimer=null)},t.prototype.close=function(t,e){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(n){switch(n.label){case 0:return w(this.isStarted(),"Only started streams should be closed."),w(t===fr.Error||hr(e),"Can't provide an error when not in an error state."),this.cancelIdleCheck(),this.backoff.cancel(),this.closeCount++,t!==fr.Error?this.backoff.reset():e&&e.code===E.RESOURCE_EXHAUSTED?(m(e.toString()),m("Using maximum backoff delay to prevent overloading the backend."),this.backoff.resetToMax()):e&&e.code===E.UNAUTHENTICATED&&this.credentialsProvider.invalidateToken(),null!==this.stream&&(this.tearDown(),this.stream.close(),this.stream=null),this.state=t,[4,this.listener.onClose(e)]
...
e.database=this.serializer.encodedDatabaseId,e.removeTarget=t,this.sendRequest(e)},e}(wr),Sr=function(t){function e(e,n,r,i,o){var a=t.call(this,e,$.WriteStreamConnectionBackoff,$.WriteStreamIdle,n,r,o)||this
...
return this.credentials.getToken().then(function(r){return n.connection.invokeStreamingRPC(t,e,r)}).catch(function(t){throw t.code===E.UNAUTHENTICATED&&n.credentials.invalidateToken(),t})},t}(),Tr=function(){function t(t){this.datastore=t,this.readVersions=Pt(),this.mutations=[],this.committed=!1}return t.prototype.recordVersion=function(t){var e
...
return this.datastore.lookup(t).then(function(t){return t.forEach(function(t){t instanceof ye||t instanceof pe?e.recordVersion(t):v("Document in a transaction was a "+t.constructor.name)}),t})},t.prototype.write=function(t){this.ensureCommitNotCalled(),this.mutations=this.mutations.concat(t)},t.prototype.precondition=function(t){var e=this.readVersions.get(t)
...
return e?Qn.updateTime(e):Qn.exists(!0)},t.prototype.set=function(t,e){this.write(e.toMutations(t,this.precondition(t)))},t.prototype.update=function(t,e){try{this.write(e.toMutations(t,this.preconditionForUpdate(t)))}catch(t){this.lastWriteError=t}},t.prototype.delete=function(t){this.write([new zn(t,this.precondition(t))]),this.readVersions=this.readVersions.insert(t,Tt.forDeletedDoc())},t.prototype.commit=function(){var t=this
...
return this.datastore.commit(this.mutations).then(function(){t.committed=!0})},t.prototype.ensureCommitNotCalled=function(){w(!this.committed,"A transaction object cannot be used after its update callback has been invoked.")},t}()
...
var Ir,_r=function(){function t(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state=pr.Unknown,this.watchStreamFailures=0,this.onlineStateTimer=null,this.shouldWarnClientIsOffline=!0}return t.prototype.handleWatchStreamStart=function(){var t=this
...
default:return v("Unknown status code: "+t)}}function Dr(t){if(void 0===t)return m("GRPC error has no .code"),E.UNKNOWN
switch(t){case Ir.OK:return E.OK
case Ir.CANCELLED:return E.CANCELLED
case Ir.UNKNOWN:return E.UNKNOWN
case Ir.DEADLINE_EXCEEDED:return E.DEADLINE_EXCEEDED
case Ir.RESOURCE_EXHAUSTED:return E.RESOURCE_EXHAUSTED
case Ir.INTERNAL:return E.INTERNAL
case Ir.UNAVAILABLE:return E.UNAVAILABLE
case Ir.UNAUTHENTICATED:return E.UNAUTHENTICATED
case Ir.INVALID_ARGUMENT:return E.INVALID_ARGUMENT
case Ir.NOT_FOUND:return E.NOT_FOUND
case Ir.ALREADY_EXISTS:return E.ALREADY_EXISTS
case Ir.PERMISSION_DENIED:return E.PERMISSION_DENIED
case Ir.FAILED_PRECONDITION:return E.FAILED_PRECONDITION
case Ir.ABORTED:return E.ABORTED
case Ir.OUT_OF_RANGE:return E.OUT_OF_RANGE
case Ir.UNIMPLEMENTED:return E.UNIMPLEMENTED
case Ir.DATA_LOSS:return E.DATA_LOSS
default:return v("Unknown status code: "+t)}}function Nr(t){if(void 0===t)return Ir.OK
switch(t){case E.OK:return Ir.OK
case E.CANCELLED:return Ir.CANCELLED
case E.UNKNOWN:return Ir.UNKNOWN
case E.DEADLINE_EXCEEDED:return Ir.DEADLINE_EXCEEDED
case E.RESOURCE_EXHAUSTED:return Ir.RESOURCE_EXHAUSTED
case E.INTERNAL:return Ir.INTERNAL
case E.UNAVAILABLE:return Ir.UNAVAILABLE
case E.UNAUTHENTICATED:return Ir.UNAUTHENTICATED
case E.INVALID_ARGUMENT:return Ir.INVALID_ARGUMENT
case E.NOT_FOUND:return Ir.NOT_FOUND
case E.ALREADY_EXISTS:return Ir.ALREADY_EXISTS
case E.PERMISSION_DENIED:return Ir.PERMISSION_DENIED
case E.FAILED_PRECONDITION:return Ir.FAILED_PRECONDITION
case E.ABORTED:return Ir.ABORTED
case E.OUT_OF_RANGE:return Ir.OUT_OF_RANGE
case E.UNIMPLEMENTED:return Ir.UNIMPLEMENTED
case E.DATA_LOSS:return Ir.DATA_LOSS
...
var xr,Mr=function(){function t(){this.changeMap=new It(ht.comparator)}return t.prototype.track=function(t){var e=t.doc.key,n=this.changeMap.get(e)
...
return new t(Tt.MIN,i,Ut(),Rt(),Ft())},t}(),Pr=function(){function t(t,e,n,r,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}return t.createSynthesizedTargetChangeForCurrentChange=function(e,n){return new t(S(),n,Ft(),Ft(),Ft())},t}(),qr=function(t,e,n,r){this.updatedTargetIds=t,this.removedTargetIds=e,this.key=n,this.newDoc=r},Fr=function(t,e){this.targetId=t,this.existenceFilter=e}
!function(t){t[t.NoChange=0]="NoChange",t[t.Added=1]="Added",t[t.Removed=2]="Removed",t[t.Current=3]="Current",t[t.Reset=4]="Reset"}(xr||(xr={}))
var Vr=function(t,e,n,r){void 0===n&&(n=S()),void 0===r&&(r=null),this.state=t,this.targetIds=e,this.resumeToken=n,this.cause=r},Ur=function(){function t(){this.pendingResponses=0,this.documentChanges=Kr(),this._resumeToken=S(),this._current=!1,this._hasPendingChanges=!0}return Object.defineProperty(t.prototype,"current",{get:function(){return this._current},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"resumeToken",{get:function(){return this._resumeToken},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"isPending",{get:function(){return 0!==this.pendingResponses},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"hasPendingChanges",{get:function(){return this._hasPendingChanges},enumerable:!0,configurable:!0}),t.prototype.updateResumeToken=function(t){t.length>0&&(this._hasPendingChanges=!0,this._resumeToken=t)},t.prototype.toTargetChange=function(){var t=Ft(),e=Ft(),n=Ft()
...
switch(t.state){case xr.NoChange:e.isActiveTarget(n)&&r.updateResumeToken(t.resumeToken)
break
case xr.Added:r.recordTargetResponse(),r.isPending||r.clearPendingChanges(),r.updateResumeToken(t.resumeToken)
break
case xr.Removed:r.recordTargetResponse(),r.isPending||e.removeTarget(n),w(!t.cause,"WatchChangeAggregator does not handle errored targets")
break
case xr.Current:e.isActiveTarget(n)&&(r.markCurrent(),r.updateResumeToken(t.resumeToken))
break
case xr.Reset:e.isActiveTarget(n)&&(e.resetTarget(n),r.updateResumeToken(t.resumeToken))
break
...
function Qr(){return new It(ht.comparator)}function Kr(){return new It(ht.comparator)}var jr="RemoteStore",Gr=function(){function t(t,e,n,r,i){var o=this
this.localStore=t,this.datastore=e,this.writePipeline=[],this.listenTargets={},this.watchChangeAggregator=null,this.networkEnabled=!1,this.isPrimary=!1,this.connectivityMonitor=i,this.connectivityMonitor.addCallback(function(t){n.enqueueAndForget(function(){return s.__awaiter(o,void 0,void 0,function(){return s.__generator(this,function(t){switch(t.label){case 0:return this.canUseNetwork()?(y(jr,"Restarting streams for network reachability change."),[4,this.restartNetwork()]):[3,2]
case 1:t.sent(),t.label=2
...
var r=new tn(n.query,t,Ge.ExistenceFilterMismatch,n.sequenceNumber)
...
return t.targetIds.forEach(function(t){r=r.then(function(){return s.__awaiter(e,void 0,void 0,function(){return s.__generator(this,function(e){return _(this.listenTargets,t)?(delete this.listenTargets[t],this.watchChangeAggregator.removeTarget(t),[2,this.syncEngine.rejectListen(t,n)]):[2]})})})}),r},t.prototype.fillWritePipeline=function(){return s.__awaiter(this,void 0,void 0,function(){var t,e
...
return s.__generator(this,function(n){return void 0===t&&w(!this.shouldStartWriteStream(),"Write stream was stopped gracefully while still needed."),t&&this.writePipeline.length>0?[2,(this.writeStream.handshakeComplete?this.handleWriteError(t):this.handleHandshakeError(t)).then(function(){e.shouldStartWriteStream()&&e.startWriteStream()})]:[2]})})},t.prototype.handleHandshakeError=function(t){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(e){return Cr(t.code)?(y(jr,"RemoteStore error before completed handshake; resetting stream token: ",this.writeStream.lastStreamToken),this.writeStream.lastStreamToken=S(),[2,this.localStore.setLastStreamToken(S()).catch(yn)]):[2]})})},t.prototype.handleWriteError=function(t){return s.__awaiter(this,void 0,void 0,function(){var e,n=this
...
case 2:return t.sent(),[2]}})})},t.prototype.handleCredentialChange=function(){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(t){switch(t.label){case 0:return this.canUseNetwork()?(y(jr,"RemoteStore restarting streams for new credential"),[4,this.restartNetwork()]):[3,2]
case 1:t.sent(),t.label=2
...
case 4:return[2]}})})},t}(),Wr=function(){function t(t,e){if(R("GeoPoint",arguments,2),O("GeoPoint","number",1,t),O("GeoPoint","number",2,e),!isFinite(t)||t<-90||t>90)throw new T(E.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t)
...
if(r.isEqual(In.INSTANCE)){if(n!==Yr.EQUAL)throw new T(E.INVALID_ARGUMENT,"Invalid query. You can only perform equals comparisons on null.")
return new e(t,n,r)}if(r.isEqual(kn.NAN)){if(n!==Yr.EQUAL)throw new T(E.INVALID_ARGUMENT,"Invalid query. You can only perform equals comparisons on NaN.")
...
return new An(r)}return r=n.internalValue+this.operand.internalValue,new kn(r)},t.prototype.applyToRemoteDocument=function(t,e){return w(null!==e,"Didn't receive transformResult for NUMERIC_ADD transform"),e},t.prototype.computeBaseValue=function(t){return t instanceof Cn?t:new An(0)},t.prototype.isEqual=function(e){return e instanceof t&&this.operand.isEqual(e.operand)},t}()
...
function vi(t,e){w(!hr(t),e+" is missing")}function wi(t){return"number"==typeof t?t:"string"==typeof t?Number(t):v("can't parse "+t)}var bi=function(){function t(t,e){this.databaseId=t,this.options=e}return t.prototype.emptyByteString=function(){return this.options.useProto3Json?"":new Uint8Array(0)},t.prototype.unsafeCastProtoByteString=function(t){return t},t.prototype.fromRpcStatus=function(t){var e=void 0===t.code?E.UNKNOWN:Dr(t.code)
...
if(t instanceof _n)return{booleanValue:t.value()}
...
if(e===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:t.value()}}return t instanceof Rn?{stringValue:t.value()}:t instanceof qn?{mapValue:this.toMapValue(t)}:t instanceof Fn?{arrayValue:this.toArrayValue(t)}:t instanceof xn?{timestampValue:this.toTimestamp(t.internalValue)}:t instanceof Pn?{geoPointValue:{latitude:t.value().latitude,longitude:t.value().longitude}}:t instanceof On?{bytesValue:this.toBytes(t.value())}:t instanceof Ln?{referenceValue:this.toResourceName(t.databaseId,t.key.path)}:v("Unknown FieldValue "+JSON.stringify(t))},t.prototype.fromValue=function(t){var e=this
if("nullValue"in t)return In.INSTANCE
if("booleanValue"in t)return _n.of(t.booleanValue)
...
return new Fn(n.map(function(t){return e.fromValue(t)}))}if("timestampValue"in t)return vi(t.timestampValue,"timestampValue"),new xn(this.fromTimestamp(t.timestampValue))
if("geoPointValue"in t){vi(t.geoPointValue,"geoPointValue")
var r=t.geoPointValue.latitude||0,i=t.geoPointValue.longitude||0
return new Pn(new Wr(r,i))}if("bytesValue"in t){vi(t.bytesValue,"bytesValue")
...
return new ye(e,n)},t.prototype.fromMaybeDocument=function(t){return"found"in t?this.fromFound(t):"missing"in t?this.fromMissing(t):v("invalid batch get response: "+JSON.stringify(t))},t.prototype.toWatchTargetChangeState=function(t){switch(t){case xr.Added:return"ADD"
case xr.Current:return"CURRENT"
case xr.NoChange:return"NO_CHANGE"
case xr.Removed:return"REMOVE"
case xr.Reset:return"RESET"
...
e=new Fr(b,w)}return e},t.prototype.fromWatchTargetChangeState=function(t){return"NO_CHANGE"===t?xr.NoChange:"ADD"===t?xr.Added:"REMOVE"===t?xr.Removed:"CURRENT"===t?xr.Current:"RESET"===t?xr.Reset:v("Got unexpected TargetChange.state: "+t)},t.prototype.versionFromListenResponse=function(t){if(!("targetChange"in t))return Tt.MIN
...
if(t instanceof jn)e={update:this.toMutationDocument(t.key,t.value)}
else if(t instanceof zn)e={delete:this.toName(t.key)}
else if(t instanceof Gn)e={update:this.toMutationDocument(t.key,t.data),updateMask:this.toDocumentMask(t.fieldMask)}
...
return new Gn(r,i,o,n)}return new jn(r,i,n)}if(t.delete)return r=this.fromName(t.delete),new zn(r,n)
...
w(i instanceof Cn,"NUMERIC_ADD transform requires a NumberValue"),n=new hi(i)}else v("Unknown transform proto: "+JSON.stringify(t))
...
return Vn.fromArray(e)},t}(),Si=function(){this.listeners=[]},Ei=function(){function t(t){this.syncEngine=t,this.queries=new ge(function(t){return t.canonicalId()}),this.onlineState=pr.Unknown,this.syncEngine.subscribe(this)}return t.prototype.listen=function(t){var e=t.query,n=!1,r=this.queries.get(e)
return r||(n=!0,r=new Si,this.queries.set(e,r)),r.listeners.push(t),t.applyOnlineStateChange(this.onlineState),r.viewSnap&&t.onViewSnapshot(r.viewSnap),n?this.syncEngine.listen(e).then(function(t){return r.targetId=t,t}):Promise.resolve(r.targetId)},t.prototype.unlisten=function(t){return s.__awaiter(this,void 0,void 0,function(){var e,n,r,i
...
break
case Ar.Removed:a=a.add(h.doc.key)}}}catch(t){r={error:t}}finally{try{c&&!c.done&&(i=u.return)&&i.call(u)}finally{if(r)throw r.error}}return new t(e,o,a)},t}(),_i=function(t){this.key=t},Ci=function(t){this.key=t},Di=function(){function t(t,e){this.query=t,this._syncedDocuments=e,this.syncState=null,this.current=!1,this.limboDocuments=Ft(),this.mutatedKeys=Ft(),this.documentSet=new Rr(t.docComparator.bind(t))}return Object.defineProperty(t.prototype,"syncedDocuments",{get:function(){return this._syncedDocuments},enumerable:!0,configurable:!0}),t.prototype.computeDocChanges=function(t,e){var n=this,r=e?e.changeSet:new Mr,i=e?e.documentSet:this.documentSet,o=e?e.mutatedKeys:this.mutatedKeys,a=i,s=!1,u=this.query.hasLimit()&&i.size===this.query.limit?i.last():null
...
return this.syncState=s,0!==o.length||u?{snapshot:new Or(this.query,t.documentSet,i,o,t.mutatedKeys,s===kr.Local,u,!1),limboChanges:a}:{limboChanges:a}},t.prototype.applyOnlineStateChange=function(t){return this.current&&t===pr.Offline?(this.current=!1,this.applyChanges({documentSet:this.documentSet,changeSet:new Mr,mutatedKeys:this.mutatedKeys,needsRefill:!1},!1)):{limboChanges:[]}},t.prototype.shouldBeInLimbo=function(t){return!this._syncedDocuments.has(t)&&!!this.documentSet.has(t)&&!this.documentSet.get(t).hasLocalMutations},t.prototype.applyTargetChange=function(t){var e=this
...
var n=[]
return e.forEach(function(e){t.limboDocuments.has(e)||n.push(new Ci(e))}),this.limboDocuments.forEach(function(t){e.has(t)||n.push(new _i(t))}),n},t.prototype.synchronizeWithPersistedState=function(t,e){this._syncedDocuments=e,this.limboDocuments=Ft()
...
this.limboResolutionsByTarget[n]=new Ai(e),this.remoteStore.listen(new tn(r,n,Ge.LimboResolution,ot.INVALID)),this.limboTargetsByKey=this.limboTargetsByKey.insert(e,n)}},t.prototype.currentLimboDocs=function(){return this.limboTargetsByKey},t.prototype.emitNewSnapsAndNotifyLocalStore=function(t,e){return s.__awaiter(this,void 0,void 0,function(){var n,r,i,o=this
...
case 3:return!1!==t||!1===this.isPrimary?[3,7]:(this.isPrimary=!1,c=[],h=Promise.resolve(),D(this.queryViewsByTarget,function(t,e){l.sharedClientState.isLocalQueryTarget(t)?c.push(t):h=h.then(function(){return l.unlisten(e.query)}),l.remoteStore.unlisten(e.targetId)}),[4,h])
...
return s.__generator(this,function(n){switch(n.label){case 0:return function(t){return t.code===E.DATA_LOSS&&t.message===we}(t)?(e=[],D(this.queryViewsByTarget,function(t){return e.push(t)}),[4,this.synchronizeQueryViewsAndRaiseSnapshots(e)]):[3,2]
...
case 2:return u.done?[3,7]:(m=u.value,w(!this.queryViewsByTarget[m],"Trying to add an already active target"),[4,this.localStore.getQueryForTarget(m)])
case 3:return w(!!(c=b.sent()),"Query data for active target "+m+" not found"),[4,this.localStore.allocateQuery(c)]
...
return s.__generator(this,function(n){switch(n.label){case 0:return(e=d.queryViewsByTarget[t])?[4,d.localStore.releaseQuery(e.query,!1).then(function(){v.remoteStore.unlisten(t),v.removeAndCleanupQuery(e)}).catch(yn)]:[3,2]
case 1:n.sent(),n.label=2
case 2:return[2]}})},d=this,b.label=11
case 11:b.trys.push([11,16,17,18]),p=s.__values(e),y=p.next(),b.label=12
case 12:return y.done?[3,15]:(m=y.value,[5,f(m)])
case 13:b.sent(),b.label=14
case 14:return y=p.next(),[3,12]
case 15:return[3,18]
case 16:return g=b.sent(),i={error:g},[3,18]
case 17:try{y&&!y.done&&(o=p.return)&&o.call(p)}finally{if(i)throw i.error}return[7]
...
return e&&e.receivedDocument?Ft().add(e.key):this.queryViewsByTarget[t]?this.queryViewsByTarget[t].view.syncedDocuments:Ft()},t}(),Ri=function(){function t(t){this.uid=t}return t.prototype.isAuthenticated=function(){return null!=this.uid},t.prototype.toKey=function(){return this.isAuthenticated()?"uid:"+this.uid:"anonymous-user"},t.prototype.isEqual=function(t){return t.uid===this.uid},t.UNAUTHENTICATED=new t(null),t.GOOGLE_CREDENTIALS=new t("google-credentials-uid"),t.FIRST_PARTY=new t("first-party-uid"),t}(),xi="SharedClientState",Mi="firestore_clients",Oi="firestore_mutations",Li="firestore_targets",Pi="firestore_online_state",qi="firestore_sequence_number",Fi=function(){function t(t,e,n,r){this.user=t,this.batchId=e,this.state=n,this.error=r,w(void 0!==r==("rejected"===n),"MutationMetadata must contain an error iff state is 'rejected'")}return t.fromWebStorageEntry=function(e,n,i){var o=JSON.parse(i),a="object"===r(o)&&-1!==["pending","acknowledged","rejected"].indexOf(o.state)&&(void 0===o.error||"object"===r(o.error)),s=void 0
return a&&o.error&&(a="string"==typeof o.error.message&&"string"==typeof o.error.code)&&(s=new T(o.error.code,o.error.message)),a?new t(e,n,o.state,s):(m(xi,"Failed to parse mutation state for ID '"+n+"': "+i),null)},t.prototype.toWebStorageJSON=function(){var t={state:this.state,updateTimeMs:Date.now()}
...
return o&&i.error&&(o="string"==typeof i.error.message&&"string"==typeof i.error.code)&&(a=new T(i.error.code,i.error.message)),o?new t(e,i.state,a):(m(xi,"Failed to parse target state for ID '"+e+"': "+n),null)},t.prototype.toWebStorageJSON=function(){var t={state:this.state,updateTimeMs:Date.now()}
...
case 1:i=g.sent()
try{for(o=s.__values(i),a=o.next();!a.done;a=o.next())(u=a.value)!==this.localClientId&&(c=this.getItem(this.toWebStorageClientStateKey(u)))&&(h=Ui.fromWebStorageEntry(u,c))&&(this.activeClients[h.clientId]=h)}catch(e){t={error:e}}finally{try{a&&!a.done&&(e=o.return)&&e.call(o)}finally{if(t)throw t.error}}this.persistClientState(),(l=this.storage.getItem(this.onlineStateKey))&&(f=this.fromWebStorageOnlineState(l))&&this.handleOnlineStateEvent(f)
try{for(d=s.__values(this.earlyEvents),p=d.next();!p.done;p=d.next())y=p.value,this.handleWebStorageEvent(y)}catch(t){n={error:t}}finally{try{p&&!p.done&&(r=d.return)&&r.call(d)}finally{if(n)throw n.error}}return this.earlyEvents=[],this.platform.window.addEventListener("unload",function(){return m.shutdown()}),this.started=!0,[2]}})})},t.prototype.writeSequenceNumber=function(t){this.setItem(this.sequenceNumberKey,JSON.stringify(t))},t.prototype.getAllActiveQueryTargets=function(){var t=Ut()
...
return y(xi,"READ",t,e),e},t.prototype.setItem=function(t,e){y(xi,"SET",t,e),this.storage.setItem(t,e)},t.prototype.removeItem=function(t){y(xi,"REMOVE",t),this.storage.removeItem(t)},t.prototype.handleWebStorageEvent=function(t){var e=this
if(t.storageArea===this.storage){if(y(xi,"EVENT",t.key,t.newValue),t.key===this.localClientStorageKey)return void m("Received WebStorage notification for local change. Another client might have garbage-collected our state")
...
w("number"==typeof n,"Found non-numeric sequence number"),e=n}catch(t){m(xi,"Failed to read sequence number from WebStorage",t)}return e}(t.newValue))!==ot.INVALID&&this.sequenceNumberHandler(a))
...
this.setItem(r,i.toWebStorageJSON())},t.prototype.toWebStorageClientStateKey=function(t){return w(-1===t.indexOf("_"),"Client key cannot contain '_', but was '"+t+"'"),Mi+"_"+this.persistenceKey+"_"+t},t.prototype.toWebStorageQueryTargetMetadataKey=function(t){return Li+"_"+this.persistenceKey+"_"+t},t.prototype.toWebStorageMutationBatchKey=function(t){var e=Oi+"_"+this.persistenceKey+"_"+t
...
return t instanceof Gi?this.startIndexedDbPersistence(n,t).then(function(t){return e.resolve(),t}).catch(function(t){if(e.reject(t),!r.canFallback(t))throw t
return console.warn("Error enabling offline persistence. Falling back to persistence disabled: "+t),r.startMemoryPersistence()}):(e.resolve(),this.startMemoryPersistence())},t.prototype.canFallback=function(t){return t instanceof T?t.code===E.FAILED_PRECONDITION||t.code===E.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&t instanceof DOMException)||22===t.code||20===t.code||11===t.code},t.prototype.verifyNotShutdown=function(){if(this._clientShutdown)throw new T(E.FAILED_PRECONDITION,"The client has already been shutdown.")},t.prototype.startIndexedDbPersistence=function(t,e){var n=this,r=pn.buildStoragePrefix(this.databaseInfo),i=new bi(this.databaseInfo.databaseId,{useProto3Json:!0})
return Promise.resolve().then(function(){return s.__awaiter(n,void 0,void 0,function(){var n,o
return s.__generator(this,function(a){switch(a.label){case 0:if(e.synchronizeTabs&&!Ki.isAvailable(this.platform))throw new T(E.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.")
...
case 2:return this.sharedClientState=new ji,[4,pn.createIndexedDbPersistence(r,this.clientId,this.platform,this.asyncQueue,i,o)]
case 3:n=a.sent(),a.label=4
case 4:return this.persistence=n,[2,n.referenceDelegate.garbageCollector]}})})})},t.prototype.startMemoryPersistence=function(){return this.persistence=nr.createEagerPersistence(this.clientId),this.sharedClientState=new ji,Promise.resolve(null)},t.prototype.initializeRest=function(t,e){var n=this
...
for(var n=0;n<t.length;++n)if(O("FieldPath","string",n,t[n]),0===t[n].length)throw new T(E.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.")
...
return null!==this.fieldMask?n.push(new Gn(t,this.data,this.fieldMask,e)):n.push(new jn(t,this.data,e)),this.fieldTransforms.length>0&&n.push(new Wn(t,this.fieldTransforms)),n},t}(),po=function(){function t(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}return t.prototype.toMutations=function(t,e){var n=[new Gn(t,this.data,this.fieldMask,e)]
...
p=Eo(t,d)}if(!o.contains(p))throw new T(E.INVALID_ARGUMENT,"Field '"+p+"' is specified in your field mask but missing from your input data.")
...
N(e,function(e,a){var s=Eo(t,e),u=r.childContextForFieldPath(s)
if((a=n.runPreConverter(a,u))instanceof oo)i=i.add(s)
else{var c=n.parseData(a,u)
null!=c&&(i=i.add(s),o=o.set(s,c))}})
var a=Vn.fromSet(i)
return new po(o,a,r.fieldTransforms)},t.prototype.parseUpdateVarargs=function(t,e,n,r){var i=new mo(ro.Update,t,ct.EMPTY_PATH),o=[So(t,e)],a=[n]
...
for(var s=0;s<r.length;s+=2)o.push(So(t,r[s])),a.push(r[s+1])
...
if("boolean"==typeof t)return _n.of(t)
if("string"==typeof t)return new Rn(t)
if(t instanceof Date)return new xn(Et.fromDate(t))
if(t instanceof Et)return new xn(new Et(t.seconds,1e3*Math.floor(t.nanoseconds/1e3)))
...
function wo(t){return!("object"!==r(t)||null===t||t instanceof Array||t instanceof Date||t instanceof Et||t instanceof Wr||t instanceof tt||t instanceof go||t instanceof io)}function bo(t,e,n){if(!wo(n)||!U(n)){var r=B(n)
throw"an object"===r?e.createError(t+" a custom object"):e.createError(t+" "+r)}}function So(t,e){if(e instanceof Yi)return e._internalPath
...
i.databaseId=new it(a.projectId,a.database),i.persistenceKey="[DEFAULT]",i.credentials=new Zi}i.settings=new Ao({}),this._config=i,this._databaseId=i.databaseId}return t.prototype.settings=function(t){if(R("Firestore.settings",arguments,1),O("Firestore.settings","object",1,t),_(t,"persistence"))throw new T(E.INVALID_ARGUMENT,'"persistence" is now specified with a separate call to firestore.enablePersistence().')
var e=new Ao(t)
...
var e=!1
return t&&(void 0!==t.experimentalTabSynchronization&&m("The 'experimentalTabSynchronization' setting has been renamed to 'synchronizeTabs'. In a future release, the setting will be removed and it is recommended that you update your firestore.enablePersistence() call to use 'synchronizeTabs'."),e=C(void 0!==t.synchronizeTabs?t.synchronizeTabs:t.experimentalTabSynchronization,!1)),this.configureClient(new Gi(this._config.settings.cacheSizeBytes,e))},t.prototype.clearPersistence=function(){var t=this,e=pn.buildStoragePrefix(this.makeDatabaseInfo()),n=new lt
...
case 3:return[2]}})})}),n.promise},t.prototype.ensureClientConfigured=function(){return this._firestoreClient||this.configureClient(new Wi),this._firestoreClient},t.prototype.makeDatabaseInfo=function(){return new nt(this._config.databaseId,this._config.persistenceKey,this._config.settings.host,this._config.settings.ssl,this._config.settings.forceLongPolling)},t.prototype.configureClient=function(t){var e=this
...
if(!_(e,"projectId"))throw new T(E.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.')
var n=e.projectId
...
break
default:throw new T(E.INVALID_ARGUMENT,"Invalid log level: "+t)}},t.prototype._areTimestampsInSnapshotsEnabled=function(){return this._config.settings.timestampsInSnapshots},t}(),xo=function(){function t(t,e){this._firestore=t,this._transaction=e}return t.prototype.get=function(t){var e=this
R("Transaction.get",arguments,1)
var n=jo("Transaction.get",t,this._firestore)
...
throw v("BatchGetDocumentsRequest returned unexpected document type: "+r.constructor.name)})},t.prototype.set=function(t,e,n){M("Transaction.set",arguments,2,3)
var r=jo("Transaction.set",t,this._firestore),i=(n=Bo("Transaction.set",n)).merge||n.mergeFields?this._firestore._dataConverter.parseMergeData("Transaction.set",e,n.mergeFields):this._firestore._dataConverter.parseSetData("Transaction.set",e)
...
return"string"==typeof e||e instanceof Yi?(x("Transaction.update",arguments,3),r=jo("Transaction.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateVarargs("Transaction.update",e,n,o)):(R("Transaction.update",arguments,2),r=jo("Transaction.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateData("Transaction.update",e)),this._transaction.update(r._key,i),this},t.prototype.delete=function(t){R("Transaction.delete",arguments,1)
var e=jo("Transaction.delete",t,this._firestore)
return this._transaction.delete(e._key),this},t}(),Mo=function(){function t(t){this._firestore=t,this._mutations=[],this._committed=!1}return t.prototype.set=function(t,e,n){M("WriteBatch.set",arguments,2,3),this.verifyNotCommitted()
var r=jo("WriteBatch.set",t,this._firestore),i=(n=Bo("WriteBatch.set",n)).merge||n.mergeFields?this._firestore._dataConverter.parseMergeData("WriteBatch.set",e,n.mergeFields):this._firestore._dataConverter.parseSetData("WriteBatch.set",e)
...
return this.verifyNotCommitted(),"string"==typeof e||e instanceof Yi?(x("WriteBatch.update",arguments,3),r=jo("WriteBatch.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateVarargs("WriteBatch.update",e,n,o)):(R("WriteBatch.update",arguments,2),r=jo("WriteBatch.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateData("WriteBatch.update",e)),this._mutations=this._mutations.concat(i.toMutations(r._key,Qn.exists(!0))),this},t.prototype.delete=function(t){R("WriteBatch.delete",arguments,1),this.verifyNotCommitted()
var e=jo("WriteBatch.delete",t,this._firestore)
return this._mutations=this._mutations.concat(new zn(e._key,Qn.NONE)),this},t.prototype.commit=function(){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(t){return this.verifyNotCommitted(),this._committed=!0,this._mutations.length>0?[2,this._firestore.ensureClientConfigured().write(this._mutations)]:[2]})})},t.prototype.verifyNotCommitted=function(){if(this._committed)throw new T(E.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")},t}(),Oo=function(){function t(t,e){this._key=t,this.firestore=e,this._firestoreClient=this.firestore.ensureClientConfigured()}return t.forPath=function(e,n){if(e.length%2!=0)throw new T(E.INVALID_ARGUMENT,"Invalid document reference. Document references must have an even number of segments, but "+e.canonicalString()+" has "+e.length)
return new t(new ht(e),n)},Object.defineProperty(t.prototype,"id",{get:function(){return this._key.path.lastSegment()},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"parent",{get:function(){return new Uo(this._key.path.popLast(),this.firestore)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"path",{get:function(){return this._key.path.canonicalString()},enumerable:!0,configurable:!0}),t.prototype.collection=function(t){if(R("DocumentReference.collection",arguments,1),O("DocumentReference.collection","non-empty string",1,t),!t)throw new T(E.INVALID_ARGUMENT,"Must provide a non-empty collection name to collection()")
var e=st.fromString(t)
return new Uo(this._key.path.child(e),this.firestore)},t.prototype.isEqual=function(e){if(!(e instanceof t))throw j("isEqual","DocumentReference",1,e)
return this.firestore===e.firestore&&this._key.isEqual(e._key)},t.prototype.set=function(t,e){M("DocumentReference.set",arguments,1,2)
...
return"string"==typeof t||t instanceof Yi?(x("DocumentReference.update",arguments,2),n=this.firestore._dataConverter.parseUpdateVarargs("DocumentReference.update",t,e,r)):(R("DocumentReference.update",arguments,1),n=this.firestore._dataConverter.parseUpdateData("DocumentReference.update",t)),this._firestoreClient.write(n.toMutations(this._key,Qn.exists(!0)))},t.prototype.delete=function(){return R("DocumentReference.delete",arguments,0),this._firestoreClient.write([new zn(this._key,Qn.NONE)])},t.prototype.onSnapshot=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
...
return M("DocumentReference.get",arguments,0,1),Ko("DocumentReference.get",t),new Promise(function(n,r){t&&"cache"===t.source?e.firestore.ensureClientConfigured().getDocumentFromLocalCache(e._key).then(function(t){n(new Po(e.firestore,e._key,t,!0,t instanceof pe&&t.hasLocalMutations))},r):e.getViaSnapshotListener(n,r,t)})},t.prototype.getViaSnapshotListener=function(t,e,n){var r=this.onSnapshotInternal({includeMetadataChanges:!0,waitForSyncWhenOnline:!0},{next:function(i){r(),!i.exists&&i.metadata.fromCache?e(new T(E.UNAVAILABLE,"Failed to get document because the client is offline.")):i.exists&&i.metadata.fromCache&&n&&"server"===n.source?e(new T(E.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):t(i)},error:e})},t}(),Lo=function(){function t(t,e){this.hasPendingWrites=t,this.fromCache=e}return t.prototype.isEqual=function(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache},t}(),Po=function(){function t(t,e,n,r,i){this._firestore=t,this._key=e,this._document=n,this._fromCache=r,this._hasPendingWrites=i}return t.prototype.data=function(t){return M("DocumentSnapshot.data",arguments,0,1),t=Qo("DocumentSnapshot.data",t),this._document?this.convertObject(this._document.data,En.fromSnapshotOptions(t,this._firestore._areTimestampsInSnapshotsEnabled())):void 0},t.prototype.get=function(t,e){if(M("DocumentSnapshot.get",arguments,1,2),e=Qo("DocumentSnapshot.get",e),this._document){var n=this._document.data.field(So("DocumentSnapshot.get",t))
if(null!==n)return this.convertValue(n,En.fromSnapshotOptions(e,this._firestore._areTimestampsInSnapshotsEnabled()))}},Object.defineProperty(t.prototype,"id",{get:function(){return this._key.path.lastSegment()},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"ref",{get:function(){return new Oo(this._key,this._firestore)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"exists",{get:function(){return null!==this._document},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"metadata",{get:function(){return new Lo(this._hasPendingWrites,this._fromCache)},enumerable:!0,configurable:!0}),t.prototype.isEqual=function(e){if(!(e instanceof t))throw j("isEqual","DocumentSnapshot",1,e)
...
R("Query.where",arguments,3),Q("Query.where",3,r),"in"!==n&&"array-contains-any"!==n&&function(t,e,n,r){if(!e.some(function(t){return t===r}))throw new T(E.INVALID_ARGUMENT,"Invalid value "+B(r)+" provided to function Query.where() for its "+G(2)+" argument. Acceptable values: "+e.join(", "))}(0,["<","<=","==",">=",">","array-contains"],0,n)
var u=So("Query.where",e),c=Yr.fromString(n)
...
if(M("Query.orderBy",arguments,1,2),L("Query.orderBy","non-empty string",2,n),void 0===n||"asc"===n)r=ni.ASCENDING
...
var i=So("Query.orderBy",e),o=new ii(i,r)
return this.validateNewOrderBy(o),new t(this._query.addOrderBy(o),this.firestore)},t.prototype.limit=function(e){if(R("Query.limit",arguments,1),O("Query.limit","number",1,e),e<=0)throw new T(E.INVALID_ARGUMENT,"Invalid Query. Query limit ("+e+") is invalid. Limit must be positive.")
...
return this.firestore===e.firestore&&this._query.isEqual(e._query)},t.prototype.boundFromDocOrFields=function(t,e,n,r){if(Q(t,1,e),e instanceof Po){if(n.length>0)throw new T(E.INVALID_ARGUMENT,"Too many arguments provided to "+t+"().")
var i=e
...
if(h instanceof Mn)throw new T(E.INVALID_ARGUMENT,'Invalid query. You are trying to start or end a query using a document for which the field "'+c.field+'" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)')
...
M("QuerySnapshot.forEach",arguments,1,2),O("QuerySnapshot.forEach","function",1,t),this._snapshot.docs.forEach(function(r){t.call(e,n.convertToDocumentImpl(r))})},Object.defineProperty(t.prototype,"query",{get:function(){return new Fo(this._originalQuery,this._firestore)},enumerable:!0,configurable:!0}),t.prototype.docChanges=function(t){t&&(K("QuerySnapshot.docChanges",t,["includeMetadataChanges"]),q("QuerySnapshot.docChanges","boolean","includeMetadataChanges",t.includeMetadataChanges))
...
s.__spread(["length","forEach","map"],"undefined"!=typeof Symbol?[Symbol.iterator]:[]).forEach(function(t){try{Object.defineProperty(Vo.prototype.docChanges,t,{get:function(){return function(){throw new T(E.INVALID_ARGUMENT,'QuerySnapshot.docChanges has been changed from a property into a method, so usages like "querySnapshot.docChanges" should become "querySnapshot.docChanges()"')}()}})}catch(t){}})
...
return e}function Qo(t,e){return void 0===e?{}:(K(t,e,["serverTimestamps"]),F(t,0,"serverTimestamps",e.serverTimestamps,["estimate","previous","none"]),e)}function Ko(t,e){L(t,"object",1,e),e&&(K(t,e,["source"]),F(t,0,"source",e.source,["default","server","cache"]))}function jo(t,e,n){if(e instanceof Oo){if(e.firestore!==n)throw new T(E.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.")
return e}throw j(t,"DocumentReference",1,e)}function Go(t){switch(t){case Ar.Added:return"added"
case Ar.Modified:case Ar.Metadata:return"modified"
case Ar.Removed:return"removed"
default:return v("Unknown change type: "+t)}}var Wo=I(Ro,"Use firebase.firestore() instead."),zo=I(xo,"Use firebase.firestore().runTransaction() instead."),Ho=I(Mo,"Use firebase.firestore().batch() instead."),Yo=I(Oo,"Use firebase.firestore().doc() instead."),Xo=I(Po),Jo=I(qo),Zo=I(Fo),$o=I(Vo),ta=I(Uo,"Use firebase.firestore().collection() instead."),ea={Firestore:Wo,GeoPoint:Wr,Timestamp:Et,Blob:et,Transaction:zo,WriteBatch:Ho,DocumentReference:Yo,DocumentSnapshot:Xo,Query:Zo,QueryDocumentSnapshot:Jo,QuerySnapshot:$o,CollectionReference:ta,FieldPath:Yi,FieldValue:ho,setLogLevel:Ro.setLogLevel,CACHE_SIZE_UNLIMITED:No}
...
function r(t){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}n.r(e),n.d(e,"__extends",function(){return o}),n.d(e,"__assign",function(){return a}),n.d(e,"__rest",function(){return s}),n.d(e,"__decorate",function(){return u}),n.d(e,"__param",function(){return c}),n.d(e,"__metadata",function(){return h}),n.d(e,"__awaiter",function(){return l}),n.d(e,"__generator",function(){return f}),n.d(e,"__exportStar",function(){return d}),n.d(e,"__values",function(){return p}),n.d(e,"__read",function(){return y}),n.d(e,"__spread",function(){return m}),n.d(e,"__await",function(){return g}),n.d(e,"__asyncGenerator",function(){return v}),n.d(e,"__asyncDelegator",function(){return w}),n.d(e,"__asyncValues",function(){return b}),n.d(e,"__makeTemplateObject",function(){return S}),n.d(e,"__importStar",function(){return E}),n.d(e,"__importDefault",function(){return T})
...
function r(r,i){e[r]=t[r]?function(e){return(n=!n)?{value:g(t[r](e)),done:"return"===r}:i?i(e):e}:i}}function b(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.")
...
var _=Array.prototype.indexOf?function(t,e){return Array.prototype.indexOf.call(t,e,void 0)}:function(t,e){if(u(t))return u(e)&&1==e.length?t.indexOf(e,0):-1
...
function x(t,e){return-1!=t.indexOf(e)}function M(t,e){return t<e?-1:t>e?1:0}t:{var O=s.navigator
...
var B,Q,K=x(k,"Opera"),j=x(k,"Trident")||x(k,"MSIE"),G=x(k,"Edge"),W=G||j,z=x(k,"Gecko")&&!(x(k.toLowerCase(),"webkit")&&!x(k,"Edge"))&&!(x(k,"Trident")||x(k,"MSIE"))&&!x(k,"Edge"),H=x(k.toLowerCase(),"webkit")&&!x(k,"Edge")
...
e=M(0==a[1].length?0:parseInt(a[1],10),0==s[1].length?0:parseInt(s[1],10))||M(0==a[2].length,0==s[2].length)||M(a[2],s[2]),a=a[3],s=s[3]}while(0==e)}return 0<=e})}var nt=s.document
...
if(n in t.a){var r,i=t.a[n],o=_(i,e);(r=0<=o)&&Array.prototype.splice.call(i,o,1),r&&(ft(e),0==t.a[n].length&&(delete t.a[n],t.b--))}}function yt(t,e,n,r){for(var i=0;i<t.length;++i){var o=t[i]
...
return null}return r=Ct(r),e&&e[ct]?e.Ba(n,r,y(i)?!!i.capture:!!i,o):wt(e,n,r,!0,i,o)}(t,e,n,r,i)
if(d(e)){for(var o=0;o<e.length;o++)vt(t,e[o],n,r,i)
return null}return n=Ct(n),t&&t[ct]?t.Aa(e,n,y(r)?!!r.capture:!!r,i):wt(t,e,n,!1,r,i)}function wt(t,e,n,r,i,o){if(!e)throw Error("Invalid event type")
...
e.removeEventListener?e.removeEventListener(n,r,t.capture):e.detachEvent?e.detachEvent(St(n),r):e.addListener&&e.removeListener&&e.removeListener(r),(n=It(e))?(pt(n,t),0==n.b&&(n.src=null,e[mt]=null)):ft(t)}}}function St(t){return t in gt?gt[t]:gt[t]="on"+t}function Et(t,e){var n=t.listener,r=t.da||t.src
return t.Z&&bt(t),n.call(r,e)}function Tt(t,e){return!!t.X||Et(t,rt?new st(e,this):e=new st(e||h("window.event"),this))}function It(t){return(t=t[mt])instanceof dt?t:null}var _t="__closure_events_fn_"+(1e9*Math.random()>>>0)
function Ct(t){return"function"==f(t)?t:(t[_t]||(t[_t]=function(e){return t.handleEvent(e)}),t[_t])}function Dt(){I.call(this),this.c=new dt(this),this.J=this,this.B=null}function Nt(t,e,n,r){if(!(e=t.c.a[String(e)]))return!0
e=e.concat()
...
else i=y(i)?!!i.capture:!!i,r=Ct(r),e&&e[ct]?(e=e.c,(n=String(n).toString())in e.a&&-1<(r=yt(a=e.a[n],r,i,o))&&(ft(a[r]),Array.prototype.splice.call(a,r,1),0==a.length&&(delete e.a[n],e.b--))):e&&(e=It(e))&&(n=e.a[n.toString()],e=-1,n&&(e=yt(n,r,i,o)),(r=-1<e?n[e]:null)&&bt(r))}(this,t,e,n,r)},i.dispatchEvent=function(t){var e,n=this.B
...
return t}
var xt,Mt=new kt(function(){return new Lt},function(t){t.reset()})
function Ot(){var t=Vt,e=null
return t.a&&(e=t.a,t.a=t.a.next,t.a||(t.b=null),e.next=null),e}function Lt(){this.next=this.b=this.a=null}function Pt(t){s.setTimeout(function(){throw t},0)}function qt(t,e){xt||function(){var t=s.Promise.resolve(void 0)
xt=function(){t.then(Ut)}}(),Ft||(xt(),Ft=!0),Vt.add(t,e)}Rt.prototype.add=function(t,e){var n=Mt.get()
...
var Ft=!1,Vt=new Rt
function Ut(){for(var t;t=Ot();){try{t.a.call(t.b)}catch(t){Pt(t)}var e=Mt
e.f(t),100>e.b&&(e.b++,t.next=e.a,e.a=t)}Ft=!1}function Bt(t,e){Dt.call(this),this.b=t||1,this.a=e||s,this.f=b(this.gb,this),this.g=E()}function Qt(t){t.ba=!1,t.L&&(t.a.clearTimeout(t.L),t.L=null)}function Kt(t,e,n){if("function"==f(t))n&&(t=b(t,n))
else{if(!t||"function"!=typeof t.handleEvent)throw Error("Invalid listener argument")
t=b(t.handleEvent,t)}return 2147483647<Number(e)?-1:s.setTimeout(t,e||0)}function jt(t,e,n){I.call(this),this.f=null!=n?b(t,n):t,this.c=e,this.b=b(this.ab,this),this.a=[]}function Gt(t){t.U=Kt(t.b,t.c),t.f.apply(null,t.a)}function Wt(t){I.call(this),this.b=t,this.a={}}T(Bt,Dt),(i=Bt.prototype).ba=!1,i.L=null,i.gb=function(){if(this.ba){var t=E()-this.g
...
if(!o)break
t.a[o.key]=o}}function Yt(t){P(t.a,function(t,e){this.a.hasOwnProperty(e)&&bt(t)},t),t.a={}}function Xt(){}Wt.prototype.G=function(){Wt.N.G.call(this),Yt(this)},Wt.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")}
var Jt=new Dt
...
function le(){at.call(this,"d")}function fe(){at.call(this,"c")}function de(){}function pe(t,e,n){this.g=t,this.W=e,this.V=n||1,this.I=new Wt(this),this.O=ye,t=W?125:void 0,this.P=new Bt(t),this.h=null,this.b=!1,this.l=this.D=this.f=this.F=this.v=this.R=this.i=null,this.j=[],this.a=null,this.A=0,this.c=this.w=null,this.o=-1,this.m=!1,this.J=0,this.B=null,this.s=this.S=this.H=!1}T(le,at),T(fe,at),T(de,ae),ce=new de
var ye=45e3,me={},ge={}
function ve(t,e,n){t.F=1,t.f=Ke(Pe(e)),t.l=n,t.H=!0,be(t,null)}function we(t,e,n,r){t.F=1,t.f=Ke(Pe(e)),t.l=null,t.H=n,be(t,r)}function be(t,e){t.v=E(),Te(t),t.D=Pe(t.f),Qe(t.D,"t",t.V),t.A=0,t.a=t.g.$(t.g.Y()?e:null),0<t.J&&(t.B=new jt(b(t.Ka,t,t.a),t.J)),Ht(t.I,t.a,"readystatechange",t.eb),e=t.h?q(t.h):{},t.l?(t.w||(t.w="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.a.ca(t.D,t.w,t.l,e)):(t.w="GET",t.a.ca(t.D,t.w,null,e)),$t(1)}function Se(t,e,n){for(var r=!0;!t.m&&t.A<n.length;){var i=Ee(t,n)
if(i==ge){4==e&&(t.c=4,ee(14),r=!1)
break}if(i==me){t.c=4,ee(15),r=!1
break}Ne(t,i)}4==e&&0==n.length&&(t.c=1,ee(16),r=!1),t.b=t.b&&r,r||(De(t),Ce(t))}function Ee(t,e){var n=t.A,r=e.indexOf("\n",n)
return-1==r?ge:(n=Number(e.substring(n,r)),isNaN(n)?me:(r+=1)+n>e.length?ge:(e=e.substr(r,n),t.A=r+n,e))}function Te(t){t.R=E()+t.O,Ie(t,t.O)}function Ie(t,e){if(null!=t.i)throw Error("WatchDog timer not null")
t.i=re(b(t.bb,t),e)}function _e(t){t.i&&(s.clearTimeout(t.i),t.i=null)}function Ce(t){t.g.Da()||t.m||t.g.na(t)}function De(t){_e(t)
var e=t.B
...
else for(r in t)this.set(r,t[r])}function Re(t,e){Me(t.b,e)&&(delete t.b[e],t.c--,t.a.length>2*t.c&&xe(t))}function xe(t){if(t.c!=t.a.length){for(var e=0,n=0;e<t.a.length;){var r=t.a[e]
Me(t.b,r)&&(t.a[n++]=r),e++}t.a.length=n}if(t.c!=t.a.length){var i={}
for(n=e=0;e<t.a.length;)Me(i,r=t.a[e])||(t.a[n++]=r,i[r]=1),e++
t.a.length=n}}function Me(t,e){return Object.prototype.hasOwnProperty.call(t,e)}(i=pe.prototype).setTimeout=function(t){this.O=t},i.eb=function(t){t=t.target
var e=this.B
e&&3==Pn(t)?e.Ua():this.Ka(t)},i.Ka=function(t){try{if(t==this.a)t:{var e=Pn(this.a),n=this.a.ya(),r=this.a.T()
if(!(3>e||3==e&&!W&&!this.a.aa())){this.m||4!=e||7==n||$t(8==n||0>=r?3:2),_e(this)
var i=this.a.T()
this.o=i
var o=this.a.aa()
if(this.b=200==i){if(this.S&&!this.s){e:{if(this.a){var a=qn(this.a,"X-HTTP-Initial-Response")
if(a&&!A(a)){var s=a
break e}}s=null}if(!s){this.b=!1,this.c=3,ee(12),De(this),Ce(this)
break t}this.s=!0,Ne(this,s)}this.H?(Se(this,e,o),W&&this.b&&3==e&&(Ht(this.I,this.P,"tick",this.cb),this.P.start())):Ne(this,o),4==e&&De(this),this.b&&!this.m&&(4==e?this.g.na(this):(this.b=!1,Te(this)))}else 400==i&&0<o.indexOf("Unknown SID")?(this.c=3,ee(12)):(this.c=0,ee(13)),De(this),Ce(this)}}}catch(t){}},i.cb=function(){if(this.a){var t=Pn(this.a),e=this.a.aa()
this.A<e.length&&(_e(this),Se(this,t,e),this.b&&4!=t&&Te(this))}},i.cancel=function(){this.m=!0,De(this)},i.bb=function(){this.i=null
var t=E()
0<=t-this.R?(2!=this.F&&($t(3),ee(17)),De(this),this.c=2,Ce(this)):Ie(this,this.R-t)},(i=ke.prototype).C=function(){xe(this)
for(var t=[],e=0;e<this.a.length;e++)t.push(this.b[this.a[e]])
return t},i.K=function(){return xe(this),this.a.concat()},i.get=function(t,e){return Me(this.b,t)?this.b[t]:e},i.set=function(t,e){Me(this.b,t)||(this.c++,this.a.push(t)),this.b[t]=e},i.forEach=function(t,e){for(var n=this.K(),r=0;r<n.length;r++){var i=n[r],o=this.get(i)
t.call(e,o,i,this)}}
var Oe=/^(?:([^:\/?#.]+):)?(?:\/\/(?:([^\/?#]*)@)?([^\/#?]*?)(?::([0-9]+))?(?=[\/#?]|$))?([^?#]+)?(?:\?([^#]*))?(?:#([\s\S]*))?$/
function Le(t,e){var n
this.b=this.j=this.f="",this.i=null,this.g=this.a="",this.h=!1,t instanceof Le?(this.h=void 0!==e?e:t.h,qe(this,t.f),this.j=t.j,Fe(this,t.b),Ve(this,t.i),this.a=t.a,Ue(this,rn(t.c)),this.g=t.g):t&&(n=String(t).match(Oe))?(this.h=!!e,qe(this,n[1]||"",!0),this.j=je(n[2]||""),Fe(this,n[3]||"",!0),Ve(this,n[4]),this.a=je(n[5]||"",!0),Ue(this,n[6]||"",!0),this.g=je(n[7]||"")):(this.h=!!e,this.c=new Ze(null,this.h))}function Pe(t){return new Le(t)}function qe(t,e,n){t.f=n?je(e,!0):e,t.f&&(t.f=t.f.replace(/:$/,""))}function Fe(t,e,n){t.b=n?je(e,!0):e}function Ve(t,e){if(e){if(e=Number(e),isNaN(e)||0>e)throw Error("Bad port number "+e)
...
e&&t.push(Ge(e,ze,!0),":")
var n=this.b
return(n||"file"==e)&&(t.push("//"),(e=this.j)&&t.push(Ge(e,ze,!0),"@"),t.push(encodeURIComponent(String(n)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),null!=(n=this.i)&&t.push(":",String(n))),(n=this.a)&&(this.b&&"/"!=n.charAt(0)&&t.push("/"),t.push(Ge(n,"/"==n.charAt(0)?Ye:He,!0))),(n=this.c.toString())&&t.push("?",n),(n=this.g)&&t.push("#",Ge(n,Je)),t.join("")},Le.prototype.resolve=function(t){var e=Pe(this),n=!!t.f
...
else if(x(i,"./")||x(i,"/.")){r=0==i.lastIndexOf("/",0),i=i.split("/")
...
e(o,i?decodeURIComponent(i.replace(/\+/g," ")):"")}}}(t.c,function(e,n){t.add(decodeURIComponent(e.replace(/\+/g," ")),n)}))}function tn(t,e){$e(t),e=on(t,e),Me(t.a.b,e)&&(t.c=null,t.b-=t.a.get(e).length,Re(t.a,e))}function en(t,e){return $e(t),e=on(t,e),Me(t.a.b,e)}function nn(t,e,n){tn(t,e),0<n.length&&(t.c=null,t.a.set(on(t,e),N(n)),t.b+=n.length)}function rn(t){var e=new Ze
...
var n=this.a.get(t)
return n||this.a.set(t,n=[]),n.push(e),this.b+=1,this},i.forEach=function(t,e){$e(this),this.a.forEach(function(n,r){C(n,function(n){t.call(e,n,r,this)},this)},this)},i.K=function(){$e(this)
...
var dn=10
function pn(t,e){!t.a&&(x(e,"spdy")||x(e,"quic")||x(e,"h2"))&&(t.f=t.g,t.a=new cn,t.b&&(vn(t,t.b),t.b=null))}function yn(t){return!!t.b||!!t.a&&t.a.a.c>=t.f}function mn(t){return t.b?1:t.a?t.a.a.c:0}function gn(t,e){return t.b?t=t.b==e:t.a?(e=hn(e),t=Me(t.a.a.b,e)):t=!1,t}function vn(t,e){t.a?t.a.add(e):t.b=e}function wn(t,e){var n
t.b&&t.b==e?t.b=null:((n=t.a)&&(n=hn(e),n=Me(t.a.a.b,n)),n&&Re(t.a.a,hn(e)))}function bn(t){if(null!=t.b)return t.c.concat(t.b.j)
if(null!=t.a&&0!=t.a.a.c){var e=t.c
return C(t.a.C(),function(t){e=e.concat(t.j)}),e}return N(t.c)}function Sn(){}function En(){this.a=new Sn}function Tn(t,e,n){var r=n||""
...
this.c=bn(this),this.b?(this.b.cancel(),this.b=null):this.a&&0!=this.a.a.c&&(C(this.a.C(),function(t){t.cancel()}),(t=this.a.a).b={},t.a.length=0,t.c=0)},Sn.prototype.stringify=function(t){return s.JSON.stringify(t,void 0)},Sn.prototype.parse=function(t){return s.JSON.parse(t,void 0)}
var _n=s.JSON.parse
function Cn(t){Dt.call(this),this.headers=new ke,this.H=t||null,this.b=!1,this.s=this.a=null,this.A="",this.h=0,this.f="",this.g=this.w=this.l=this.v=!1,this.o=0,this.m=null,this.I=Dn,this.D=this.F=!1}T(Cn,Dt)
var Dn="",Nn=/^https?$/i,An=["POST","PUT"]
function kn(t){return"content-type"==t.toLowerCase()}function Rn(t,e){t.b=!1,t.a&&(t.g=!0,t.a.abort(),t.g=!1),t.f=e,t.h=5,xn(t),On(t)}function xn(t){t.v||(t.v=!0,t.dispatchEvent("complete"),t.dispatchEvent("error"))}function Mn(t){if(t.b&&void 0!==a&&(!t.s[1]||4!=Pn(t)||2!=t.T()))if(t.l&&4==Pn(t))Kt(t.Fa,0,t)
...
o=u.substr(0,u.length-1)}i=!Nn.test(o?o.toLowerCase():"")}e=i}e?(t.dispatchEvent("complete"),t.dispatchEvent("success")):(t.h=6,t.f=t.za()+" ["+t.T()+"]",xn(t))}finally{On(t)}}}function On(t,e){if(t.a){Ln(t)
...
n=(t=[t.substr(0,r),i,t.substr(n)])[1],t[1]=e?n?n+"&"+e:e:n,t=t[0]+(t[1]?"?"+t[1]:"")+t[2]}return t}return Be(t,e,n),t}function Vn(t){this.f=[],this.F=new un,this.ga=this.pa=this.B=this.ha=this.a=this.I=this.j=this.V=this.g=this.J=this.i=null,this.Ra=this.P=0,this.Pa=!!h("internalChannelParams.failFast",t),this.ia=this.w=this.s=this.l=this.h=this.c=null,this.oa=!0,this.m=this.ra=this.O=-1,this.S=this.v=this.A=0,this.Oa=h("internalChannelParams.baseRetryDelayMs",t)||5e3,this.Sa=h("internalChannelParams.retryDelaySeedMs",t)||1e4,this.Qa=h("internalChannelParams.forwardChannelMaxRetries",t)||2,this.qa=h("internalChannelParams.forwardChannelRequestTimeoutMs",t)||2e4,this.La=t&&t.Ab||void 0,this.D=void 0,this.R=t&&t.supportsCrossDomainXhr||!1,this.H="",this.b=new fn(t&&t.concurrentRequestLimit),this.ja=new En,this.o=!t||void 0===t.backgroundChannelTest||t.backgroundChannelTest,(this.W=t&&t.fastHandshake||!1)&&!this.o&&(this.o=!0),t&&t.forceLongPolling&&(this.oa=!1),this.fa=void 0}function Un(t){if(Bn(t),3==t.u){var e=t.P++,n=Pe(t.B)
Be(n,"SID",t.H),Be(n,"RID",e),Be(n,"TYPE","terminate"),Gn(t,n),(e=new pe(t,e,void 0)).F=2,e.f=Ke(Pe(n)),n=!1,s.navigator&&s.navigator.sendBeacon&&(n=s.navigator.sendBeacon(e.f.toString(),"")),!n&&s.Image&&((new Image).src=e.f,n=!0),n||(e.a=e.g.$(null),e.a.ca(e.f)),e.v=E(),Te(e)}$n(t)}function Bn(t){t.w&&(t.w.abort(),t.w=null),t.a&&(t.a.cancel(),t.a=null),t.l&&(s.clearTimeout(t.l),t.l=null),Xn(t),t.b.cancel(),t.h&&(c(t.h)&&s.clearTimeout(t.h),t.h=null)}function Qn(t,e){t.f.push(new ln(t.Ra++,e)),3==t.u&&Kn(t)}function Kn(t){yn(t.b)||t.h||(t.h=!0,qt(t.Ia,t),t.A=0)}function jn(t,e){var n
n=e?e.W:t.P++
var r=Pe(t.B)
...
return t&&qe(i,t),e&&Fe(i,e),n&&Ve(i,n),r&&(i.a=r),i}(o.protocol,i,+o.port,n)}return t.V&&P(t.V,function(t,e){Be(r,e,t)}),e=t.j,n=t.I,e&&n&&Be(r,e,n),Be(r,"VER",t.wa),Gn(t,r),r}function er(){}function nr(){if(j&&!(10<=Number($)))throw Error("Environmental error: no available transport.")}function rr(t,e){Dt.call(this),this.a=new Vn(e),this.g=t,this.m=e&&e.testUrl?e.testUrl:function(t){for(var e=arguments[0],n=1;n<arguments.length;n++){var r,i=arguments[n]
...
break t}e=-1}return 0>e?null:u(t)?t.charAt(e):t[e]}(i.K()),n=s.FormData&&t instanceof s.FormData,!(0<=_(An,e))||r||n||i.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8"),i.forEach(function(t,e){this.a.setRequestHeader(e,t)},this),this.I&&(this.a.responseType=this.I),"withCredentials"in this.a&&this.a.withCredentials!==this.F&&(this.a.withCredentials=this.F)
try{Ln(this),0<this.o&&((this.D=function(t){return j&&et(9)&&c(t.timeout)&&void 0!==t.ontimeout}(this.a))?(this.a.timeout=this.o,this.a.ontimeout=b(this.Ca,this)):this.m=Kt(this.Ca,this.o,this)),this.l=!0,this.a.send(t),this.l=!1}catch(t){Rn(this,t)}},i.Ca=function(){void 0!==a&&this.a&&(this.f="Timed out after "+this.o+"ms, aborting",this.h=8,this.dispatchEvent("timeout"),this.abort(8))},i.abort=function(t){this.a&&this.b&&(this.b=!1,this.g=!0,this.a.abort(),this.g=!1,this.h=t||7,this.dispatchEvent("complete"),this.dispatchEvent("abort"),On(this))},i.G=function(){this.a&&(this.b&&(this.b=!1,this.g=!0,this.a.abort(),this.g=!1),On(this,!0)),Cn.N.G.call(this)},i.Fa=function(){this.j||(this.w||this.l||this.g?Mn(this):this.$a())},i.$a=function(){Mn(this)},i.T=function(){try{return 2<Pn(this)?this.a.status:-1}catch(t){return-1}},i.za=function(){try{return 2<Pn(this)?this.a.statusText:""}catch(t){return""}},i.aa=function(){try{return this.a?this.a.responseText:""}catch(t){return""}},i.Va=function(t){if(this.a){var e=this.a.responseText
return t&&0==e.indexOf(t)&&(e=e.substring(t.length)),_n(e)}},i.ya=function(){return this.h},i.Ya=function(){return u(this.f)?this.f:String(this.f)},(i=Vn.prototype).wa=8,i.u=1,i.Da=function(){return 0==this.u},i.Ia=function(t){if(this.h)if(this.h=null,1==this.u){if(!t){this.P=Math.floor(1e5*Math.random())
...
e=Wn(this,n,e),Be(i=Pe(this.B),"RID",t),Be(i,"CVER",22),this.o&&this.j&&Be(i,"X-HTTP-Session-Id",this.j),Gn(this,i),this.g&&r&&Fn(i,this.g,r),vn(this.b,n),this.W?(Be(i,"$req",e),Be(i,"SID","null"),n.S=!0,ve(n,i,null)):ve(n,i,e),this.u=2}}else 3==this.u&&(t?jn(this,t):0==this.f.length||yn(this.b)||jn(this))},i.Ha=function(){this.l=null,this.a=new pe(this,"rpc",this.S),null===this.g&&(this.a.h=this.i),this.a.J=0
var t=Pe(this.pa)
Be(t,"RID","rpc"),Be(t,"SID",this.H),Be(t,"CI",this.ia?"0":"1"),Be(t,"AID",this.O),Gn(this,t),Be(t,"TYPE","xmlhttp"),this.g&&this.i&&Fn(t,this.g,this.i),this.D&&this.a.setTimeout(this.D),we(this.a,t,!0,this.ga)},i.Ga=function(t,e){if(0!=this.u&&(this.a==t||gn(this.b,t)))if(this.m=t.o,!t.s&&gn(this.b,t)&&3==this.u){try{var n=this.ja.a.parse(e)}catch(t){n=null}if(d(n)&&3==n.length){if(0==(e=n)[0]){t:if(!this.l){if(this.a){if(!(this.a.v+3e3<t.v))break t
...
var i=r[3]
null!=i&&(this.wa=i),null!=(r=r[5])&&c(r)&&0<r&&(this.D=1.5*r),this.o&&(r=t.a)&&((i=qn(r,"X-Client-Wire-Protocol"))&&pn(this.b,i),this.j&&(r=qn(r,"X-HTTP-Session-Id")))&&(this.I=r,Be(this.B,this.j,r)),this.u=3,this.c&&this.c.va(),r=t,this.pa=tr(this,this.Y()?this.ga:null,this.ha),r.s?(wn(this.b,r),(i=this.D)&&r.setTimeout(i),r.i&&(_e(r),Te(r)),this.a=r):zn(this),0<this.f.length&&Kn(this)}else"stop"!=r[0]&&"close"!=r[0]||Zn(this,7)
...
return(t=new Cn(this.La)).F=this.R,t},i.ma=function(){return!!this.c&&!0},i.Y=function(){return this.R},(i=er.prototype).va=function(){},i.ua=function(){},i.ta=function(){},i.sa=function(){},i.Ta=function(){},nr.prototype.a=function(t,e){return new rr(t,e)},T(rr,Dt),(i=rr.prototype).addEventListener=function(t,e,n,r){rr.N.addEventListener.call(this,t,e,n,r)},i.removeEventListener=function(t,e,n,r){rr.N.removeEventListener.call(this,t,e,n,r)},i.Wa=function(){this.a.c=this.f,this.l&&(this.a.R=!0)
...
nr.prototype.createWebChannel=nr.prototype.a,rr.prototype.send=rr.prototype.Xa,rr.prototype.open=rr.prototype.Wa,rr.prototype.close=rr.prototype.close,ie.NO_ERROR=0,ie.TIMEOUT=8,ie.HTTP_ERROR=6,oe.COMPLETE="complete",ue.EventType=he,he.OPEN="a",he.CLOSE="b",he.ERROR="c",he.MESSAGE="d",Dt.prototype.listen=Dt.prototype.Aa,Cn.prototype.listenOnce=Cn.prototype.Ba,Cn.prototype.getLastError=Cn.prototype.Ya,Cn.prototype.getLastErrorCode=Cn.prototype.ya,Cn.prototype.getStatus=Cn.prototype.T,Cn.prototype.getStatusText=Cn.prototype.za,Cn.prototype.getResponseJson=Cn.prototype.Va,Cn.prototype.getResponseText=Cn.prototype.aa,Cn.prototype.send=Cn.prototype.ca
var ur={createWebChannelTransport:sr,ErrorCode:ie,EventType:oe,WebChannel:ue,XhrIo:Cn},cr=ur.createWebChannelTransport,hr=ur.ErrorCode,lr=ur.EventType,fr=ur.WebChannel,dr=ur.XhrIo
e.default=ur}}])
