...
try{e.call(t,function(t){a||(a=!0,n.call(r,t))},o)}catch(t){o(t)}}(t,r,e,n,i),!0}catch(t){return n.call(i,t),!0}return!1}function Mt(t){t.h||(t.h=!0,gt(t.Xb,t))}function jt(t){var e=null
...
o&&(i.a==Tt&&1==r?t(i,n):(a?((r=a).next==i.f&&(i.f=r),r.next=r.next.next):jt(i),Ut(i,o,Et,n)))}e.c=null}else Lt(e,Et,n)}(this,new Ft(t))},this)},t.Lc=function(t){this.a=Tt,Lt(this,kt,t)},t.Mc=function(t){this.a=Tt,Lt(this,Et,t)},t.Xb=function(){for(var t;t=jt(this);)Ut(this,t,this.a,this.i)
this.h=!1}
var Kt=mt
...
function Me(t){return b(t)?t:(t[xe]||(t[xe]=function(e){return t.handleEvent(e)}),t[xe])}function je(){qt.call(this),this.m=new we(this),this.Qb=this,this.Va=null}function Ue(t,e,n,i,r){t.m.add(String(e),n,!1,i,r)}function Ve(t,e,n,i,r){t.m.add(String(e),n,!0,i,r)}function Ke(t,e,n,i){if(!(e=t.m.a[String(e)]))return!0
e=e.concat()
...
t.a.length=n}}function Xe(t,e){return Object.prototype.hasOwnProperty.call(t,e)}N(je,qt),je.prototype[me]=!0,je.prototype.addEventListener=function(t,e,n,i){Se(this,t,e,n,i)},je.prototype.removeEventListener=function(t,e,n,i){_e(this,t,e,n,i)},je.prototype.dispatchEvent=function(t){var e,n=this.Va
...
delete e.a[t],e.b--}}this.Va=null},(t=Ge.prototype).S=function(){We(this)
...
var pr,vr={Yc:{ab:"https://www.googleapis.com/identitytoolkit/v3/relyingparty/",ib:"https://securetoken.googleapis.com/v1/token",id:"p"},$c:{ab:"https://staging-www.sandbox.googleapis.com/identitytoolkit/v3/relyingparty/",ib:"https://staging-securetoken.sandbox.googleapis.com/v1/token",id:"s"},ad:{ab:"https://www-googleapis-test.sandbox.google.com/identitytoolkit/v3/relyingparty/",ib:"https://test-securetoken.sandbox.googleapis.com/v1/token",id:"t"}}
function mr(t){for(var e in vr)if(vr[e].id===t)return{firebaseEndpoint:(t=vr[e]).ab,secureTokenEndpoint:t.ib}
return null}pr=mr("__EID__")?"__EID__":void 0
var gr="oauth_consumer_key oauth_nonce oauth_signature oauth_signature_method oauth_timestamp oauth_token oauth_version".split(" "),br=["client_id","response_type","scope","redirect_uri","state"],yr={Tc:{Oa:"locale",Ba:500,Aa:600,Pa:"facebook.com",hb:br},Vc:{Oa:null,Ba:500,Aa:620,Pa:"github.com",hb:br},Wc:{Oa:"hl",Ba:515,Aa:680,Pa:"google.com",hb:br},bd:{Oa:"lang",Ba:485,Aa:705,Pa:"twitter.com",hb:gr}}
...
try{return new jr(t.providerId,e,t.signInMethod)}catch(t){}}return null}function Kr(t,e){this.Dc=e||[],Mi(this,{providerId:t,isOAuthProvider:!0}),this.zb={},this.cb=(wr(t)||{}).Oa||null,this.$a=null}function Fr(t){if("string"!=typeof t||0!=t.indexOf("saml."))throw new Ji("argument-error",'SAML provider IDs must be prefixed with "saml."')
...
return"signIn"===(tn(t.a,"mode")||null)&&e?e:null}function no(t){if(!(t.Ta&&t.Sa||t.Fa&&t.$))throw new Ji("internal-error")
...
return new jr(this.providerId,n,this.providerId)},N(Hr,qr),xi(Hr,"PROVIDER_ID","facebook.com"),xi(Hr,"FACEBOOK_SIGN_IN_METHOD","facebook.com"),N(Gr,qr),xi(Gr,"PROVIDER_ID","github.com"),xi(Gr,"GITHUB_SIGN_IN_METHOD","github.com"),N(Xr,qr),xi(Xr,"PROVIDER_ID","google.com"),xi(Xr,"GOOGLE_SIGN_IN_METHOD","google.com"),N(zr,Kr),xi(zr,"PROVIDER_ID","twitter.com"),xi(zr,"TWITTER_SIGN_IN_METHOD","twitter.com"),$r.prototype.la=function(t){return this.signInMethod==Qr.EMAIL_LINK_SIGN_IN_METHOD?vs(t,Ja,{email:this.a,oobCode:this.c}):vs(t,ls,{email:this.a,password:this.c})},$r.prototype.b=function(t,e){return this.signInMethod==Qr.EMAIL_LINK_SIGN_IN_METHOD?vs(t,za,{idToken:e,email:this.a,oobCode:this.c}):vs(t,os,{idToken:e,email:this.a,password:this.c})},$r.prototype.f=function(t,e){return Dr(this.la(t),e)},$r.prototype.w=function(){return{email:this.a,password:this.c,signInMethod:this.signInMethod}},Mi(Qr,{PROVIDER_ID:"password"}),Mi(Qr,{EMAIL_LINK_SIGN_IN_METHOD:"emailLink"}),Mi(Qr,{EMAIL_PASSWORD_SIGN_IN_METHOD:"password"}),no.prototype.la=function(t){return t.Ua(ro(this))},no.prototype.b=function(t,e){var n=ro(this)
...
t&&(e.body=t),this.u.fetch(new Request(this.g,e)).then(this.hc.bind(this),this.Ma.bind(this))},t.abort=function(){this.response=this.responseText="",this.i=new Headers,this.status=0,this.c&&this.c.cancel("Request was aborted."),1<=this.readyState&&this.a&&4!=this.readyState&&(this.a=!1,Ko(this,!1)),this.readyState=Uo},t.hc=function(t){this.a&&(this.f=t,this.b||(this.b=t.headers,this.readyState=2,Fo(this)),this.a&&(this.readyState=3,Fo(this),this.a&&("arraybuffer"===this.responseType?t.arrayBuffer().then(this.fc.bind(this),this.Ma.bind(this)):void 0!==u.ReadableStream&&"body"in t?(this.response=this.responseText="",this.c=t.body.getReader(),this.l=new TextDecoder,Vo(this)):t.text().then(this.gc.bind(this),this.Ma.bind(this)))))},t.cc=function(t){if(this.a){var e=this.l.decode(t.value?t.value:new Uint8Array(0),{stream:!t.done})
e&&(this.response=this.responseText+=e),t.done?Ko(this,!0):Fo(this),3==this.readyState&&Vo(this)}},t.gc=function(t){this.a&&(this.response=this.responseText=t,Ko(this,!0))},t.fc=function(t){this.a&&(this.response=t,Ko(this,!0))},t.Ma=function(t){var e=this.h
...
null===o?i.push(t):r in e&&(n[r]=o)}),i.length&&(n.deleteAttribute=i),vs(this,rs,n)},t.kb=function(t,e){return dt(t={requestType:"PASSWORD_RESET",email:t},e),vs(this,Qa,t)},t.lb=function(t,e){return dt(t={requestType:"EMAIL_SIGNIN",email:t},e),vs(this,$a,t)},t.jb=function(t,e){return dt(t={requestType:"VERIFY_EMAIL",idToken:t},e),vs(this,Za,t)},t.Ua=function(t){return vs(this,fs,t)},t.Za=function(t,e){return vs(this,ns,{oobCode:t,newPassword:e})},t.Ka=function(t){return vs(this,Ha,{oobCode:t})},t.Wa=function(t){return vs(this,qa,{oobCode:t})}
...
Ra(t)}},ps={Wb:{USER_NOT_FOUND:"user-not-found"},endpoint:"verifyPhoneNumber",C:Da,J:Ra}
...
return new It(function(e,o){Na(t,a.toString(),function(t){t?t.error?o(gs(t,r||{})):e(t):o(new Ji("network-request-failed"))},n,s?void 0:Bn(Ti(i)),t.a,t.h.get())})}(t,e.endpoint,r,n,e.Wb,e.wb||!1)}).then(function(t){return i=t,e.Qa?e.Qa(n,i):i}).then(e.J).then(function(){if(!e.da)return i
...
return!e&&t&&(e=Ii(t)),new Ji("internal-error",e)}function bs(t){this.b=t,this.a=null,this.fb=function(t){return(Ts||(Ts=new It(function(t,e){function n(){Ai(),vi("gapi.load")("gapi.iframes",{callback:t,ontimeout:function(){Ai(),e(Error("Network Error"))},timeout:ws.get()})}if(vi("gapi.iframes.Iframe"))t()
...
!function(t,e){t.fb.then(function(){t.a.register("authEvent",e,vi("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"))})}(t.i,function(e){var n={}
...
return _s(t).then(function(){return function(t,e){return t.fb.then(function(){return new It(function(n){t.a.send(e.type,e,n,vi("gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER"))})})}(t.i,e)}).then(function(t){if(t&&t.length&&void 0!==t[0].webStorageSupport)return t[0].webStorageSupport
...
var nu,iu,ru={B:Ys,Ra:Qs},ou={B:Ys,Ra:Qs},au={B:Cs,Ra:Zs},su={B:Ys,Ra:Zs},uu={Xc:"local",NONE:"none",Zc:"session"}
function cu(){var t=!(Si(pi())||!oi()),e=wi(),n=mi()
this.o=t,this.h=e,this.m=n,this.a={},nu||(nu=new eu),t=nu
try{this.g=!zn()&&Pi()||!u.indexedDB?new t.a.B:new Js(ai()?new zs:new t.a.B)}catch(t){this.g=new zs,this.h=!0}try{this.i=new t.a.Ra}catch(t){this.i=new zs}this.l=new zs,this.f=E(this.Ob,this),this.b={}}function hu(){return iu||(iu=new cu),iu}function lu(t,e){switch(e){case"session":return t.i
...
n!=i&&(t.b[e]=n,n=new pe({type:"storage",key:e,target:window,oldValue:i,newValue:n,a:!0}),t.Ob(n))}},1e3)}(this)),this.a[t]||(this.a[t]=[]),this.a[t].push(n)},t.removeListener=function(t,e,n){t=fu(t,e),this.a[t]&&(B(this.a[t],function(t){return t==n}),0==this.a[t].length&&delete this.a[t]),ut(this.a)&&(lu(this,"local").ca(this.f),pu(this))},t.Ob=function(t){if(t&&t.f){var e=t.a.key
if(null==e)for(var n in this.a){var i=this.b[n]
void 0===i&&(i=null)
var r=u.localStorage.getItem(n)
r!==i&&(this.b[n]=r,this.Xa(n))}else if(0==e.indexOf("firebase:")&&this.a[e]){if(void 0!==t.a.a?lu(this,"local").ca(this.f):pu(this),this.o)if(n=u.localStorage.getItem(e),(i=t.a.newValue)!==n)null!==i?u.localStorage.setItem(e,i):u.localStorage.removeItem(e)
else if(this.b[e]===i&&void 0===t.a.a)return
var o=this
n=function(){void 0===t.a.a&&o.b[e]===u.localStorage.getItem(e)||(o.b[e]=u.localStorage.getItem(e),o.Xa(e))},Yt&&oe&&10==oe&&u.localStorage.getItem(e)!==t.a.newValue&&t.a.newValue!==t.a.oldValue?setTimeout(n,10):n()}}else V(t,E(this.Xa,this))},t.Xa=function(t){this.a[t]&&V(this.a[t],function(t){t()})}
...
if("function"!=typeof vi("cordova.InAppBrowser.open",u))throw Cu("cordova-plugin-inappbrowser is not installed")},function(){throw new Ji("cordova-not-ready")})},t.Ea=function(t,e){return e(new Ji("operation-not-supported-in-this-environment")),_t()},t.Db=function(){return Ot(new Ji("operation-not-supported-in-this-environment"))},t.Pb=function(){return!1},t.Mb=function(){return!0},t.Hb=function(){return!0},t.Ca=function(t,e,n){if(this.c)return Ot(new Ji("redirect-operation-pending"))
...
function ju(t){return du(t.b,Mu,t.a)}function Uu(t,e,n){this.i={},this.u=0,this.A=t,this.l=e,this.o=n,this.h=[],this.f=!1,this.m=E(this.bb,this),this.b=new Ju,this.v=new Zu,this.g=new xu(this.l+":"+this.o),this.c={},this.c.unknown=this.b,this.c.signInViaRedirect=this.b,this.c.linkViaRedirect=this.b,this.c.reauthViaRedirect=this.b,this.c.signInViaPopup=this.v,this.c.linkViaPopup=this.v,this.c.reauthViaPopup=this.v,this.a=Vu(this.A,this.l,this.o,pr)}function Vu(t,e,n,i){var o=r.a.SDK_VERSION||null
...
Gu(e)&&t.bb(n)}),t.a.Hb()||zu(t.b)}(t=Uu.prototype).reset=function(){this.f=!1,this.a.La(this.m),this.a=Vu(this.A,this.l,this.o),this.i={}},t.Ya=function(){this.b.Ya()},t.subscribe=function(t){if(q(this.h,t)||this.h.push(t),!this.f){var e=this;(function(t){return t.b.get(Mu,t.a).then(function(t){return"pending"==t})})(this.g).then(function(t){t?ju(e.g).then(function(){Ku(e).s(function(t){var n=new co("unknown",null,null,null,new Ji("operation-not-supported-in-this-environment"))
Gu(t)&&e.bb(n)})}):Fu(e)}).s(function(){Fu(e)})}},t.unsubscribe=function(t){B(this.h,function(e){return e==t})},t.bb=function(t){if(!t)throw new Ji("invalid-auth-event")
...
return i=t,ju(r.g).then(function(){throw i})}).then(function(){return r.a.Pb()?new It(function(){}):ju(r.g).then(function(){return r.fa()}).then(function(){}).s(function(){})})})},Uu.prototype.Ea=function(t,e,n,i){return this.a.Ea(n,function(n){t.ha(e,null,n,i)},qu.get())}
var Wu={}
function Xu(t,e,n){var i=e+":"+n
return Wu[i]||(Wu[i]=new Uu(t,e,n)),Wu[i]}function Ju(){this.b=null,this.f=[],this.c=[],this.a=null,this.i=this.g=!1}function zu(t){t.g||(t.g=!0,$u(t,!1,null,null))}function Yu(t,e){if(t.b=function(){return _t(e)},t.f.length)for(var n=0;n<t.f.length;n++)t.f[n](e)}function $u(t,e,n,i){e?i?function(t,e){if(t.b=function(){return Ot(e)},t.c.length)for(var n=0;n<t.c.length;n++)t.c[n](e)}(t,i):Yu(t,n):Yu(t,{user:null}),t.f=[],t.c=[]}function Zu(){}function Qu(){this.ub=!1,Object.defineProperty(this,"appVerificationDisabled",{get:function(){return this.ub},set:function(t){this.ub=t},enumerable:!1})}function tc(t,e){this.a=e,xi(this,"verificationId",t)}function ec(t,e,n,i){return new oo(t).Ua(e,n).then(function(t){return new tc(t,i)})}function nc(t){var e=dr(t)
...
return function(t,e){return vs(t.c,Ya,{idToken:e}).then(E(t.xc,t))}(t,e).then(function(){return n||Ac(t,"isAnonymous",!1),e})})}function Oc(t,e){e[wa]&&t.ra!=e[wa]&&(oc(t.h,e),t.dispatchEvent(new cc("tokenChanged")),gc(t,e[wa]),Ac(t,"refreshToken",t.h.a))}function Pc(t,e){return _c(t).then(function(){if(q(kc(t),e))return bc(t).then(function(){throw new Ji("provider-already-linked")})})}function Cc(t,e,n){return ji({user:t,credential:so(e),additionalUserInfo:e=Ir(e),operationType:n})}function Rc(t,e){return Oc(t,e),t.reload().then(function(){return t})}function Dc(t,e,n,i,o){if(!gi())return Ot(new Ji("operation-not-supported-in-this-environment"))
...
n(i,r,o).then(function(e){$u(t,a,e,null)}).s(function(e){$u(t,a,null,e)})}(this,t,e):Ot(new Ji("invalid-auth-event")):($u(this,!1,null,null),_t())}else Ot(new Ji("invalid-auth-event"))},Ju.prototype.Ya=function(){this.g&&!this.i&&$u(this,!1,null,null)},Ju.prototype.fa=function(){var t=this
...
return Mc(this,Tc(this).then(function(){return _c(t).then(function(){return bc(t)}).then(Ic)}))},t.bc=function(t){return this.F(t).then(function(t){return new nc(t)})},t.F=function(t){var e=this
return Mc(this,Tc(this).then(function(){return e.h.getToken(t)}).then(function(t){if(!t)throw new Ji("internal-error")
return t.accessToken!=e.ra&&(gc(e,t.accessToken),e.dispatchEvent(new cc("tokenChanged"))),Ac(e,"refreshToken",t.refreshToken),t.accessToken}))},t.xc=function(t){if(!(t=t.users)||!t.length)throw new Ji("internal-error")
...
Ac(this,"isAnonymous",!(this.email&&t.passwordHash||this.providerData&&this.providerData.length))},t.yc=function(t){return Di("firebase.User.prototype.reauthenticateAndRetrieveDataWithCredential is deprecated. Please use firebase.User.prototype.reauthenticateWithCredential instead."),this.gb(t)},t.gb=function(t){var e=this,n=null
return Mc(this,t.f(this.c,this.uid).then(function(t){return Oc(e,t),n=Cc(e,t,"reauthenticate"),e.i=null,e.reload()}).then(function(){return n}),!0)},t.pc=function(t){return Di("firebase.User.prototype.linkAndRetrieveDataWithCredential is deprecated. Please use firebase.User.prototype.linkWithCredential instead."),this.eb(t)},t.eb=function(t){var e=this,n=null
return Mc(this,Pc(this,t.providerId).then(function(){return e.F()}).then(function(n){return t.b(e.c,n)}).then(function(t){return n=Cc(e,t,"link"),Rc(e,t)}).then(function(){return n}))},t.qc=function(t,e){var n=this
return Mc(this,Pc(this,"phone").then(function(){return ec(pc(n),t,e,E(n.eb,n))}))},t.zc=function(t,e){var n=this
return Mc(this,_t().then(function(){return ec(pc(n),t,e,E(n.gb,n))}),!0)},t.rb=function(t){var e=this
...
return Dc(this,"linkViaPopup",t,function(){return Pc(e,t.providerId).then(function(){return bc(e)})},!1)},t.Ac=function(t){return Dc(this,"reauthViaPopup",t,function(){return _t()},!0)},t.sc=function(t){var e=this
return Lc(this,"linkViaRedirect",t,function(){return Pc(e,t.providerId)},!1)},t.Bc=function(t){return Lc(this,"reauthViaRedirect",t,function(){return _t()},!0)},t.Bb=function(t,e,n){var i=this
...
var e=t.h
e.b.addListener(Bc("local"),e.a,t.ka)}})}(this)),this.X=!1,this.ka=E(this.Kc,this),this.Ha=E(this.Z,this),this.ra=E(this.$b,this),this.sa=E(this.jc,this),this.ta=E(this.kc,this),function(t){var e=nh(t).options.authDomain,n=nh(t).options.apiKey
e&&gi()&&(t.Rb=t.V.then(function(){if(!t.l){if(t.a=Xu(e,n,nh(t).name),t.a.subscribe(t),ih(t)&&yc(ih(t)),t.D){yc(t.D)
var i=t.D
i.pa(t.ea()),lc(i,t),fc(i=t.D,t.G),dc(i,t),t.D=null}return t.a}}))}(this),this.INTERNAL={},this.INTERNAL.delete=E(this.delete,this),this.INTERNAL.logFramework=E(this.tc,this),this.u=0,je.call(this),function(t){Object.defineProperty(t,"lc",{get:function(){return this.ea()},set:function(t){this.pa(t)},enumerable:!1}),t.W=null}(this),this.G=[]}function Yc(t){de.call(this,"languageCodeChanged"),this.g=t}function $c(t){de.call(this,"frameworkChanged"),this.c=t}function Zc(t){return t.Rb||Ot(new Ji("auth-domain-config-required"))}function Qc(t,e){var n={}
...
if(t.O!==t.getUid()&&t.I.length)for(t.O=t.getUid(),e=0;e<t.I.length;e++)t.I[e]&&t.I[e](rh(t))}}function ah(t,e){return t.N.push(e),e.ia(function(){H(t.N,e)}),e}function sh(){}function uh(){this.a={},this.b=1e12}Fc.prototype.mb=function(t){var e=null,n=this
...
break
default:if(!mi()&&"none"!==t)throw n}}(t),Jc(this,function(){return t!=n.c.B?n.b.get(n.c,n.a).then(function(i){return e=i,qc(n,t)}).then(function(){if(n.c=Bc(t),e)return n.b.set(n.c,e,n.a)}):_t()})},N(zc,je),N(Yc,de),N($c,de),(t=zc.prototype).mb=function(t){return ah(this,t=this.h.mb(t))},t.pa=function(t){this.W===t||this.l||(this.W=t,Sa(this.c,this.W),this.dispatchEvent(new Yc(this.ea())))},t.ea=function(){return this.W},t.Qc=function(){var t=u.navigator
this.pa(t&&(t.languages&&t.languages[0]||t.language||t.userLanguage)||null)},t.tc=function(t){this.G.push(t),Aa(this.c,r.a.SDK_VERSION?di(r.a.SDK_VERSION,this.G):null),this.dispatchEvent(new $c(this.G))},t.ya=function(){return W(this.G)},t.toJSON=function(){return{apiKey:nh(this).options.apiKey,authDomain:nh(this).options.authDomain,appName:nh(this).name,currentUser:ih(this)&&ih(this).w()}},t.xb=function(t,e){switch(t){case"unknown":case"signInViaRedirect":return!0
case"signInViaPopup":return this.g==e&&!!this.f
default:return!1}},t.ha=function(t,e,n,i){"signInViaPopup"==t&&this.g==i&&(n&&this.v?this.v(n):e&&!n&&this.f&&this.f(e),this.b&&(this.b.cancel(),this.b=null),delete this.f,delete this.v)},t.xa=function(t,e){return"signInViaRedirect"==t||"signInViaPopup"==t&&this.g==e&&this.f?E(this.Zb,this):null},t.Zb=function(t,e,n){var i=this
...
var i=e.uid
n=null!=n&&""!==n&&null!=i&&""!==i&&n==i}if(n)return Nc(ih(t),e),ih(t).F();(ih(t)||e)&&(th(t,e),e&&(yc(e),e.ba=t.A),t.a&&t.a.subscribe(t),oh(t))}})},t.Z=function(t){return Gc(this.h,t)},t.$b=function(){oh(this),this.Z(ih(this))},t.jc=function(){this.pb()},t.kc=function(){this.pb()},t.mc=function(t){var e=this
this.addAuthTokenListener(function(){t.next(ih(e))})},t.nc=function(t){var e=this
!function(t,e){t.I.push(e),ah(t,t.i.then(function(){!t.l&&q(t.I,e)&&t.O!==t.getUid()&&(t.O=t.getUid(),e(rh(t)))}))}(this,function(){t.next(ih(e))})},t.vc=function(t,e,n){var i=this
return this.X&&Promise.resolve().then(function(){b(t)?t(ih(i)):b(t.next)&&t.next(ih(i))}),this.Sb(t,e,n)},t.uc=function(t,e,n){var i=this
return this.X&&Promise.resolve().then(function(){i.O=i.getUid(),b(t)?t(ih(i)):b(t.next)&&t.next(ih(i))}),this.Tb(t,e,n)},t.ac=function(t){var e=this
...
return this.i.then(function(){return eh(n,vs(n.c,ls,{email:t,password:e}))})},t.Vb=function(t,e){var n=this
return this.i.then(function(){return eh(n,vs(n.c,Ba,{email:t,password:e}))})},t.Nb=function(t){var e=this
return this.i.then(function(){return eh(e,t.la(e.c))})},t.nb=function(t){return Di("firebase.auth.Auth.prototype.signInAndRetrieveDataWithCredential is deprecated. Please use firebase.auth.Auth.prototype.signInWithCredential instead."),this.Nb(t)},t.ob=function(){var t=this
...
return Ac(n,"isAnonymous",!0),t.Z(n),e})})},t.getUid=function(){return ih(this)&&ih(this).uid||null},t.Ub=function(t){this.addAuthTokenListener(t),this.u++,0<this.u&&ih(this)&&vc(ih(this))},t.Cc=function(t){var e=this
...
return this.N=[],this.h&&(t=this.h).b.removeListener(Bc("local"),t.a,this.ka),this.a&&(this.a.unsubscribe(this),this.a.Ya()),Promise.resolve()},t.Yb=function(t){return ah(this,function(t,e){return vs(t,Ga,{identifier:e,continueUri:bi()?Yn():"http://localhost"}).then(function(t){return t.signinMethods||[]})}(this.c,t))},t.oc=function(t){return!!eo(t)},t.lb=function(t,e){var n=this
...
return ur(t)}).then(function(e){return n.c.lb(t,e)}).then(function(){}))},t.Rc=function(t){return this.Ka(t).then(function(t){return t.data.email})},t.Za=function(t,e){return ah(this,this.c.Za(t,e).then(function(){}))},t.Ka=function(t){return ah(this,this.c.Ka(t).then(function(t){return new Vi(t)}))},t.Wa=function(t){return ah(this,this.c.Wa(t).then(function(){}))},t.kb=function(t,e){var n=this
return ah(this,_t().then(function(){return void 0===e||ut(e)?{}:ur(new Zi(e))}).then(function(e){return n.c.kb(t,e)}).then(function(){}))},t.Hc=function(t,e){return ah(this,ec(this,t,e,E(this.nb,this)))},t.Gc=function(t,e){var n=this
return ah(this,_t().then(function(){var i=to(t,e||Yn())
return n.nb(i)}))},sh.prototype.render=function(){},sh.prototype.reset=function(){},sh.prototype.getResponse=function(){},sh.prototype.execute=function(){}
var ch=null
