(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[8],{191:function(t,e,n){"use strict"
n.r(e)
...
return self&&"ServiceWorkerGlobalScope"in self?new k(t):new O(t)},R)}}]),(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[4],{188:function(t,e,n){"use strict"
...
if(r.isEqual(Sn.INSTANCE)){if(n!==Yr.EQUAL)throw new T(E.INVALID_ARGUMENT,"Invalid query. Null supports only equality comparisons.")
return new e(t,n,r)}if(r.isEqual(Dn.NAN)){if(n!==Yr.EQUAL)throw new T(E.INVALID_ARGUMENT,"Invalid query. NaN supports only equality comparisons.")
...
function li(t){return t instanceof Un?t.internalValue.slice():[]}var fi,pi,di=function(){function t(t){this.count=t}return t.prototype.isEqual=function(t){return t&&t.count===this.count},t}(),yi=((fi={})[ni.ASCENDING.name]="ASCENDING",fi[ni.DESCENDING.name]="DESCENDING",fi),mi=((pi={})[Yr.LESS_THAN.name]="LESS_THAN",pi[Yr.LESS_THAN_OR_EQUAL.name]="LESS_THAN_OR_EQUAL",pi[Yr.GREATER_THAN.name]="GREATER_THAN",pi[Yr.GREATER_THAN_OR_EQUAL.name]="GREATER_THAN_OR_EQUAL",pi[Yr.EQUAL.name]="EQUAL",pi[Yr.ARRAY_CONTAINS.name]="ARRAY_CONTAINS",pi[Yr.IN.name]="IN",pi[Yr.ARRAY_CONTAINS_ANY.name]="ARRAY_CONTAINS_ANY",pi),gi=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/)
function vi(t,e){_(!hr(t),e+" is missing")}function _i(t){return"number"==typeof t?t:"string"==typeof t?Number(t):v("can't parse "+t)}var bi=function(){function t(t,e){this.databaseId=t,this.options=e}return t.prototype.emptyByteString=function(){return this.options.useProto3Json?"":new Uint8Array(0)},t.prototype.unsafeCastProtoByteString=function(t){return t},t.prototype.fromRpcStatus=function(t){var e=void 0===t.code?E.UNKNOWN:Nr(t.code)
...
return new Et(e,n)},t.prototype.fromIso8601String=function(t){var e=0,n=gi.exec(t)
...
return new Un(n.map(function(t){return e.fromValue(t)}))}if("timestampValue"in t)return vi(t.timestampValue,"timestampValue"),new On(this.fromTimestamp(t.timestampValue))
if("geoPointValue"in t){vi(t.geoPointValue,"geoPointValue")
var r=t.geoPointValue.latitude||0,i=t.geoPointValue.longitude||0
return new Ln(new Gr(r,i))}if("bytesValue"in t){vi(t.bytesValue,"bytesValue")
var o=this.fromBlob(t.bytesValue)
return new xn(o)}if("referenceValue"in t){vi(t.referenceValue,"referenceValue")
...
return t.forEach(function(t){n.push(e.toValue(t))}),{values:n}},t.prototype.fromFound=function(t){_(!!t.found,"Tried to deserialize a found document from a missing document."),vi(t.found.name,"doc.found.name"),vi(t.found.updateTime,"doc.found.updateTime")
...
e=new qr(n,r,i,a||null)}else if("documentChange"in t){vi(t.documentChange,"documentChange"),vi(t.documentChange.document,"documentChange.name"),vi(t.documentChange.document.name,"documentChange.document.name"),vi(t.documentChange.document.updateTime,"documentChange.document.updateTime")
...
e=new Fr(f,p,l.key,l)}else if("documentDelete"in t){vi(t.documentDelete,"documentDelete"),vi(t.documentDelete.document,"documentDelete.document")
var d=t.documentDelete
u=this.fromName(d.document),c=d.readTime?this.fromVersion(d.readTime):Tt.forDeletedDoc(),l=new ye(u,c),p=d.removedTargetIds||[],e=new Fr([],p,l.key,l)}else if("documentRemove"in t){vi(t.documentRemove,"documentRemove"),vi(t.documentRemove.document,"documentRemove")
...
var m=t.filter,g=m.count||0,_=new di(g),b=m.targetId
...
_(i instanceof Cn,"NUMERIC_ADD transform requires a NumberValue"),n=new hi(i)}else v("Unknown transform proto: "+JSON.stringify(t))
...
return qn.fromArray(e)},t}(),wi=function(){this.listeners=[]},Ei=function(){function t(t){this.syncEngine=t,this.queries=new ge(function(t){return t.canonicalId()}),this.onlineState=dr.Unknown,this.syncEngine.subscribe(this)}return t.prototype.listen=function(t){var e=t.query,n=!1,r=this.queries.get(e)
...
return o&&i.error&&(o="string"==typeof i.error.message&&"string"==typeof i.error.code)&&(a=new T(i.error.code,i.error.message)),o?new t(e,i.state,a):(m(Oi,"Failed to parse target state for ID '"+e+"': "+n),null)},t.prototype.toWebStorageJSON=function(){var t={state:this.state,updateTimeMs:Date.now()}
...
return o?new t(e,a):(m(Oi,"Failed to parse client data for instance '"+e+"': "+n),null)},t}(),ji=function(){function t(t,e){this.clientId=t,this.onlineState=e}return t.fromWebStorageEntry=function(e){var n=JSON.parse(e)
return"object"===r(n)&&n.onlineState in dr&&"string"==typeof n.clientId?new t(n.clientId,dr[n.onlineState]):(m(Oi,"Failed to parse online state: "+e),null)},t}(),Bi=function(){function t(){this.activeTargetIds=Vt()}return t.prototype.addQueryTarget=function(t){_(!this.activeTargetIds.has(t),"Target with ID '"+t+"' already active."),this.activeTargetIds=this.activeTargetIds.add(t)},t.prototype.removeQueryTarget=function(t){this.activeTargetIds=this.activeTargetIds.delete(t)},t.prototype.toWebStorageJSON=function(){var t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()}
...
return y(Oi,"READ",t,e),e},t.prototype.setItem=function(t,e){y(Oi,"SET",t,e),this.storage.setItem(t,e)},t.prototype.removeItem=function(t){y(Oi,"REMOVE",t),this.storage.removeItem(t)},t.prototype.handleWebStorageEvent=function(t){var e=this
if(t.storageArea===this.storage){if(y(Oi,"EVENT",t.key,t.newValue),t.key===this.localClientStorageKey)return void m("Received WebStorage notification for local change. Another client might have garbage-collected our state")
...
_("number"==typeof n,"Found non-numeric sequence number"),e=n}catch(t){m(Oi,"Failed to read sequence number from WebStorage",t)}return e}(t.newValue))!==ot.INVALID&&this.sequenceNumberHandler(a))
...
this.setItem(r,i.toWebStorageJSON())},t.prototype.toWebStorageClientStateKey=function(t){return _(-1===t.indexOf("_"),"Client key cannot contain '_', but was '"+t+"'"),Pi+"_"+this.persistenceKey+"_"+t},t.prototype.toWebStorageQueryTargetMetadataKey=function(t){return Mi+"_"+this.persistenceKey+"_"+t},t.prototype.toWebStorageMutationBatchKey=function(t){var e=xi+"_"+this.persistenceKey+"_"+t
...
var r=Number(n[1])
return qi.fromWebStorageEntry(r,e)},t.prototype.fromWebStorageOnlineState=function(t){return ji.fromWebStorageEntry(t)},t.prototype.handleMutationBatchEvent=function(t){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(e){return t.user.uid!==this.currentUser.uid?(y(Oi,"Ignoring mutation for non-active user "+t.user.uid),[2]):[2,this.syncEngine.applyBatchState(t.batchId,t.state,t.error)]})})},t.prototype.handleQueryTargetEvent=function(t){return this.syncEngine.applyTargetState(t.targetId,t.state,t.error)},t.prototype.handleClientStateEvent=function(t,e){var n=this,r=this.getAllActiveQueryTargets()
...
if(t instanceof go)return new Mn(t.databaseId,t.key)
...
function _o(t){return!("object"!==r(t)||null===t||t instanceof Array||t instanceof Date||t instanceof Et||t instanceof Gr||t instanceof tt||t instanceof go||t instanceof io)}function bo(t,e,n){if(!_o(n)||!V(n)){var r=j(n)
...
return this._dataConverter=new vo(function(t){if(t instanceof xo){var n=e._config.databaseId,r=t.firestore._config.databaseId
...
return new go(e._config.databaseId,t._key)}return t}),this._firestoreClient=new Hi(b.getPlatform(),n,this._config.credentials,this._queue),this._firestoreClient.start(t)},t.databaseIdFromApp=function(t){var e=t.options
...
break
default:throw new T(E.INVALID_ARGUMENT,"Invalid log level: "+t)}},t.prototype._areTimestampsInSnapshotsEnabled=function(){return this._config.settings.timestampsInSnapshots},t}(),Oo=function(){function t(t,e){this._firestore=t,this._transaction=e}return t.prototype.get=function(t){var e=this
...
var r=Qo("Transaction.set",t,this._firestore),i=(n=jo("Transaction.set",n)).merge||n.mergeFields?this._firestore._dataConverter.parseMergeData("Transaction.set",e,n.mergeFields):this._firestore._dataConverter.parseSetData("Transaction.set",e)
...
return"string"==typeof e||e instanceof Yi?(O("Transaction.update",arguments,3),r=Qo("Transaction.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateVarargs("Transaction.update",e,n,o)):(R("Transaction.update",arguments,2),r=Qo("Transaction.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateData("Transaction.update",e)),this._transaction.update(r._key,i),this},t.prototype.delete=function(t){R("Transaction.delete",arguments,1)
var e=Qo("Transaction.delete",t,this._firestore)
return this._transaction.delete(e._key),this},t}(),Po=function(){function t(t){this._firestore=t,this._mutations=[],this._committed=!1}return t.prototype.set=function(t,e,n){P("WriteBatch.set",arguments,2,3),this.verifyNotCommitted()
var r=Qo("WriteBatch.set",t,this._firestore),i=(n=jo("WriteBatch.set",n)).merge||n.mergeFields?this._firestore._dataConverter.parseMergeData("WriteBatch.set",e,n.mergeFields):this._firestore._dataConverter.parseSetData("WriteBatch.set",e)
...
return this.verifyNotCommitted(),"string"==typeof e||e instanceof Yi?(O("WriteBatch.update",arguments,3),r=Qo("WriteBatch.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateVarargs("WriteBatch.update",e,n,o)):(R("WriteBatch.update",arguments,2),r=Qo("WriteBatch.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateData("WriteBatch.update",e)),this._mutations=this._mutations.concat(i.toMutations(r._key,Bn.exists(!0))),this},t.prototype.delete=function(t){R("WriteBatch.delete",arguments,1),this.verifyNotCommitted()
...
var n=(e=jo("DocumentReference.set",e)).merge||e.mergeFields?this.firestore._dataConverter.parseMergeData("DocumentReference.set",t,e.mergeFields):this.firestore._dataConverter.parseSetData("DocumentReference.set",t)
...
return"string"==typeof t||t instanceof Yi?(O("DocumentReference.update",arguments,2),n=this.firestore._dataConverter.parseUpdateVarargs("DocumentReference.update",t,e,r)):(R("DocumentReference.update",arguments,1),n=this.firestore._dataConverter.parseUpdateData("DocumentReference.update",t)),this._firestoreClient.write(n.toMutations(this._key,Bn.exists(!0)))},t.prototype.delete=function(){return R("DocumentReference.delete",arguments,0),this._firestoreClient.write([new Hn(this._key,Bn.NONE)])},t.prototype.onSnapshot=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
...
return P("DocumentReference.get",arguments,0,1),Wo("DocumentReference.get",t),new Promise(function(n,r){t&&"cache"===t.source?e.firestore.ensureClientConfigured().getDocumentFromLocalCache(e._key).then(function(t){n(new Lo(e.firestore,e._key,t,!0,t instanceof de&&t.hasLocalMutations))},r):e.getViaSnapshotListener(n,r,t)})},t.prototype.getViaSnapshotListener=function(t,e,n){var r=this.onSnapshotInternal({includeMetadataChanges:!0,waitForSyncWhenOnline:!0},{next:function(i){r(),!i.exists&&i.metadata.fromCache?e(new T(E.UNAVAILABLE,"Failed to get document because the client is offline.")):i.exists&&i.metadata.fromCache&&n&&"server"===n.source?e(new T(E.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):t(i)},error:e})},t}(),Mo=function(){function t(t,e){this.hasPendingWrites=t,this.fromCache=e}return t.prototype.isEqual=function(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache},t}(),Lo=function(){function t(t,e,n,r,i){this._firestore=t,this._key=e,this._document=n,this._fromCache=r,this._hasPendingWrites=i}return t.prototype.data=function(t){return P("DocumentSnapshot.data",arguments,0,1),t=Bo("DocumentSnapshot.data",t),this._document?this.convertObject(this._document.data,En.fromSnapshotOptions(t,this._firestore._areTimestampsInSnapshotsEnabled())):void 0},t.prototype.get=function(t,e){if(P("DocumentSnapshot.get",arguments,1,2),e=Bo("DocumentSnapshot.get",e),this._document){var n=this._document.data.field(wo("DocumentSnapshot.get",t))
...
R("Query.where",arguments,3),B("Query.where",3,r),"in"!==n&&"array-contains-any"!==n&&function(t,e,n,r){if(!e.some(function(t){return t===r}))throw new T(E.INVALID_ARGUMENT,"Invalid value "+j(r)+" provided to function Query.where() for its "+K(2)+" argument. Acceptable values: "+e.join(", "))}(0,["<","<=","==",">=",">","array-contains"],0,n)
...
if(P("Query.orderBy",arguments,1,2),M("Query.orderBy","non-empty string",2,n),void 0===n||"asc"===n)r=ni.ASCENDING
...
return this.firestore===e.firestore&&this._query.isEqual(e._query)},t.prototype.boundFromDocOrFields=function(t,e,n,r){if(B(t,1,e),e instanceof Lo){if(n.length>0)throw new T(E.INVALID_ARGUMENT,"Too many arguments provided to "+t+"().")
var i=e
...
P("QuerySnapshot.forEach",arguments,1,2),x("QuerySnapshot.forEach","function",1,t),this._snapshot.docs.forEach(function(r){t.call(e,n.convertToDocumentImpl(r))})},Object.defineProperty(t.prototype,"query",{get:function(){return new Uo(this._originalQuery,this._firestore)},enumerable:!0,configurable:!0}),t.prototype.docChanges=function(t){t&&(W("QuerySnapshot.docChanges",t,["includeMetadataChanges"]),F("QuerySnapshot.docChanges","boolean","includeMetadataChanges",t.includeMetadataChanges))
...
function jo(t,e){if(void 0===e)return{merge:!1}
...
for(var o=0;o<r.length;++o)if(!i(r[o]))throw new T(E.INVALID_ARGUMENT,"Function "+t+"() requires all "+e+" elements to be "+n+", but the value at index "+o+" was: "+j(r[o]))}(t,e,n,r,i)}(t,"mergeFields","a string or a FieldPath",e.mergeFields,function(t){return"string"==typeof t||t instanceof Yi}),void 0!==e.mergeFields&&void 0!==e.merge)throw new T(E.INVALID_ARGUMENT,"Invalid options passed to function "+t+'(): You cannot specify both "merge" and "mergeFields".')
return e}function Bo(t,e){return void 0===e?{}:(W(t,e,["serverTimestamps"]),U(t,0,"serverTimestamps",e.serverTimestamps,["estimate","previous","none"]),e)}function Wo(t,e){M(t,"object",1,e),e&&(W(t,e,["source"]),U(t,0,"source",e.source,["default","server","cache"]))}function Qo(t,e,n){if(e instanceof xo){if(e.firestore!==n)throw new T(E.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.")
...
e.default=ur}}]),(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[6],{189:function(t,e,n){"use strict"
n.r(e),n(197)},197:function(t,e,n){"use strict"
function r(t){return(r="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(t){return typeof t}:function(t){return t&&"function"==typeof Symbol&&t.constructor===Symbol&&t!==Symbol.prototype?"symbol":typeof t})(t)}Object.defineProperty(e,"__esModule",{value:!0})
...
return S.getInstance().firebaseAppInstance=t,new tt(t)},{})}!function(t){h=t}(window),nt(o),e.registerPerformance=nt},199:function(t,e,n){"use strict"
n.r(e),n.d(e,"registerInstallations",function(){return z})
var r,i=n(63),o=n.n(i),a=n(0),s=n(64),u=n(200),c=1e4,h="w:0.2.1",l="FIS_v2",f="https://firebaseinstallations.googleapis.com/v1",p=36e5,d=((r={})["missing-app-config-values"]="Missing App configuration values.",r["create-installation-failed"]="Could not register Firebase Installation.",r["generate-token-failed"]="Could not generate Auth Token.",r["not-registered"]="Firebase Installation is not registered.",r["installation-not-found"]="Firebase Installation not found.",r["request-failed"]='{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',r["app-offline"]="Could not process request. Application offline.",r["delete-pending-registration"]="Can't delete installation while there is a pending registration request.",r),y=new s.ErrorFactory("installations","Installations",d)
...
u.isNodeSdk()&&(t.exports=r)}wn(a),e.DataSnapshot=zt,e.Database=pn,e.OnDisconnect=vt,e.Query=Zt,e.Reference=sn,e.ServerValue=bn,e.enableLogging=w,e.registerDatabase=wn}}]),(window.webpackJsonp_ember_auto_import_=window.webpackJsonp_ember_auto_import_||[]).push([[9],{192:function(t,e,n){"use strict"
n.r(e)
...
var G=function(){function t(t,e){var n=0,r=""
...
throw Error("This browser doesn't seem to support creating Blobs")}.apply(null,r))}var i=e.map(function(t){return q(t)?I(E.RAW,t).data:t.data_}),o=0
i.forEach(function(t){o+=t.byteLength})
var a=new Uint8Array(o),s=0
return i.forEach(function(t){for(var e=0;e<t.length;e++)a[s++]=t[e]}),new t(a,!0)},t.prototype.uploadData=function(){return this.data_},t}(),H=function(){function t(t,e){this.bucket=t,this.path_=e}return Object.defineProperty(t.prototype,"path",{get:function(){return this.path_},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"isRoot",{get:function(){return 0===this.path.length},enumerable:!0,configurable:!0}),t.prototype.fullServerUrl=function(){var t=encodeURIComponent
...
return n},t}()
function z(t){var e,n
try{e=JSON.parse(t)}catch(t){return null}return F(n=e)&&!Array.isArray(n)?e:null}function Y(t){var e=t.lastIndexOf("/",t.length-2)
return-1===e?t:t.slice(e+1)}function X(t){return"https://"+s+"/v0"+t}function J(t){var e=encodeURIComponent,n="?"
for(var r in t)t.hasOwnProperty(r)&&(n=n+(e(r)+"=")+e(t[r])+"&")
return n.slice(0,-1)}function $(t,e){return e}var Z=function(t,e,n,r){this.server=t,this.local=e||t,this.writable=!!n,this.xform=r||$},tt=null
function et(t,e,n){var r=z(e)
return null===r?null:function(t,e,n){for(var r={type:"file"},i=n.length,o=0;o<i;o++){var a=n[o]
r[a.local]=a.xform(r,e[a.server])}return function(t,e){Object.defineProperty(t,"ref",{get:function(){var n=t.bucket,r=t.fullPath,i=new H(n,r)
return e.makeStorageReference(i)}})}(r,t),r}(t,r,n)}function nt(t,e){for(var n={},r=e.length,i=0;i<r;i++){var o=e[i]
o.writable&&(n[o.server]=t[o.local])}return JSON.stringify(n)}function rt(t){if(!F(t)||!t)throw"Expected Metadata object."
for(var e in t)if(t.hasOwnProperty(e)){var n=t[e]
if("customMetadata"===e){if(!F(n))throw"Expected object for 'customMetadata' mapping."}else if(U(n))throw"Mapping for '"+e+"' cannot be an object."}}var it="maxResults",ot=1e3,at="pageToken",st="prefixes",ut="items"
function ct(t){if(!F(t)||!t)throw"Expected ListOptions object."
for(var e in t)if(e===it){if(!V(t[it])||t[it]<=0)throw"Expected maxResults to be a positive number."
if(t[it]>1e3)throw"Expected maxResults to be less than or equal to "+ot+"."}else{if(e!==at)throw"Unknown option: "+e
if(t[at]&&!q(t[at]))throw"Expected pageToken to be string."}}var ht=function(t,e,n,r){this.url=t,this.method=e,this.handler=n,this.timeout=r,this.urlParams={},this.headers={},this.body=null,this.errorHandler=null,this.progressCallback=null,this.successCodes=[200],this.additionalRetryCodes=[]}
function lt(t){if(!t)throw y()}function ft(t,e){return function(n,r){var i=et(t,r,e)
return lt(null!==i),i}}function pt(t){return function(e,n){var r=function(t,e){var n=z(e)
...
if(e[st])try{for(var h=Object(o.__values)(e[st]),l=h.next();!l.done;l=h.next()){var d=l.value.replace(/\/$/,""),y=t.makeStorageReference(new H(c,d))
s.prefixes.push(y)}}catch(t){n={error:t}}finally{try{l&&!l.done&&(r=h.return)&&r.call(h)}finally{if(n)throw n.error}}if(e[ut])try{for(var m=Object(o.__values)(e[ut]),g=m.next();!g.done;g=m.next()){var v=g.value
y=t.makeStorageReference(new H(c,v.name)),s.items.push(y)}}catch(t){i={error:t}}finally{try{g&&!g.done&&(a=m.return)&&a.call(m)}finally{if(i)throw i.error}}return s}(t,n)}(t,n)
return lt(null!==r),r}}function dt(t){return function(e,n){var r,i,o
return 401===e.getStatus()?r=new f(p.UNAUTHENTICATED,"User is not authenticated, please authenticate using Firebase Authentication and try again."):402===e.getStatus()?(o=t.bucket,r=new f(p.QUOTA_EXCEEDED,"Quota for bucket '"+o+"' exceeded, please view quota on https://firebase.google.com/pricing/.")):403===e.getStatus()?(i=t.path,r=new f(p.UNAUTHORIZED,"User does not have permission to access '"+i+"'.")):r=n,r.setServerResponseProp(n.serverResponseProp()),r}}function yt(t){var e=dt(t)
return function(n,r){var i,o=e(n,r)
return 404===n.getStatus()&&(i=t.path,o=new f(p.OBJECT_NOT_FOUND,"Object '"+i+"' does not exist.")),o.setServerResponseProp(r.serverResponseProp()),o}}function mt(t,e,n){var r=X(e.fullServerUrl()),i=t.maxOperationRetryTime(),o=new ht(r,"GET",ft(t,n),i)
return o.errorHandler=yt(e),o}function gt(t,e,n){var r=Object.assign({},n)
return r.fullPath=t.path,r.size=e.size(),r.contentType||(r.contentType=function(t,e){return e&&e.type()||"application/octet-stream"}(0,e)),r}var vt=function(t,e,n,r){this.current=t,this.total=e,this.finalized=!!n,this.metadata=r||null}
function _t(t,e){var n=null
try{n=t.getResponseHeader("X-Goog-Upload-Status")}catch(t){lt(!1)}return lt(!!n&&-1!==(e||["active"]).indexOf(n)),n}var bt=function(t,e,n){if(L(t)||x(e)||x(n))this.next=t,this.error=e||null,this.complete=n||null
else{var r=t
this.next=r.next||null,this.error=r.error||null,this.complete=r.complete||null}},wt=function(t,e,n,r,i,o){this.bytesTransferred=t,this.totalBytes=e,this.state=n,this.metadata=r,this.task=i,this.ref=o}
function Et(t,e,n){for(var r=e.length,i=e.length,o=0;o<e.length;o++)if(e[o].optional){r=o
...
for(o=0;o<n.length;o++)try{e[o].validator(n[o])}catch(e){throw e instanceof Error?v(o,t,e.message):v(o,t,e)}}var Tt=function(t,e){var n=this
this.validator=function(e){n.optional&&!M(e)||t(e)},this.optional=!!e}
function St(t,e){function n(t){if(!q(t))throw"Expected string."}var r,i,o
return t?(i=n,o=t,r=function(t){i(t),o(t)}):r=n,new Tt(r,e)}function It(t){return new Tt(rt,t)}function Ct(){return new Tt(function(t){if(!(j(t)&&t>=0))throw"Expected a number 0 or greater."})}function Nt(t,e){return new Tt(function(e){if(!(null===e||x(e)&&e instanceof Object))throw"Expected an Object."
null!=t&&t(e)},e)}function kt(t){return new Tt(function(t){if(null!==t&&!L(t))throw"Expected a Function."},t)}function At(t){return function(){for(var e=[],n=0;n<arguments.length;n++)e[n]=arguments[n]
Promise.resolve().then(function(){return t.apply(void 0,Object(o.__spread)(e))})}}var Dt=function(){function t(t,e,n,r,i,o){var a=this
...
this.resolveToken_(function(e){var n=function(t,e,n,r,i){var o=e.bucketOnlyServerUrl(),a=gt(e,r,i),s={name:a.fullPath},u=X(o),c={"X-Goog-Upload-Protocol":"resumable","X-Goog-Upload-Command":"start","X-Goog-Upload-Header-Content-Length":r.size(),"X-Goog-Upload-Header-Content-Type":a.contentType,"Content-Type":"application/json; charset=utf-8"},h=nt(a,n),l=t.maxUploadRetryTime(),f=new ht(u,"POST",function(t){var e
_t(t)
try{e=t.getResponseHeader("X-Goog-Upload-URL")}catch(t){lt(!1)}return lt(q(e)),e},l)
return f.urlParams=s,f.headers=c,f.body=h,f.errorHandler=dt(e),f}(t.authWrapper_,t.location_,t.mappings_,t.blob_,t.metadata_),r=t.authWrapper_.makeRequest(n,e)
...
this.resolveToken_(function(n){var r=function(t,e,n,r){var i=t.maxUploadRetryTime(),o=new ht(n,"POST",function(t){var e=_t(t,["active","final"]),n=null
try{n=t.getResponseHeader("X-Goog-Upload-Size-Received")}catch(t){lt(!1)}n||lt(!1)
var i=Number(n)
return lt(!isNaN(i)),new vt(i,r.size(),"final"===e)},i)
return o.headers={"X-Goog-Upload-Command":"query"},o.errorHandler=dt(e),o}(t.authWrapper_,t.location_,e,t.blob_),i=t.authWrapper_.makeRequest(r,n)
...
try{o=function(t,e,n,r,i,o,a,s){var u=new vt(0,0)
...
if(null===m)throw g()
var v=e.maxUploadRetryTime(),_=new ht(n,"POST",function(t,n){var i,a=_t(t,["active","final"]),s=u.current+h,c=r.size()
return i="final"===a?ft(e,o)(t,n):null,new vt(s,c,"final"===a,i)},v)
return _.headers=y,_.body=m.uploadData(),_.progressCallback=s||null,_.errorHandler=dt(t),_}(t.location_,t.authWrapper_,r,t.blob_,e,t.mappings_,n,t.makeProgressCallback_())}catch(e){return t.error_=e,void t.transition_(R.ERROR)}var a=t.authWrapper_.makeRequest(o,i)
...
this.resolveToken_(function(e){var n=mt(t.authWrapper_,t.location_,t.mappings_),r=t.authWrapper_.makeRequest(n,e)
...
if(null===l)throw g()
var f={name:u.fullPath},p=X(o),d=t.maxUploadRetryTime(),y=new ht(p,"POST",ft(t,n),d)
return y.urlParams=f,y.headers=a,y.body=l.uploadData(),y.errorHandler=dt(e),y}(t.authWrapper_,t.location_,t.mappings_,t.blob_,t.metadata_),r=t.authWrapper_.makeRequest(n,e)
...
return new wt(this.transferred_,this.blob_.size(),t,this.metadata_,this,this.ref_)},enumerable:!0,configurable:!0}),t.prototype.on=function(t,e,n,r){var i="Expected a function or an Object with one of `next`, `error`, `complete` properties.",o=kt(!0).validator,a=Nt(null,!0).validator
function s(t){try{return void o(t)}catch(t){}try{if(a(t),!(M(t.next)||M(t.error)||M(t.complete)))throw""
return}catch(t){throw i}}Et("on",[St(function(){if(t!==D.STATE_CHANGED)throw"Expected one of the event types: ["+D.STATE_CHANGED+"]."}),Nt(s,!0),kt(!0),kt(!0)],arguments)
var u=this
function c(t){return function(e,n,i){null!==t&&Et("on",t,arguments)
var o=new bt(e,n,r)
return u.addObserver_(o),function(){u.removeObserver_(o)}}}var h=[Nt(function(t){if(null===t)throw i
s(t)}),kt(!0),kt(!0)]
return M(e)||M(n)||M(r)?c(null)(e,n,r):c(h)},t.prototype.then=function(t,e){return this.promise_.then(t,e)},t.prototype.catch=function(t){return this.then(null,t)},t.prototype.addObserver_=function(t){this.observers_.push(t),this.notifyObserver_(t)},t.prototype.removeObserver_=function(t){var e=this.observers_.indexOf(t);-1!==e&&this.observers_.splice(e,1)},t.prototype.notifyObservers_=function(){var t=this
...
switch(P(this.state_)){case O.SUCCESS:At(this.resolve_.bind(null,this.snapshot))()
break
case O.CANCELED:case O.ERROR:At(this.reject_.bind(null,this.error_))()
break
default:t=!1}t&&(this.resolve_=null,this.reject_=null)}},t.prototype.notifyObserver_=function(t){switch(P(this.state_)){case O.RUNNING:case O.PAUSED:t.next&&At(t.next.bind(t,this.snapshot))()
break
case O.SUCCESS:t.complete&&At(t.complete.bind(t))()
break
case O.CANCELED:case O.ERROR:t.error&&At(t.error.bind(t,this.error_))()
break
default:t.error&&At(t.error.bind(t,this.error_))()}},t.prototype.resume=function(){Et("resume",[],arguments)
var t=this.state_===R.PAUSED||this.state_===R.PAUSING
return t&&this.transition_(R.RUNNING),t},t.prototype.pause=function(){Et("pause",[],arguments)
var t=this.state_===R.RUNNING
return t&&this.transition_(R.PAUSING),t},t.prototype.cancel=function(){Et("cancel",[],arguments)
var t=this.state_===R.RUNNING||this.state_===R.PAUSING
return t&&this.transition_(R.CANCELING),t},t}(),Rt=function(){function t(t,e){this.authWrapper=t,this.location=e instanceof H?e:H.makeFromUrl(e)}return t.prototype.toString=function(){return Et("toString",[],arguments),"gs://"+this.location.bucket+"/"+this.location.path},t.prototype.newRef=function(e,n){return new t(e,n)},t.prototype.mappings=function(){return function(){if(tt)return tt
var t=[]
t.push(new Z("bucket")),t.push(new Z("generation")),t.push(new Z("metageneration")),t.push(new Z("name","fullPath",!0))
var e=new Z("name")
e.xform=function(t,e){return function(t){return!q(t)||t.length<2?t:Y(t)}(e)},t.push(e)
var n=new Z("size")
return n.xform=function(t,e){return x(e)?Number(e):e},t.push(n),t.push(new Z("timeCreated")),t.push(new Z("updated")),t.push(new Z("md5Hash",null,!0)),t.push(new Z("cacheControl",null,!0)),t.push(new Z("contentDisposition",null,!0)),t.push(new Z("contentEncoding",null,!0)),t.push(new Z("contentLanguage",null,!0)),t.push(new Z("contentType",null,!0)),t.push(new Z("metadata","customMetadata",!0)),tt=t}()},t.prototype.child=function(t){Et("child",[St()],arguments)
var e=function(t,e){var n=e.split("/").filter(function(t){return t.length>0}).join("/")
return 0===t.length?n:t+"/"+n}(this.location.path,t),n=new H(this.location.bucket,e)
...
if(null===t)return null
var e=new H(this.location.bucket,t)
return this.newRef(this.authWrapper,e)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"root",{get:function(){var t=new H(this.location.bucket,"")
return this.newRef(this.authWrapper,t)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"bucket",{get:function(){return this.location.bucket},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"fullPath",{get:function(){return this.location.path},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"name",{get:function(){return Y(this.location.path)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"storage",{get:function(){return this.authWrapper.service()},enumerable:!0,configurable:!0}),t.prototype.put=function(t,e){return void 0===e&&(e=null),Et("put",[new Tt(function(t){if(!(t instanceof Uint8Array||t instanceof ArrayBuffer||W()&&t instanceof Blob))throw"Expected Blob or File."}),It(!0)],arguments),this.throwIfRoot_("put"),new Dt(this,this.authWrapper,this.location,this.mappings(),new G(t),e)},t.prototype.putString=function(t,e,n){void 0===e&&(e=E.RAW),Et("putString",[St(),St(T,!0),It(!0)],arguments),this.throwIfRoot_("putString")
var r=I(e,t),i=Object.assign({},n)
return!x(i.contentType)&&x(r.contentType)&&(i.contentType=r.contentType),new Dt(this,this.authWrapper,this.location,this.mappings(),new G(r.data,!0),i)},t.prototype.delete=function(){var t=this
return Et("delete",[],arguments),this.throwIfRoot_("delete"),this.authWrapper.getAuthToken().then(function(e){var n=function(t,e){var n=X(e.fullServerUrl()),r=t.maxOperationRetryTime(),i=new ht(n,"DELETE",function(t,e){},r)
return i.successCodes=[200,204],i.errorHandler=yt(e),i}(t.authWrapper,t.location)
return t.authWrapper.makeRequest(n,e).getPromise()})},t.prototype.listAll=function(){Et("listAll",[],arguments)
...
case 3:return[2]}})})},t.prototype.list=function(t){Et("list",[(!0,new Tt(ct,!0))],arguments)
var e=this
...
var a=X(e.bucketOnlyServerUrl()),s=t.maxOperationRetryTime(),u=new ht(a,"GET",pt(t),s)
return u.urlParams=o,u.errorHandler=dt(e),u}(e.authWrapper,e.location,0,r.pageToken,r.maxResults)
return e.authWrapper.makeRequest(i,n).getPromise()})},t.prototype.getMetadata=function(){var t=this
return Et("getMetadata",[],arguments),this.throwIfRoot_("getMetadata"),this.authWrapper.getAuthToken().then(function(e){var n=mt(t.authWrapper,t.location,t.mappings())
return t.authWrapper.makeRequest(n,e).getPromise()})},t.prototype.updateMetadata=function(t){var e=this
return Et("updateMetadata",[It()],arguments),this.throwIfRoot_("updateMetadata"),this.authWrapper.getAuthToken().then(function(n){var r=function(t,e,n,r){var i=X(e.fullServerUrl()),o=nt(n,r),a=t.maxOperationRetryTime(),s=new ht(i,"PATCH",ft(t,r),a)
return s.headers={"Content-Type":"application/json; charset=utf-8"},s.body=o,s.errorHandler=yt(e),s}(e.authWrapper,e.location,t,e.mappings())
return e.authWrapper.makeRequest(r,n).getPromise()})},t.prototype.getDownloadURL=function(){var t=this
return Et("getDownloadURL",[],arguments),this.throwIfRoot_("getDownloadURL"),this.authWrapper.getAuthToken().then(function(e){var n=function(t,e,n){var r=X(e.fullServerUrl()),i=t.maxOperationRetryTime(),o=new ht(r,"GET",function(t,e){return function(n,r){var i=et(t,r,e)
return lt(null!==i),function(t,e){var n=z(e)
...
return X("/b/"+i(n)+"/o/"+i(r))+J({alt:"media",token:e})})[0]}(i,r)}}(t,n),i)
return o.errorHandler=yt(e),o}(t.authWrapper,t.location,t.mappings())
...
return t})})},t.prototype.throwIfRoot_=function(t){if(""===this.location.path)throw function(t){return new f(p.INVALID_ROOT_OPERATION,"The operation '"+t+"' cannot be performed on a root reference, create a non-root reference using child, such as .child('file.png').")}(t)},t}(),Ot=function(){function t(t){this.promise_=Promise.reject(t)}return t.prototype.getPromise=function(){return this.promise_},t.prototype.cancel=function(t){},t}(),Pt=function(){function t(){this.map=new Map,this.id=l}return t.prototype.addRequest=function(t){var e=this,n=this.id
this.id++,this.map.set(n,t),t.getPromise().then(function(){return e.map.delete(n)},function(){return e.map.delete(n)})},t.prototype.clear=function(){this.map.forEach(function(t){t&&t.cancel(!0)}),this.map.clear()},t}(),xt=function(){function t(e,n,r,i,o){if(this.bucket_=null,this.deleted_=!1,this.app_=e,null!==this.app_){var a=this.app_.options
x(a)&&(this.bucket_=t.extractBucket_(a))}this.storageRefMaker_=n,this.requestMaker_=r,this.pool_=o,this.service_=i,this.maxOperationRetryTime_=c,this.maxUploadRetryTime_=h,this.requestMap_=new Pt}return t.extractBucket_=function(t){var e=t[u]||null
return null==e?null:H.makeFromBucketSpec(e).bucket},t.prototype.getAuthToken=function(){return null!==this.app_&&x(this.app_.INTERNAL)&&x(this.app_.INTERNAL.getToken)?this.app_.INTERNAL.getToken().then(function(t){return null!==t?t.accessToken:null},function(){return null}):Promise.resolve(null)},t.prototype.bucket=function(){if(this.deleted_)throw _()
return this.bucket_},t.prototype.service=function(){return this.service_},t.prototype.makeStorageReference=function(t){return this.storageRefMaker_(this,t)},t.prototype.makeRequest=function(t,e){if(this.deleted_)return new Ot(_())
var n=this.requestMaker_(t,e,this.pool_)
return this.requestMap_.addRequest(n),n},t.prototype.deleteApp=function(){this.deleted_=!0,this.app_=null,this.requestMap_.clear()},t.prototype.maxUploadRetryTime=function(){return this.maxUploadRetryTime_},t.prototype.setMaxUploadRetryTime=function(t){this.maxUploadRetryTime_=t},t.prototype.maxOperationRetryTime=function(){return this.maxOperationRetryTime_},t.prototype.setMaxOperationRetryTime=function(t){this.maxOperationRetryTime_=t},t}(),Mt=function(){function t(t,e,n,r,i,o,a,s,u,c,h){var l=this
...
function d(t){p||(p=!0,c||(null!==i?(t||(s=2),clearTimeout(i),l(0)):t||(s=1)))}return l(0),setTimeout(function(){a=!0,d(!0)},n),d}(function(e,n){if(n)e(!1,new Lt(!1,null,!0))
...
e(!0,new Lt(a,n))}else{var s=n.getErrorCode()===k.ABORT
e(!1,new Lt(!1,null,s))}})}function i(e){var n=e.loaded,r=e.lengthComputable?e.total:-1
...
return e||n||r},t}(),Lt=function(t,e,n){this.wasSuccessCode=t,this.xhr=e,this.canceled=!!n}
function Ft(t,e,n){var r=J(t.urlParams),o=t.url+r,a=Object.assign({},t.headers)
...
t["X-Firebase-Storage-Version"]="webjs/"+e}(a),new Mt(o,t.method,a,t.body,t.successCodes,t.additionalRetryCodes,t.handler,t.errorHandler,t.timeout,t.progressCallback,n)}var Ut,qt,Vt=function(){function t(t,e,n){if(this.bucket_=null,this.authWrapper_=new xt(t,function(t,e){return new Rt(t,e)},Ft,this,e),this.app_=t,null!=n)this.bucket_=H.makeFromBucketSpec(n)
else{var r=this.authWrapper_.bucket()
null!=r&&(this.bucket_=new H(r,""))}this.internals_=new jt(this)}return t.prototype.ref=function(t){if(Et("ref",[St(function(t){if("string"!=typeof t)throw"Path is not a string."
...
var e=new Rt(this.authWrapper_,this.bucket_)
return null!=t?e.child(t):e},t.prototype.refFromURL=function(t){return Et("refFromURL",[St(function(t){if("string"!=typeof t)throw"Path is not a string."
if(!/^[A-Za-z]+:\/\//.test(t))throw"Expected full URL but got a child path, use ref instead."
try{H.makeFromUrl(t)}catch(t){throw"Expected valid full URL but got an invalid one."}},!1)],arguments),new Rt(this.authWrapper_,t)},Object.defineProperty(t.prototype,"maxUploadRetryTime",{get:function(){return this.authWrapper_.maxUploadRetryTime()},enumerable:!0,configurable:!0}),t.prototype.setMaxUploadRetryTime=function(t){Et("setMaxUploadRetryTime",[Ct()],arguments),this.authWrapper_.setMaxUploadRetryTime(t)},t.prototype.setMaxOperationRetryTime=function(t){Et("setMaxOperationRetryTime",[Ct()],arguments),this.authWrapper_.setMaxOperationRetryTime(t)},Object.defineProperty(t.prototype,"app",{get:function(){return this.app_},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"INTERNAL",{get:function(){return this.internals_},enumerable:!0,configurable:!0}),t}(),jt=function(){function t(t){this.service_=t}return t.prototype.delete=function(){return this.service_.authWrapper_.deleteApp(),Promise.resolve()},t}()
Ut=i.a,qt={TaskState:O,TaskEvent:D,StringFormat:E,Storage:Vt,Reference:Rt},Ut.INTERNAL.registerService("storage",function(t,e,n){return new Vt(t,new K,n)},qt,void 0,!0)}}])
