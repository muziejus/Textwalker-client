...
var i=function(e){function i(){return(0,t.default)(this,i),(0,r.default)(this,(0,n.default)(i).apply(this,arguments))}return(0,a.default)(i,e),i}(Ember.Route)
e.default=i}),define("wandertext/src/ui/routes/index/template",["exports"],function(e){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
var t=Ember.HTMLBars.template({id:"a1bK8lkr",block:'{"symbols":[],"statements":[[7,"h2"],[9],[0,"\\n  Welcome to Wandertext.\\n"],[10],[0,"\\n\\n"],[7,"p"],[11,"class","lead"],[9],[0,"Create and share semantically rich geospatial datasets."],[10],[0,"\\n\\n"],[7,"button"],[11,"class","btn btn-primary"],[9],[0,"Go to "],[7,"i"],[9],[0,"Nightwood"],[10],[10],[0,"\\n"],[7,"button"],[11,"class","btn btn-primary"],[9],[0,"Go to "],[7,"i"],[9],[0,"Bāburnāmā"],[10],[10],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"src/ui/routes/index/template.hbs"}})
...
return Object.defineProperty(r,"__esModule",{value:!0}),r}catch(n){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("wandertext/src/main").default.create({name:"wandertext",version:"0.0.0+9fd1a376"})
