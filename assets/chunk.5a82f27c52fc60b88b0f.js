...
return e?(D(e),Promise.resolve()):function(t){return(e=T.getInstance().firebaseAppInstance.installations().getToken(),e.then(function(t){}),e).then(function(e){var n="https://firebaseremoteconfig.googleapis.com/v1/projects/"+T.getInstance().getProjectId()+"/namespaces/fireperf:fetch?key="+T.getInstance().getApiKey(),r=new Request(n,{method:"POST",headers:{Authorization:N+" "+e},body:JSON.stringify({app_instance_id:t,app_instance_id_token:e,app_id:T.getInstance().getAppId(),app_version:m,sdk_version:P})})
return fetch(r).then(function(t){if(t.ok)return t.json()
throw S.create("RC response not ok")})}).catch(function(){O.info(x)})
var e}(t).then(function(t){return D(t)}).then(function(t){return function(t){if(t){var e=I.getInstance().localStorage
e.setItem(b,JSON.stringify(t)),e.setItem(_,String(Date.now()+60*T.getInstance().configTimeToLive*60*1e3))}}(t)},function(){})}(t)}).then(function(){return B()},function(){return B()})}function B(){C=3}var U,L=1e4,F=3,K=[]
...
!e.instrumentationEnabled&&t.isAuto||(e.dataCollectionEnabled||t.isAuto)&&I.getInstance().requiredApisAvailable()&&(t.isAuto&&k()!==d.VISIBLE||e.loggingEnabled&&e.logTraceAfterSampling&&(3===C?$(t):q().then(function(){return $(t)},function(){return $(t)})))}function $(t){E()&&setTimeout(function(){return V().log(t,1)},0)}function H(t,e){return 0===e?(r={url:(n=t).url,http_method:n.httpMethod||0,http_response_code:200,response_payload_bytes:n.responsePayloadBytes,client_start_time_us:n.startTimeUs,time_to_response_initiated_us:n.timeToResponseInitiatedUs,time_to_response_completed_us:n.timeToResponseCompletedUs},o={application_info:W(),network_request_metric:r},JSON.stringify(o)):function(t){var e={name:t.name,is_auto:t.isAuto,client_start_time_us:t.startTimeUs,duration_us:t.durationUs}
...
var n,r,o}function W(){return{google_app_id:T.getInstance().getAppId(),app_instance_id:E(),web_app_info:{sdk_version:m,page_url:I.getInstance().getUrl(),service_worker_status:(t=I.getInstance().navigator,"serviceWorker"in t?t.serviceWorker.controller?2:3:1),visibility_state:k(),effective_connection_type:A()},application_process_state:0}
...
F=3,t(r)}).catch(function(){K=a.__spread(e,K),F--,O.info("Tries left: "+F+"."),t(L)})}},e)}(5500)
var z=function(){function t(t,e,n){void 0===e&&(e=!1),this.name=t,this.isAuto=e,this.state=1,this.customAttributes={},this.counters={},this.api=I.getInstance(),this.randomId=Math.floor(1e6*Math.random()),this.isAuto||(this.traceStartMark=y+"-"+this.randomId+"-"+this.name,this.traceStopMark=g+"-"+this.randomId+"-"+this.name,this.traceMeasure=n||v+"-"+this.randomId+"-"+this.name,n&&this.calculateTraceMetrics())}return t.prototype.start=function(){if(1!==this.state)throw S.create("trace started",{traceName:this.name})
...
t.onFirstInputDelay(function(t){r&&(clearTimeout(r),z.createOobTrace(e,n,t))})}else z.createOobTrace(e,n)}()},0),setTimeout(function(){return function(){var t,e,n=I.getInstance(),r=n.getEntriesByType("resource")
try{for(var o=a.__values(r),i=o.next();!i.done;i=o.next()){Q(i.value)}}catch(e){t={error:e}}finally{try{i&&!i.done&&(e=o.return)&&e.call(o)}finally{if(t)throw t.error}}n.setupObserver("resource",Q)}()},0),setTimeout(function(){return function(){var t,e,n=I.getInstance(),r=n.getEntriesByType("measure")
try{for(var o=a.__values(r),i=o.next();!i.done;i=o.next()){Z(i.value)}}catch(e){t={error:e}}finally{try{i&&!i.done&&(e=o.return)&&e.call(o)}finally{if(t)throw t.error}}n.setupObserver("measure",Z)}()},0))}function Z(t){var e=t.name
e.substring(0,v.length)!==v&&z.createUserTimingTrace(e)}var tt=function(){function t(t){this.app=t,I.getInstance().requiredApisAvailable()?q().then(Y,Y):O.info("Firebase Performance cannot start if browser does not support fetch and Promise or cookie is disabled.")}return t.prototype.trace=function(t){return new z(t)},Object.defineProperty(t.prototype,"instrumentationEnabled",{get:function(){return T.getInstance().instrumentationEnabled},set:function(t){T.getInstance().instrumentationEnabled=t},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"dataCollectionEnabled",{get:function(){return T.getInstance().dataCollectionEnabled},set:function(t){T.getInstance().dataCollectionEnabled=t},enumerable:!0,configurable:!0}),t}(),et="[DEFAULT]"
...
try{for(;(void 0===e||e-- >0)&&!(r=i.next()).done;)a.push(r.value)}catch(t){o={error:t}}finally{try{r&&!r.done&&(n=i.return)&&n.call(i)}finally{if(o)throw o.error}}return a}function y(){for(var t=[],e=0;e<arguments.length;e++)t=t.concat(m(arguments[e]))
...
function a(t){o[t]&&(r[t]=function(e){return new Promise(function(n,r){i.push([t,e,n,r])>1||s(t,e)})})}function s(t,e){try{(n=o[t](e)).value instanceof g?Promise.resolve(n.value.v).then(u,c):f(i[0][2],n)}catch(t){f(i[0][3],t)}var n}function u(t){s("next",t)}function c(t){s("throw",t)}function f(t,e){t(e),i.shift(),i.length&&s(i[0][0],i[0][1])}}function b(t){var e,n
return e={},r("next"),r("throw",function(t){throw t}),r("return"),e[Symbol.iterator]=function(){return this},e
function r(r,o){e[r]=t[r]?function(e){return(n=!n)?{value:g(t[r](e)),done:"return"===r}:o?o(e):e}:o}}function _(t){if(!Symbol.asyncIterator)throw new TypeError("Symbol.asyncIterator is not defined.")
...
n.d(e,"registerInstallations",function(){return X})
var l,p=1e4,d="w:0.2.0",h="FIS_v2",m="https://firebaseinstallations.googleapis.com/v1",y=36e5,g=((l={})["missing-app-config-values"]="Missing App configuration values.",l["create-installation-failed"]="Could not register Firebase Installation.",l["generate-token-failed"]="Could not generate Auth Token.",l["not-registered"]="Firebase Installation is not registered.",l["installation-not-found"]="Firebase Installation not found.",l["request-failed"]='{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',l["app-offline"]="Could not process request. Application offline.",l["delete-pending-registration"]="Can't delete installation while there is a pending registration request.",l),v=new c.ErrorFactory("installations","Installations",g)
...
if(!(e&&r&&o&&i))throw v.create("missing-app-config-values")
...
case 1:return n=o.sent(),r=n.error,[2,v.create("request-failed",{requestName:t,serverCode:r.code,serverMessage:r.message,serverStatus:r.status})]}})})}function T(t){var e=t.apiKey
...
case 2:return[2,{fid:(u=s.sent()).fid||n,registrationStatus:2,refreshToken:u.refreshToken,authToken:S(u.authToken)}]
case 3:return[4,I("Create Installation",a)]
case 4:throw s.sent()}})})}function O(t){return new Promise(function(e){setTimeout(e,t)})}var P=/^[cdef][\w-]{21}$/,j=""
function N(){try{var t=new Uint8Array(17);(self.crypto||self.msCrypto).getRandomValues(t),t[0]=112+t[0]%16
...
return P.test(e)?e:j}catch(t){return j}}var x="firebase-installations-database",D=1,M="firebase-installations-store",R=null
function C(){return R||(R=Object(f.openDb)(x,D,function(t){switch(t.oldVersion){case 0:t.createObjectStore(M)}})),R}function q(t,e){return a(this,void 0,void 0,function(){var n,r,o
return s(this,function(i){switch(i.label){case 0:return n=L(t),[4,C()]
case 1:return r=i.sent(),[4,(o=r.transaction(M,"readwrite")).objectStore(M).put(e,n)]
case 2:return i.sent(),[4,o.complete]
case 3:return i.sent(),[2,e]}})})}function B(t){return a(this,void 0,void 0,function(){var e,n,r
return s(this,function(o){switch(o.label){case 0:return e=L(t),[4,C()]
case 1:return n=o.sent(),[4,(r=n.transaction(M,"readwrite")).objectStore(M).delete(e)]
case 2:return o.sent(),[4,r.complete]
case 3:return o.sent(),[2]}})})}function U(t,e){return a(this,void 0,void 0,function(){var n,r,o,i,a,u
return s(this,function(s){switch(s.label){case 0:return n=L(t),[4,C()]
case 1:return r=s.sent(),o=r.transaction(M,"readwrite"),[4,(i=o.objectStore(M)).get(n)]
...
case 7:return s.sent(),[2,u]}})})}function L(t){return t.appName+"!"+t.appId}function F(t){return a(this,void 0,void 0,function(){var e,n,r
return s(this,function(o){switch(o.label){case 0:return[4,U(t,function(n){var r=function(t){var e=n||{fid:N(),registrationStatus:0}
return J(e)?{fid:e.fid,registrationStatus:0}:e}(),o=function(t,e){if(0===e.registrationStatus){if(!navigator.onLine)return{installationEntry:e,registrationPromise:Promise.reject(v.create("app-offline"))}
...
return s(this,function(o){switch(o.label){case 0:return o.trys.push([0,2,,7]),[4,A(t,e)]
case 1:return n=o.sent(),[2,q(t,n)]
case 2:return b(r=o.sent())&&409===r.serverCode?[4,B(t)]:[3,4]
case 3:return o.sent(),[3,6]
case 4:return[4,q(t,{fid:e.fid,registrationStatus:0})]
case 5:o.sent(),o.label=6
case 6:throw r
case 7:return[2]}})})}(t,n)
return{installationEntry:n,registrationPromise:r}}return 1===e.registrationStatus?{installationEntry:e,registrationPromise:K(t)}:{installationEntry:e}}(t,r)
return e=o.registrationPromise,o.installationEntry})]
case 1:return(n=o.sent()).fid!==j?[3,3]:(r={},[4,e])
case 2:return[2,(r.installationEntry=o.sent(),r)]
case 3:return[2,{installationEntry:n,registrationPromise:e}]}})})}function K(t){return a(this,void 0,void 0,function(){var e
return s(this,function(n){switch(n.label){case 0:return[4,V(t)]
...
return[2,e]}})})}function V(t){return U(t,function(t){if(!t)throw v.create("installation-not-found")
return J(t)?{fid:t.fid,registrationStatus:0}:t})}function J(t){return 1===t.registrationStatus&&t.registrationTime+p<Date.now()}function $(t,e){return a(this,void 0,void 0,function(){var n,r,o,i,a
...
case 4:throw s.sent()}})})}function H(t){return a(this,void 0,void 0,function(){var e,n,r
return s(this,function(o){switch(o.label){case 0:return[4,U(t,function(n){if(!G(n))throw v.create("not-registered")
var r=n.authToken
if(function(t){return 2===t.requestStatus&&!function(t){var e=Date.now()
return e<t.creationTime||t.creationTime+t.expiresIn<e+y}(t)}(r))return n
if(1===r.requestStatus)return e=function(t){return a(this,void 0,void 0,function(){var e,n
return s(this,function(r){switch(r.label){case 0:return[4,W(t)]
case 1:e=r.sent(),r.label=2
case 2:return 1!==e.authToken.requestStatus?[3,5]:[4,O(100)]
case 3:return r.sent(),[4,W(t)]
...
return s(this,function(a){switch(a.label){case 0:return a.trys.push([0,3,,8]),[4,$(t,e)]
case 1:return n=a.sent(),o=i({},e,{authToken:n}),[4,q(t,o)]
case 2:return a.sent(),[2,n]
case 3:return!b(r=a.sent())||401!==r.serverCode&&404!==r.serverCode?[3,5]:[4,B(t)]
case 4:return a.sent(),[3,7]
case 5:return o=i({},e,{authToken:{requestStatus:0}}),[4,q(t,o)]
...
case 4:return[2,r.token]}})})}function W(t){return U(t,function(t){if(!G(t))throw v.create("not-registered")
var e
return 1===(e=t.authToken).requestStatus&&e.requestTime+p<Date.now()?i({},t,{authToken:{requestStatus:0}}):t})}function G(t){return void 0!==t&&2===t.registrationStatus}function z(t){return a(this,void 0,void 0,function(){var e,n,r
return s(this,function(o){switch(o.label){case 0:return[4,F(t)]
...
o.label=4
case 4:return[2]}})})}function Q(t,e){return a(this,void 0,void 0,function(){var n,r,o,i
...
case 2:throw a.sent()
case 3:return[2]}})})}function X(t){t.INTERNAL.registerService("installations",function(t){return _(t),{app:t,getId:function(){return function(t){return a(this,void 0,void 0,function(){var e,n,r,o
return s(this,function(i){switch(i.label){case 0:return[4,F(e=_(t))]
case 1:return n=i.sent(),r=n.installationEntry,(o=n.registrationPromise)&&o.catch(function(){}),2===r.registrationStatus&&H(e).catch(function(){}),[2,r.fid]}})})}(t)},getToken:function(){return function(t){return a(this,void 0,void 0,function(){var e
return s(this,function(n){switch(n.label){case 0:return[4,z(e=_(t))]
case 1:return n.sent(),[2,H(e)]}})})}(t)},delete:function(){return function(t){return a(this,void 0,void 0,function(){var e,n
return s(this,function(r){switch(r.label){case 0:return[4,U(e=_(t),function(t){if(!t||0!==t.registrationStatus)return t})]
...
case 3:return[4,Q(e,n)]
case 4:return r.sent(),[4,B(e)]
case 5:r.sent(),r.label=6
case 6:return[2]}})})}(t)}}})}X(o.a)}}])
