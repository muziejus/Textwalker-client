...
return t},t.getInstance=function(){return void 0===p&&(p=new t),p},t}()
function E(){return l}function O(){switch(S.getInstance().document.visibilityState){case"visible":return d.VISIBLE
...
function B(){var t
return R=2,q=q||(t=S.getInstance().document,new Promise(function(e){t&&"complete"!==t.readyState?t.addEventListener("readystatechange",function n(){"complete"===t.readyState&&(t.removeEventListener("readystatechange",n),e())}):e()})).then(function(){return(t=T.getInstance().firebaseAppInstance.installations().getId()).then(function(t){l=t}),t
...
e.setItem(_,JSON.stringify(t)),e.setItem(y,String(Date.now()+60*T.getInstance().configTimeToLive*60*1e3))}}(t)},function(){})}(t)}).then(function(){return U()},function(){return U()})}function U(){R=3}var x,L=1e4,F=3,K=[]
function V(){if(x)return x
var t=function(t){return function(e,n){for(var r=[],i=2;i<arguments.length;i++)r[i-2]=arguments[i];(function(t){if(!t.eventTime||!t.message)throw I.create("invalid cc log")
K=K.concat([t])})({message:t.apply(void 0,r),eventTime:Date.now()})}}(H)
return(x=new h.Logger("@firebase/performance/cc")).logHandler=t,x}function J(t){var e=T.getInstance()
!e.instrumentationEnabled&&t.isAuto||(e.dataCollectionEnabled||t.isAuto)&&S.getInstance().requiredApisAvailable()&&(t.isAuto&&O()!==d.VISIBLE||e.loggingEnabled&&e.logTraceAfterSampling&&(3===R?$(t):B().then(function(){return $(t)},function(){return $(t)})))}function $(t){E()&&setTimeout(function(){return V().log(t,1)},0)}function H(t,e){return 0===e?(r={url:(n=t).url,http_method:n.httpMethod||0,http_response_code:200,response_payload_bytes:n.responsePayloadBytes,client_start_time_us:n.startTimeUs,time_to_response_initiated_us:n.timeToResponseInitiatedUs,time_to_response_completed_us:n.timeToResponseCompletedUs},i={application_info:W(),network_request_metric:r},JSON.stringify(i)):function(t){var e={name:t.name,is_auto:t.isAuto,client_start_time_us:t.startTimeUs,duration_us:t.durationUs}
...
F=3,t(r)}).catch(function(){K=e.concat(K),F--,k.info("Tries left: "+F+"."),t(L)})}},e)}(5500)
var G=function(){function t(t,e,n){void 0===e&&(e=!1),this.name=t,this.isAuto=e,this.state=1,this.customAttributes={},this.counters={},this.api=S.getInstance(),this.randomId=Math.floor(1e6*Math.random()),this.isAuto||(this.traceStartMark=m+"-"+this.randomId+"-"+this.name,this.traceStopMark=v+"-"+this.randomId+"-"+this.name,this.traceMeasure=n||b+"-"+this.randomId+"-"+this.name,n&&this.calculateTraceMetrics())}return t.prototype.start=function(){if(1!==this.state)throw I.create("trace started",{traceName:this.name})
...
t.onFirstInputDelay(function(t){r&&(clearTimeout(r),G.createOobTrace(e,n,t))})}else G.createOobTrace(e,n)}()},0),setTimeout(function(){return function(){for(var t=S.getInstance(),e=0,n=t.getEntriesByType("resource");e<n.length;e++)Q(n[e])
t.setupObserver("resource",Q)}()},0),setTimeout(function(){return function(){for(var t=S.getInstance(),e=0,n=t.getEntriesByType("measure");e<n.length;e++)Z(n[e])
t.setupObserver("measure",Z)}()},0))}function Z(t){var e=t.name
e.substring(0,b.length)!==b&&G.createUserTimingTrace(e)}var tt=function(){function t(t){this.app=t,S.getInstance().requiredApisAvailable()?B().then(Y,Y):k.info("Firebase Performance cannot start if browser does not support fetch and Promise or cookie is disabled.")}return t.prototype.trace=function(t){return new G(t)},Object.defineProperty(t.prototype,"instrumentationEnabled",{get:function(){return T.getInstance().instrumentationEnabled},set:function(t){T.getInstance().instrumentationEnabled=t},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"dataCollectionEnabled",{get:function(){return T.getInstance().dataCollectionEnabled},set:function(t){T.getInstance().dataCollectionEnabled=t},enumerable:!0,configurable:!0}),t}(),et="[DEFAULT]"
function nt(t){t.INTERNAL.registerService("performance",function(t){if(t.name!==et)throw I.create("FB not default")
if("undefined"==typeof window)throw I.create("no window")
return function(t){f=t}(window),T.getInstance().firebaseAppInstance=t,new tt(t)},{})}nt(o),e.registerPerformance=nt},182:function(t,e,n){"use strict"
n.r(e),n.d(e,"registerInstallations",function(){return z})
var r,i=n(53),o=n.n(i),a=n(31),s=n(54),c=n(183),u=1e4,f="w:0.2.4",p="FIS_v2",l="https://firebaseinstallations.googleapis.com/v1",d=36e5,h=((r={})["missing-app-config-values"]="Missing App configuration values.",r["create-installation-failed"]="Could not register Firebase Installation.",r["generate-token-failed"]="Could not generate Auth Token.",r["not-registered"]="Firebase Installation is not registered.",r["installation-not-found"]="Firebase Installation not found.",r["request-failed"]='{$requestName} request failed with error "{$serverCode} {$serverStatus}: {$serverMessage}"',r["app-offline"]="Could not process request. Application offline.",r["delete-pending-registration"]="Can't delete installation while there is a pending registration request.",r),g=new s.ErrorFactory("installations","Installations",h)
...
return l+"/projects/"+e+"/installations"}function _(t){return{token:t.token,requestStatus:2,expiresIn:(e=t.expiresIn,Number(e.replace("s","000"))),creationTime:Date.now()}
...
return r.append("Authorization",p+" "+n),r}function S(t){return Object(a.__awaiter)(this,void 0,void 0,function(){var e
...
return Object(a.__generator)(this,function(a){switch(a.label){case 0:return e=b(t),r=w(t),i={fid:n,authVersion:p,appId:t.appId,sdkVersion:f},o={method:"POST",headers:r,body:JSON.stringify(i)},[4,S(function(){return fetch(e,o)})]
...
return Object(a.__generator)(this,function(o){switch(o.label){case 0:return n=B(t),[4,M()]
...
return Object(a.__generator)(this,function(i){switch(i.label){case 0:return e=B(t),[4,M()]
...
return Object(a.__generator)(this,function(a){switch(a.label){case 0:return n=B(t),[4,M()]
...
return o&&(o.onupgradeneeded=function(t){r&&r(new l(o.result,t.oldVersion,o.transaction))}),i.then(function(t){return new d(t)})},t.deleteDb=function(t){return n(indexedDB,"deleteDatabase",[t])},Object.defineProperty(t,"__esModule",{value:!0})},"object"===s(e)&&void 0!==t?a(e):(i=[e],void 0===(o="function"==typeof(r=a)?r.apply(e,i):r)||(t.exports=o))}}])
