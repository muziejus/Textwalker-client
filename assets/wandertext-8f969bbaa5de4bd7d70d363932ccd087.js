"use strict"
define("wandertext/app",["exports","wandertext/resolver","ember-load-initializers","wandertext/config/environment"],function(e,t,n,r){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("wandertext/app").default.create({name:"wandertext",version:"0.0.0+c5c57602"})
