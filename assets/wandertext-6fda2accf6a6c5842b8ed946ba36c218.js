...
e.default=i}),define("wandertext/src/ui/components/floating-box/component",["exports","@babel/runtime/helpers/esm/classCallCheck","@babel/runtime/helpers/esm/possibleConstructorReturn","@babel/runtime/helpers/esm/getPrototypeOf","@babel/runtime/helpers/esm/inherits"],function(e,t,n,r,a){Object.defineProperty(e,"__esModule",{value:!0}),e.default=void 0
...
var t=Ember.HTMLBars.template({id:"2VUySfxC",block:'{"symbols":["&default"],"statements":[[7,"div"],[11,"id","floating-box"],[11,"class","card w-50"],[9],[0,"\\n"],[7,"h3"],[9],[0,"I am FloatingBox"],[10],[0,"\\n"],[14,1],[0,"\\n"],[10],[0,"\\n"]],"hasEval":false}',meta:{moduleName:"src/ui/components/floating-box/template.hbs"}})
...
return Object.defineProperty(n,"__esModule",{value:!0}),n}catch(r){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("wandertext/src/main").default.create({name:"wandertext",version:"0.0.0+daeae3c2"})
