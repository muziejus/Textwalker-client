...
return i.field=e,i.op=n,i.value=r,i}return s.__extends(e,t),e.create=function(t,n,r){if(t.isKeyField())return n===Hr.IN?(w(r instanceof Fn,"Comparing on key with IN, but filter value not an ArrayValue"),w(r.internalValue.every(function(t){return t instanceof Ln}),"Comparing on key with IN, but an array value was not a RefValue"),new Jr(t,r)):(w(r instanceof Ln,"Comparing on key, but filter value not a RefValue"),w(n!==Hr.ARRAY_CONTAINS&&n!==Hr.ARRAY_CONTAINS_ANY,"'"+n.toString()+"' queries don't make sense on document keys."),new Xr(t,n,r))
if(r.isEqual(In.INSTANCE)){if(n!==Hr.EQUAL)throw new T(S.INVALID_ARGUMENT,"Invalid query. Null supports only equality comparisons.")
return new e(t,n,r)}if(r.isEqual(kn.NAN)){if(n!==Hr.EQUAL)throw new T(S.INVALID_ARGUMENT,"Invalid query. NaN supports only equality comparisons.")
return new e(t,n,r)}return n===Hr.ARRAY_CONTAINS?new Zr(t,r):n===Hr.IN?(w(r instanceof Fn,"IN filter has invalid value: "+r.toString()),new $r(t,r)):n===Hr.ARRAY_CONTAINS_ANY?(w(r instanceof Fn,"ARRAY_CONTAINS_ANY filter has invalid value: "+r.toString()),new ti(t,r)):new e(t,n,r)},e.prototype.matches=function(t){var e=t.field(this.field)
return null!==e&&this.value.typeOrder===e.typeOrder&&this.matchesComparison(e.compareTo(this.value))},e.prototype.matchesComparison=function(t){switch(this.op){case Hr.LESS_THAN:return t<0
case Hr.LESS_THAN_OR_EQUAL:return t<=0
case Hr.EQUAL:return 0===t
case Hr.GREATER_THAN:return t>0
case Hr.GREATER_THAN_OR_EQUAL:return t>=0
...
return this.matchesComparison(n)},e}(Yr),Jr=function(t){function e(e,n){var r=t.call(this,e,Hr.IN,n)||this
return r.value=n,r}return s.__extends(e,t),e.prototype.matches=function(t){return this.value.internalValue.some(function(e){return t.key.isEqual(e.key)})},e}(Yr),Zr=function(t){function e(e,n){return t.call(this,e,Hr.ARRAY_CONTAINS,n)||this}return s.__extends(e,t),e.prototype.matches=function(t){var e=t.field(this.field)
return e instanceof Fn&&e.contains(this.value)},e}(Yr),$r=function(t){function e(e,n){var r=t.call(this,e,Hr.IN,n)||this
return r.value=n,r}return s.__extends(e,t),e.prototype.matches=function(t){var e=this.value,n=t.field(this.field)
return null!==n&&e.contains(n)},e}(Yr),ti=function(t){function e(e,n){var r=t.call(this,e,Hr.ARRAY_CONTAINS_ANY,n)||this
return r.value=n,r}return s.__extends(e,t),e.prototype.matches=function(t){var e=this,n=t.field(this.field)
return n instanceof Fn&&n.internalValue.some(function(t){return e.value.contains(t)})},e}(Yr),ei=function(){function t(t){this.name=t}return t.prototype.toString=function(){return this.name},t.ASCENDING=new t("asc"),t.DESCENDING=new t("desc"),t}(),ni=function(){function t(t,e){this.position=t,this.before=e}return t.prototype.canonicalId=function(){var t,e,n=this.before?"b:":"a:"
...
w(void 0!==a,"Field should exist since document matched the orderBy already."),n=o.compareTo(a)}if(i.dir===ei.DESCENDING&&(n*=-1),0!==n)break}return this.before?n<=0:n<0},t.prototype.isEqual=function(t){if(null===t)return!1
...
if(!n.isEqual(r))return!1}return!0},t}(),ri=function(){function t(t,e){this.field=t,void 0===e&&(e=ei.ASCENDING),this.dir=e,this.isKeyOrderBy=t.isKeyField()}return t.prototype.compare=function(t,e){var n=this.isKeyOrderBy?pe.compareByKey(t,e):pe.compareByField(this.field,t,e)
switch(this.dir){case ei.ASCENDING:return n
case ei.DESCENDING:return-1*n
default:return v("Unknown direction: "+this.dir)}},t.prototype.canonicalId=function(){return this.field.canonicalString()+this.dir.toString()},t.prototype.toString=function(){return this.field.canonicalString()+" ("+this.dir+")"},t.prototype.isEqual=function(t){return this.dir===t.dir&&this.field.isEqual(t.field)},t}(),ii=new ri(ct.keyField(),ei.ASCENDING),oi=new ri(ct.keyField(),ei.DESCENDING),ai=function(){function t(){}return t.prototype.applyToLocalView=function(t,e){return new xn(e,t)},t.prototype.applyToRemoteDocument=function(t,e){return e},t.prototype.computeBaseValue=function(t){return null},t.prototype.isEqual=function(e){return e instanceof t},t.instance=new t,t}(),si=function(){function t(t){this.elements=t}return t.prototype.applyToLocalView=function(t,e){return this.apply(t)},t.prototype.applyToRemoteDocument=function(t,e){return this.apply(t)},t.prototype.apply=function(t){var e,n,r=hi(t),i=function(t){r.find(function(e){return e.isEqual(t)})||r.push(t)}
try{for(var o=s.__values(this.elements),a=o.next();!a.done;a=o.next())i(a.value)}catch(t){e={error:t}}finally{try{a&&!a.done&&(n=o.return)&&n.call(o)}finally{if(e)throw e.error}}return new Fn(r)},t.prototype.computeBaseValue=function(t){return null},t.prototype.isEqual=function(e){return e instanceof t&&Y(e.elements,this.elements)},t}(),ui=function(){function t(t){this.elements=t}return t.prototype.applyToLocalView=function(t,e){return this.apply(t)},t.prototype.applyToRemoteDocument=function(t,e){return this.apply(t)},t.prototype.apply=function(t){var e,n,r=hi(t),i=function(t){r=r.filter(function(e){return!e.isEqual(t)})}
try{for(var o=s.__values(this.elements),a=o.next();!a.done;a=o.next())i(a.value)}catch(t){e={error:t}}finally{try{a&&!a.done&&(n=o.return)&&n.call(o)}finally{if(e)throw e.error}}return new Fn(r)},t.prototype.computeBaseValue=function(t){return null},t.prototype.isEqual=function(e){return e instanceof t&&Y(e.elements,this.elements)},t}(),ci=function(){function t(t){this.operand=t}return t.prototype.applyToLocalView=function(t,e){var n=this.computeBaseValue(t)
...
function hi(t){return t instanceof Fn?t.internalValue.slice():[]}var li,fi,di=function(){function t(t){this.count=t}return t.prototype.isEqual=function(t){return t&&t.count===this.count},t}(),pi=((li={})[ei.ASCENDING.name]="ASCENDING",li[ei.DESCENDING.name]="DESCENDING",li),yi=((fi={})[Hr.LESS_THAN.name]="LESS_THAN",fi[Hr.LESS_THAN_OR_EQUAL.name]="LESS_THAN_OR_EQUAL",fi[Hr.GREATER_THAN.name]="GREATER_THAN",fi[Hr.GREATER_THAN_OR_EQUAL.name]="GREATER_THAN_OR_EQUAL",fi[Hr.EQUAL.name]="EQUAL",fi[Hr.ARRAY_CONTAINS.name]="ARRAY_CONTAINS",fi[Hr.IN.name]="IN",fi[Hr.ARRAY_CONTAINS_ANY.name]="ARRAY_CONTAINS_ANY",fi),mi=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/)
function gi(t,e){w(!hr(t),e+" is missing")}function vi(t){return"number"==typeof t?t:"string"==typeof t?Number(t):v("can't parse "+t)}var wi=function(){function t(t,e){this.databaseId=t,this.options=e}return t.prototype.emptyByteString=function(){return this.options.useProto3Json?"":new Uint8Array(0)},t.prototype.unsafeCastProtoByteString=function(t){return t},t.prototype.fromRpcStatus=function(t){var e=void 0===t.code?S.UNKNOWN:Dr(t.code)
...
return new St(e,n)},t.prototype.fromIso8601String=function(t){var e=0,n=mi.exec(t)
...
return new Fn(n.map(function(t){return e.fromValue(t)}))}if("timestampValue"in t)return gi(t.timestampValue,"timestampValue"),new Mn(this.fromTimestamp(t.timestampValue))
if("geoPointValue"in t){gi(t.geoPointValue,"geoPointValue")
var r=t.geoPointValue.latitude||0,i=t.geoPointValue.longitude||0
return new Pn(new jr(r,i))}if("bytesValue"in t){gi(t.bytesValue,"bytesValue")
var o=this.fromBlob(t.bytesValue)
return new On(o)}if("referenceValue"in t){gi(t.referenceValue,"referenceValue")
...
return t.forEach(function(t){n.push(e.toValue(t))}),{values:n}},t.prototype.fromFound=function(t){w(!!t.found,"Tried to deserialize a found document from a missing document."),gi(t.found.name,"doc.found.name"),gi(t.found.updateTime,"doc.found.updateTime")
...
e=new Vr(n,r,i,a||null)}else if("documentChange"in t){gi(t.documentChange,"documentChange"),gi(t.documentChange.document,"documentChange.name"),gi(t.documentChange.document.name,"documentChange.document.name"),gi(t.documentChange.document.updateTime,"documentChange.document.updateTime")
...
e=new qr(f,d,l.key,l)}else if("documentDelete"in t){gi(t.documentDelete,"documentDelete"),gi(t.documentDelete.document,"documentDelete.document")
var p=t.documentDelete
u=this.fromName(p.document),c=p.readTime?this.fromVersion(p.readTime):Tt.forDeletedDoc(),l=new ye(u,c),d=p.removedTargetIds||[],e=new qr([],d,l.key,l)}else if("documentRemove"in t){gi(t.documentRemove,"documentRemove"),gi(t.documentRemove.document,"documentRemove")
...
var m=t.filter,g=m.count||0,w=new di(g),b=m.targetId
...
if("setToServerValue"in t)w("REQUEST_TIME"===t.setToServerValue,"Unknown server value transform proto: "+JSON.stringify(t)),n=ai.instance
...
w(i instanceof _n,"NUMERIC_ADD transform requires a NumberValue"),n=new ci(i)}else v("Unknown transform proto: "+JSON.stringify(t))
...
return new ni(r,n)},t.prototype.toDirection=function(t){return pi[t.name]},t.prototype.fromDirection=function(t){switch(t){case"ASCENDING":return ei.ASCENDING
case"DESCENDING":return ei.DESCENDING
default:return}},t.prototype.toOperatorName=function(t){return yi[t.name]},t.prototype.fromOperatorName=function(t){switch(t){case"EQUAL":return Hr.EQUAL
case"GREATER_THAN":return Hr.GREATER_THAN
case"GREATER_THAN_OR_EQUAL":return Hr.GREATER_THAN_OR_EQUAL
case"LESS_THAN":return Hr.LESS_THAN
case"LESS_THAN_OR_EQUAL":return Hr.LESS_THAN_OR_EQUAL
case"ARRAY_CONTAINS":return Hr.ARRAY_CONTAINS
case"IN":return Hr.IN
case"ARRAY_CONTAINS_ANY":return Hr.ARRAY_CONTAINS_ANY
case"OPERATOR_UNSPECIFIED":return v("Unspecified operator")
default:return v("Unknown operator")}},t.prototype.toFieldPathReference=function(t){return{fieldPath:t.canonicalString()}},t.prototype.fromFieldPathReference=function(t){return ct.fromServerFormat(t.fieldPath)},t.prototype.toPropertyOrder=function(t){return{field:this.toFieldPathReference(t.field),direction:this.toDirection(t.dir)}},t.prototype.fromPropertyOrder=function(t){return new ri(this.fromFieldPathReference(t.field),this.fromDirection(t.direction))},t.prototype.fromFieldFilter=function(t){return Yr.create(this.fromFieldPathReference(t.fieldFilter.field),this.fromOperatorName(t.fieldFilter.op),this.fromValue(t.fieldFilter.value))},t.prototype.toUnaryOrFieldFilter=function(t){if(t.op===Hr.EQUAL){if(t.value.isEqual(kn.NAN))return{unaryFilter:{field:this.toFieldPathReference(t.field),op:"IS_NAN"}}
...
return Yr.create(e,Hr.EQUAL,kn.NAN)
case"IS_NULL":var n=this.fromFieldPathReference(t.unaryFilter.field)
return Yr.create(n,Hr.EQUAL,In.INSTANCE)
...
return Vn.fromArray(e)},t}(),bi=function(){this.listeners=[]},Ei=function(){function t(t){this.syncEngine=t,this.queries=new ge(function(t){return t.canonicalId()}),this.onlineState=pr.Unknown,this.syncEngine.subscribe(this)}return t.prototype.listen=function(t){var e=t.query,n=!1,r=this.queries.get(e)
...
break
case Ar.Removed:a=a.add(h.doc.key)}}}catch(t){r={error:t}}finally{try{c&&!c.done&&(i=u.return)&&i.call(u)}finally{if(r)throw r.error}}return new t(e,o,a)},t}(),Ii=function(t){this.key=t},Ci=function(t){this.key=t},_i=function(){function t(t,e){this.query=t,this._syncedDocuments=e,this.syncState=null,this.current=!1,this.limboDocuments=Ft(),this.mutatedKeys=Ft(),this.documentSet=new Rr(t.docComparator.bind(t))}return Object.defineProperty(t.prototype,"syncedDocuments",{get:function(){return this._syncedDocuments},enumerable:!0,configurable:!0}),t.prototype.computeDocChanges=function(t,e){var n=this,r=e?e.changeSet:new xr,i=e?e.documentSet:this.documentSet,o=e?e.mutatedKeys:this.mutatedKeys,a=i,s=!1,u=this.query.hasLimit()&&i.size===this.query.limit?i.last():null
...
var n=[]
return e.forEach(function(e){t.limboDocuments.has(e)||n.push(new Ci(e))}),this.limboDocuments.forEach(function(t){e.has(t)||n.push(new Ii(t))}),n},t.prototype.synchronizeWithPersistedState=function(t,e){this._syncedDocuments=e,this.limboDocuments=Ft()
var n=this.computeDocChanges(t)
return this.applyChanges(n,!0)},t.prototype.computeInitialSnapshot=function(){return Or.fromInitialDocuments(this.query,this.documentSet,this.mutatedKeys,this.syncState===kr.Local)},t}(),Di=function(t,e,n){this.query=t,this.targetId=e,this.view=n},Ni=function(t){this.key=t},Ai=function(){function t(t,e,n,r){this.localStore=t,this.remoteStore=e,this.sharedClientState=n,this.currentUser=r,this.syncEngineListener=null,this.queryViewsByQuery=new ge(function(t){return t.canonicalId()}),this.queryViewsByTarget={},this.limboTargetsByKey=new It(ht.comparator),this.limboResolutionsByTarget={},this.limboDocumentRefs=new Yn,this.mutationUserCallbacks={},this.limboTargetIdGenerator=$t.forSyncEngine(),this.isPrimary=void 0,this.onlineState=pr.Unknown}return Object.defineProperty(t.prototype,"isPrimaryClient",{get:function(){return!0===this.isPrimary},enumerable:!0,configurable:!0}),t.prototype.subscribe=function(t){w(null!==t,"SyncEngine listener cannot be null"),w(null===this.syncEngineListener,"SyncEngine already has a subscriber."),this.syncEngineListener=t},t.prototype.listen=function(t){return s.__awaiter(this,void 0,void 0,function(){var e,n,r,i,o
...
return this.localStore.executeQuery(r).then(function(i){return n.localStore.remoteDocumentKeys(t.targetId).then(function(o){var a=new _i(r,o),s=a.computeDocChanges(i),u=Pr.createSynthesizedTargetChangeForCurrentChange(t.targetId,e&&n.onlineState!==pr.Offline),c=a.applyChanges(s,!0===n.isPrimary,u)
...
this.limboResolutionsByTarget[n]=new Ni(e),this.remoteStore.listen(new tn(r,n,We.LimboResolution,ot.INVALID)),this.limboTargetsByKey=this.limboTargetsByKey.insert(e,n)}},t.prototype.currentLimboDocs=function(){return this.limboTargetsByKey},t.prototype.emitNewSnapsAndNotifyLocalStore=function(t,e){return s.__awaiter(this,void 0,void 0,function(){var n,r,i,o=this
...
return e&&e.receivedDocument?Ft().add(e.key):this.queryViewsByTarget[t]?this.queryViewsByTarget[t].view.syncedDocuments:Ft()},t}(),ki=function(){function t(t){this.uid=t}return t.prototype.isAuthenticated=function(){return null!=this.uid},t.prototype.toKey=function(){return this.isAuthenticated()?"uid:"+this.uid:"anonymous-user"},t.prototype.isEqual=function(t){return t.uid===this.uid},t.UNAUTHENTICATED=new t(null),t.GOOGLE_CREDENTIALS=new t("google-credentials-uid"),t.FIRST_PARTY=new t("first-party-uid"),t}(),Ri="SharedClientState",Mi="firestore_clients",xi="firestore_mutations",Oi="firestore_targets",Li="firestore_online_state",Pi="firestore_sequence_number",qi=function(){function t(t,e,n,r){this.user=t,this.batchId=e,this.state=n,this.error=r,w(void 0!==r==("rejected"===n),"MutationMetadata must contain an error iff state is 'rejected'")}return t.fromWebStorageEntry=function(e,n,i){var o=JSON.parse(i),a="object"===r(o)&&-1!==["pending","acknowledged","rejected"].indexOf(o.state)&&(void 0===o.error||"object"===r(o.error)),s=void 0
...
return this.error&&(t.error={code:this.error.code,message:this.error.message}),JSON.stringify(t)},t}(),Fi=function(){function t(t,e,n){this.targetId=t,this.state=e,this.error=n,w(void 0!==n==("rejected"===e),"QueryTargetMetadata must contain an error iff state is 'rejected'")}return t.fromWebStorageEntry=function(e,n){var i=JSON.parse(n),o="object"===r(i)&&-1!==["not-current","current","rejected"].indexOf(i.state)&&(void 0===i.error||"object"===r(i.error)),a=void 0
...
return o?new t(e,a):(m(Ri,"Failed to parse client data for instance '"+e+"': "+n),null)},t}(),Ui=function(){function t(t,e){this.clientId=t,this.onlineState=e}return t.fromWebStorageEntry=function(e){var n=JSON.parse(e)
return"object"===r(n)&&n.onlineState in pr&&"string"==typeof n.clientId?new t(n.clientId,pr[n.onlineState]):(m(Ri,"Failed to parse online state: "+e),null)},t}(),Bi=function(){function t(){this.activeTargetIds=Ut()}return t.prototype.addQueryTarget=function(t){w(!this.activeTargetIds.has(t),"Target with ID '"+t+"' already active."),this.activeTargetIds=this.activeTargetIds.add(t)},t.prototype.removeQueryTarget=function(t){this.activeTargetIds=this.activeTargetIds.delete(t)},t.prototype.toWebStorageJSON=function(){var t={activeTargetIds:this.activeTargetIds.toArray(),updateTimeMs:Date.now()}
...
var a=r.replace(/[.*+?^${}()|[\]\\]/g,"\\$&")
this.storage=this.platform.window.localStorage,this.currentUser=o,this.localClientStorageKey=this.toWebStorageClientStateKey(this.localClientId),this.sequenceNumberKey=Pi+"_"+r,this.activeClients[this.localClientId]=new Bi,this.clientStateKeyRe=new RegExp("^"+Mi+"_"+a+"_([^_]*)$"),this.mutationBatchKeyRe=new RegExp("^"+xi+"_"+a+"_(\\d+)(?:_(.*))?$"),this.queryTargetKeyRe=new RegExp("^"+Oi+"_"+a+"_(\\d+)$"),this.onlineStateKey=Li+"_"+r,this.platform.window.addEventListener("storage",this.storageListener)}return t.isAvailable=function(t){return!(!t.window||null==t.window.localStorage)},t.prototype.start=function(){return s.__awaiter(this,void 0,void 0,function(){var t,e,n,r,i,o,a,u,c,h,l,f,d,p,y,m=this
...
if(n){var r=Fi.fromWebStorageEntry(t,n)
...
w("number"==typeof n,"Found non-numeric sequence number"),e=n}catch(t){m(Ri,"Failed to read sequence number from WebStorage",t)}return e}(t.newValue))!==ot.INVALID&&this.sequenceNumberHandler(a))
return[2]})})})}},Object.defineProperty(t.prototype,"localClientState",{get:function(){return this.activeClients[this.localClientId]},enumerable:!0,configurable:!0}),t.prototype.persistClientState=function(){this.setItem(this.localClientStorageKey,this.localClientState.toWebStorageJSON())},t.prototype.persistMutationState=function(t,e,n){var r=new qi(this.currentUser,t,e,n),i=this.toWebStorageMutationBatchKey(t)
...
this.storage.setItem(this.onlineStateKey,JSON.stringify(e))},t.prototype.persistQueryTargetState=function(t,e,n){var r=this.toWebStorageQueryTargetMetadataKey(t),i=new Fi(t,e,n)
this.setItem(r,i.toWebStorageJSON())},t.prototype.toWebStorageClientStateKey=function(t){return w(-1===t.indexOf("_"),"Client key cannot contain '_', but was '"+t+"'"),Mi+"_"+this.persistenceKey+"_"+t},t.prototype.toWebStorageQueryTargetMetadataKey=function(t){return Oi+"_"+this.persistenceKey+"_"+t},t.prototype.toWebStorageMutationBatchKey=function(t){var e=xi+"_"+this.persistenceKey+"_"+t
...
return console.warn("Error enabling offline persistence. Falling back to persistence disabled: "+t),r.startMemoryPersistence()}):(e.resolve(),this.startMemoryPersistence())},t.prototype.canFallback=function(t){return t instanceof T?t.code===S.FAILED_PRECONDITION||t.code===S.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&t instanceof DOMException)||22===t.code||20===t.code||11===t.code},t.prototype.verifyNotShutdown=function(){if(this._clientShutdown)throw new T(S.FAILED_PRECONDITION,"The client has already been shutdown.")},t.prototype.startIndexedDbPersistence=function(t,e){var n=this,r=pn.buildStoragePrefix(this.databaseInfo),i=new wi(this.databaseInfo.databaseId,{useProto3Json:!0})
return Promise.resolve().then(function(){return s.__awaiter(n,void 0,void 0,function(){var n,o
return s.__generator(this,function(a){switch(a.label){case 0:if(e.synchronizeTabs&&!Qi.isAvailable(this.platform))throw new T(S.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.")
return o=e.lruParams(),e.synchronizeTabs?(this.sharedClientState=new Qi(this.asyncQueue,this.platform,r,this.clientId,t),[4,pn.createMultiClientIndexedDbPersistence(r,this.clientId,this.platform,this.asyncQueue,i,o,{sequenceNumberSyncer:this.sharedClientState})]):[3,2]
case 1:return n=a.sent(),[3,4]
case 2:return this.sharedClientState=new Ki,[4,pn.createIndexedDbPersistence(r,this.clientId,this.platform,this.asyncQueue,i,o)]
case 3:n=a.sent(),a.label=4
case 4:return this.persistence=n,[2,n.referenceDelegate.garbageCollector]}})})})},t.prototype.startMemoryPersistence=function(){return this.persistence=nr.createEagerPersistence(this.clientId),this.sharedClientState=new Ki,Promise.resolve(null)},t.prototype.initializeRest=function(t,e){var n=this
...
return this.verifyNotShutdown(),this.asyncQueue.enqueue(function(){return e.localStore.executeQuery(t)}).then(function(e){var n=Ft(),r=new _i(t,n),i=r.computeDocChanges(e)
...
this.muted||setTimeout(function(){n.muted||t(e)},0)},t}(),Hi=function(){function t(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
...
return this._internalPath.isEqual(e._internalPath)},t._DOCUMENT_ID=new t(ct.keyField().canonicalString()),t}(),Yi=new RegExp("[~\\*/\\[\\]]"),Xi=function(t,e){this.user=e,this.type="OAuth",this.authHeaders={Authorization:"Bearer "+t}},Ji=function(){function t(){this.changeListener=null}return t.prototype.getToken=function(){return Promise.resolve(null)},t.prototype.invalidateToken=function(){},t.prototype.setChangeListener=function(t){w(!this.changeListener,"Can only call setChangeListener() once."),this.changeListener=t,t(ki.UNAUTHENTICATED)},t.prototype.removeChangeListener=function(){w(null!==this.changeListener,"removeChangeListener() when no listener registered"),this.changeListener=null},t}(),Zi=function(){function t(t){var e=this
...
return n?(w("string"==typeof n.accessToken,"Invalid tokenData returned from getToken():"+n),new Xi(n.accessToken,t.currentUser)):null})},t.prototype.invalidateToken=function(){this.forceRefresh=!0},t.prototype.setChangeListener=function(t){w(!this.changeListener,"Can only call setChangeListener() once."),this.changeListener=t,this.currentUser&&t(this.currentUser)},t.prototype.removeChangeListener=function(){w(null!=this.tokenListener,"removeChangeListener() called twice"),w(null!==this.changeListener,"removeChangeListener() called when no listener registered"),this.app.INTERNAL.removeAuthTokenListener(this.tokenListener),this.tokenListener=null,this.changeListener=null},t.prototype.getUser=function(){var t=this.app.INTERNAL.getUid()
return w(null===t||"string"==typeof t,"Received invalid UID: "+t),new ki(t)},t}(),$i=function(){function t(t,e){this.gapi=t,this.sessionIndex=e,this.type="FirstParty",this.user=ki.FIRST_PARTY}return Object.defineProperty(t.prototype,"authHeaders",{get:function(){var t={"X-Goog-AuthUser":this.sessionIndex},e=this.gapi.auth.getAuthHeaderValueForFirstParty([])
return e&&(t.Authorization=e),t},enumerable:!0,configurable:!0}),t}(),to=function(){function t(t,e){this.gapi=t,this.sessionIndex=e}return t.prototype.getToken=function(){return Promise.resolve(new $i(this.gapi,this.sessionIndex))},t.prototype.setChangeListener=function(t){t(ki.FIRST_PARTY)},t.prototype.removeChangeListener=function(){},t.prototype.invalidateToken=function(){},t}()
...
if(c in o&&"function"==typeof o[c])return!0}}catch(t){n={error:t}}finally{try{u&&!u.done&&(i=a.return)&&i.call(a)}finally{if(n)throw n.error}}return!1}(t)}var no,ro=function(){function t(t){this._methodName=t}return t.delete=function(){return k("FieldValue.delete",arguments),io.instance},t.serverTimestamp=function(){return k("FieldValue.serverTimestamp",arguments),oo.instance},t.arrayUnion=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
return M("FieldValue.arrayUnion",arguments,1),new ao(t)},t.arrayRemove=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
return M("FieldValue.arrayRemove",arguments,1),new so(t)},t.increment=function(t){return O("FieldValue.increment","number",1,t),R("FieldValue.increment",arguments,1),new uo(t)},t.prototype.isEqual=function(t){return this===t},t}(),io=function(t){function e(){return t.call(this,"FieldValue.delete")||this}return s.__extends(e,t),e.instance=new e,e}(ro),oo=function(t){function e(){return t.call(this,"FieldValue.serverTimestamp")||this}return s.__extends(e,t),e.instance=new e,e}(ro),ao=function(t){function e(e){var n=t.call(this,"FieldValue.arrayUnion")||this
...
return n._operand=e,n}return s.__extends(e,t),e}(ro),co=I(ro,"Use FieldValue.<field>() instead."),ho=/^__.*__$/,lo=function(){function t(t,e,n){this.data=t,this.fieldMask=e,this.fieldTransforms=n}return t.prototype.toMutations=function(t,e){var n=[]
...
wo("Data must be an object, but it was:",n,e)
...
wo("Data must be an object, but it was:",o,e)
...
if(d instanceof Hi)p=d._internalPath
else{if("string"!=typeof d)throw v("Expected stringOrFieldPath to be a string or a FieldPath")
p=Eo(t,d)}if(!o.contains(p))throw new T(S.INVALID_ARGUMENT,"Field '"+p+"' is specified in your field mask but missing from your input data.")
...
wo("Data must be an object, but it was:",r,e)
...
return new fo(c,p,i.fieldTransforms)},t.prototype.parseQueryValue=function(t,e){var n=new yo(no.Argument,t,ct.EMPTY_PATH),r=this.parseData(e,n)
return w(null!=r,"Parsed data should not be null."),w(0===n.fieldTransforms.length,"Field transforms should have been disallowed."),r},t.prototype.runPreConverter=function(t,e){try{return this.preConverter(t)}catch(t){var n=So(t)
throw e.createError(n)}},t.prototype.parseData=function(t,e){if(vo(t=this.runPreConverter(t,e)))return wo("Unsupported field value:",e,t),this.parseObject(t,e)
...
null==h&&(h=In.INSTANCE),i.push(h),o++}}catch(t){n={error:t}}finally{try{u&&!u.done&&(r=a.return)&&r.call(a)}finally{if(n)throw n.error}}return new Fn(i)},t.prototype.parseSentinelFieldValue=function(t,e){if(!po(e.dataSource))throw e.createError(t._methodName+"() can only be used with update() and set()")
if(null===e.path)throw e.createError(t._methodName+"() is not currently supported inside arrays")
if(t instanceof io){if(e.dataSource!==no.MergeSet)throw e.dataSource===no.Update?(w(e.path.length>0,"FieldValue.delete() at the top level should have already been handled."),e.createError("FieldValue.delete() can only appear at the top level of your update data")):e.createError("FieldValue.delete() cannot be used with set() unless you pass {merge:true}")
e.fieldMask.push(e.path)}else if(t instanceof oo)e.fieldTransforms.push(new Un(e.path,ai.instance))
else if(t instanceof ao){var n=this.parseArrayTransformElements(t._methodName,t._elements),r=new si(n)
e.fieldTransforms.push(new Un(e.path,r))}else if(t instanceof so){n=this.parseArrayTransformElements(t._methodName,t._elements)
var i=new ui(n)
e.fieldTransforms.push(new Un(e.path,i))}else if(t instanceof uo){var o=this.parseQueryValue("FieldValue.increment",t._operand),a=new ci(o)
...
if(t instanceof mo)return new Ln(t.databaseId,t.key)
...
function vo(t){return!("object"!==r(t)||null===t||t instanceof Array||t instanceof Date||t instanceof St||t instanceof jr||t instanceof tt||t instanceof mo||t instanceof ro)}function wo(t,e,n){if(!vo(n)||!U(n)){var r=B(n)
throw"an object"===r?e.createError(t+" a custom object"):e.createError(t+" "+r)}}function bo(t,e){if(e instanceof Hi)return e._internalPath
if("string"==typeof e)return Eo(t,e)
throw new T(S.INVALID_ARGUMENT,"Function "+t+"() called with invalid data. Field path arguments must be of type string or FieldPath.")}function Eo(t,e){try{return function(t){if(t.search(Yi)>=0)throw new T(S.INVALID_ARGUMENT,"Invalid field path ("+t+"). Paths must not contain '~', '*', '/', '[', or ']'")
try{return new(Hi.bind.apply(Hi,s.__spread([void 0],t.split("."))))}catch(e){throw new T(S.INVALID_ARGUMENT,"Invalid field path ("+t+"). Paths must not be empty, begin with '.', end with '.', or contain '..'")}}(e)._internalPath}catch(e){var n=So(e)
throw new T(S.INVALID_ARGUMENT,"Function "+t+"() called with invalid data. "+n)}}function So(t){return t instanceof Error?t.message:t.toString()}var To="firestore.googleapis.com",Io=!0,Co=!0,_o=!1,Do=an.COLLECTION_DISABLED,No=function(){function t(t){if(void 0===t.host){if(void 0!==t.ssl)throw new T(S.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set")
this.host=To,this.ssl=Io}else P("settings","non-empty string","host",t.host),this.host=t.host,q("settings","boolean","ssl",t.ssl),this.ssl=_(t.ssl,Io)
if(K("settings",t,["host","ssl","credentials","timestampsInSnapshots","cacheSizeBytes","experimentalForceLongPolling"]),q("settings","object","credentials",t.credentials),this.credentials=t.credentials,q("settings","boolean","timestampsInSnapshots",t.timestampsInSnapshots),!0===t.timestampsInSnapshots?m("\n  The timestampsInSnapshots setting now defaults to true and you no\n  longer need to explicitly set it. In a future release, the setting\n  will be removed entirely and so it is recommended that you remove it\n  from your firestore.settings() call now."):!1===t.timestampsInSnapshots&&m("\n  The timestampsInSnapshots setting will soon be removed. YOU MUST UPDATE\n  YOUR CODE.\n\n  To hide this warning, stop using the timestampsInSnapshots setting in your\n  firestore.settings({ ... }) call.\n\n  Once you remove the setting, Timestamps stored in Cloud Firestore will be\n  read back as Firebase Timestamp objects instead of as system Date objects.\n  So you will also need to update code expecting a Date to instead expect a\n  Timestamp. For example:\n\n  // Old:\n  const date = snapshot.get('created_at');\n  // New:\n  const timestamp = snapshot.get('created_at'); const date =\n  timestamp.toDate();\n\n  Please audit all existing usages of Date when you enable the new\n  behavior."),this.timestampsInSnapshots=_(t.timestampsInSnapshots,Co),q("settings","number","cacheSizeBytes",t.cacheSizeBytes),void 0===t.cacheSizeBytes)this.cacheSizeBytes=an.DEFAULT_CACHE_SIZE_BYTES
else{if(t.cacheSizeBytes!==Do&&t.cacheSizeBytes<an.MINIMUM_CACHE_SIZE_BYTES)throw new T(S.INVALID_ARGUMENT,"cacheSizeBytes must be at least "+an.MINIMUM_CACHE_SIZE_BYTES)
this.cacheSizeBytes=t.cacheSizeBytes}q("settings","boolean","experimentalForceLongPolling",t.experimentalForceLongPolling),this.forceLongPolling=void 0===t.experimentalForceLongPolling?_o:t.experimentalForceLongPolling}return t.prototype.isEqual=function(t){return this.host===t.host&&this.ssl===t.ssl&&this.timestampsInSnapshots===t.timestampsInSnapshots&&this.credentials===t.credentials&&this.cacheSizeBytes===t.cacheSizeBytes&&this.forceLongPolling===t.forceLongPolling},t}(),Ao=function(){},ko=function(){function t(e){var n=this
...
i.databaseId=new it(a.projectId,a.database),i.persistenceKey="[DEFAULT]",i.credentials=new Ji}i.settings=new No({}),this._config=i,this._databaseId=i.databaseId}return t.prototype.settings=function(t){if(R("Firestore.settings",arguments,1),O("Firestore.settings","object",1,t),C(t,"persistence"))throw new T(S.INVALID_ARGUMENT,'"persistence" is now specified with a separate call to firestore.enablePersistence().')
var e=new No(t)
...
return w(!("object"!==r(e)||null===e||!e.auth||!e.auth.getAuthHeaderValueForFirstParty),"unexpected gapi interface"),new to(e,t.sessionIndex||"0")
...
var e=!1
return t&&(void 0!==t.experimentalTabSynchronization&&m("The 'experimentalTabSynchronization' setting has been renamed to 'synchronizeTabs'. In a future release, the setting will be removed and it is recommended that you update your firestore.enablePersistence() call to use 'synchronizeTabs'."),e=_(void 0!==t.synchronizeTabs?t.synchronizeTabs:t.experimentalTabSynchronization,!1)),this.configureClient(new Gi(this._config.settings.cacheSizeBytes,e))},t.prototype.clearPersistence=function(){var t=this,e=pn.buildStoragePrefix(this.makeDatabaseInfo()),n=new lt
...
return new mo(e._config.databaseId,t._key)}return t}),this._firestoreClient=new ji(b.getPlatform(),n,this._config.credentials,this._queue),this._firestoreClient.start(t)},t.databaseIdFromApp=function(t){var e=t.options
...
break
default:throw new T(S.INVALID_ARGUMENT,"Invalid log level: "+t)}},t.prototype._areTimestampsInSnapshotsEnabled=function(){return this._config.settings.timestampsInSnapshots},t}(),Ro=function(){function t(t,e){this._firestore=t,this._transaction=e}return t.prototype.get=function(t){var e=this
R("Transaction.get",arguments,1)
var n=Ko("Transaction.get",t,this._firestore)
...
if(r instanceof pe)return new Lo(e._firestore,n._key,r,!1,!1)
...
var r=Ko("Transaction.set",t,this._firestore),i=(n=Uo("Transaction.set",n)).merge||n.mergeFields?this._firestore._dataConverter.parseMergeData("Transaction.set",e,n.mergeFields):this._firestore._dataConverter.parseSetData("Transaction.set",e)
...
return"string"==typeof e||e instanceof Hi?(M("Transaction.update",arguments,3),r=Ko("Transaction.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateVarargs("Transaction.update",e,n,o)):(R("Transaction.update",arguments,2),r=Ko("Transaction.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateData("Transaction.update",e)),this._transaction.update(r._key,i),this},t.prototype.delete=function(t){R("Transaction.delete",arguments,1)
var e=Ko("Transaction.delete",t,this._firestore)
return this._transaction.delete(e._key),this},t}(),Mo=function(){function t(t){this._firestore=t,this._mutations=[],this._committed=!1}return t.prototype.set=function(t,e,n){x("WriteBatch.set",arguments,2,3),this.verifyNotCommitted()
var r=Ko("WriteBatch.set",t,this._firestore),i=(n=Uo("WriteBatch.set",n)).merge||n.mergeFields?this._firestore._dataConverter.parseMergeData("WriteBatch.set",e,n.mergeFields):this._firestore._dataConverter.parseSetData("WriteBatch.set",e)
...
return this.verifyNotCommitted(),"string"==typeof e||e instanceof Hi?(M("WriteBatch.update",arguments,3),r=Ko("WriteBatch.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateVarargs("WriteBatch.update",e,n,o)):(R("WriteBatch.update",arguments,2),r=Ko("WriteBatch.update",t,this._firestore),i=this._firestore._dataConverter.parseUpdateData("WriteBatch.update",e)),this._mutations=this._mutations.concat(i.toMutations(r._key,Qn.exists(!0))),this},t.prototype.delete=function(t){R("WriteBatch.delete",arguments,1),this.verifyNotCommitted()
var e=Ko("WriteBatch.delete",t,this._firestore)
return this._mutations=this._mutations.concat(new zn(e._key,Qn.NONE)),this},t.prototype.commit=function(){return s.__awaiter(this,void 0,void 0,function(){return s.__generator(this,function(t){return this.verifyNotCommitted(),this._committed=!0,this._mutations.length>0?[2,this._firestore.ensureClientConfigured().write(this._mutations)]:[2]})})},t.prototype.verifyNotCommitted=function(){if(this._committed)throw new T(S.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")},t}(),xo=function(){function t(t,e){this._key=t,this.firestore=e,this._firestoreClient=this.firestore.ensureClientConfigured()}return t.forPath=function(e,n){if(e.length%2!=0)throw new T(S.INVALID_ARGUMENT,"Invalid document reference. Document references must have an even number of segments, but "+e.canonicalString()+" has "+e.length)
...
return new Vo(this._key.path.child(e),this.firestore)},t.prototype.isEqual=function(e){if(!(e instanceof t))throw G("isEqual","DocumentReference",1,e)
...
var n=(e=Uo("DocumentReference.set",e)).merge||e.mergeFields?this.firestore._dataConverter.parseMergeData("DocumentReference.set",t,e.mergeFields):this.firestore._dataConverter.parseSetData("DocumentReference.set",t)
...
return"string"==typeof t||t instanceof Hi?(M("DocumentReference.update",arguments,2),n=this.firestore._dataConverter.parseUpdateVarargs("DocumentReference.update",t,e,r)):(R("DocumentReference.update",arguments,1),n=this.firestore._dataConverter.parseUpdateData("DocumentReference.update",t)),this._firestoreClient.write(n.toMutations(this._key,Qn.exists(!0)))},t.prototype.delete=function(){return R("DocumentReference.delete",arguments,0),this._firestoreClient.write([new zn(this._key,Qn.NONE)])},t.prototype.onSnapshot=function(){for(var t=[],e=0;e<arguments.length;e++)t[e]=arguments[e]
x("DocumentReference.onSnapshot",arguments,1,4)
var n,i={includeMetadataChanges:!1},o=0
"object"!==r(t[o])||eo(t[o])||(K("DocumentReference.onSnapshot",i=t[o],["includeMetadataChanges"]),q("DocumentReference.onSnapshot","boolean","includeMetadataChanges",i.includeMetadataChanges),o++)
...
var i=new zi({next:function(t){if(e.next){w(t.docs.size<=1,"Too many documents returned on a document query")
var r=t.docs.get(n._key)
e.next(new Lo(n.firestore,n._key,r,t.fromCache,t.hasPendingWrites))}},error:r}),o=this._firestoreClient.listen(zr.atPath(this._key.path),i,t)
return function(){i.mute(),n._firestoreClient.unlisten(o)}},t.prototype.get=function(t){var e=this
return x("DocumentReference.get",arguments,0,1),Qo("DocumentReference.get",t),new Promise(function(n,r){t&&"cache"===t.source?e.firestore.ensureClientConfigured().getDocumentFromLocalCache(e._key).then(function(t){n(new Lo(e.firestore,e._key,t,!0,t instanceof pe&&t.hasLocalMutations))},r):e.getViaSnapshotListener(n,r,t)})},t.prototype.getViaSnapshotListener=function(t,e,n){var r=this.onSnapshotInternal({includeMetadataChanges:!0,waitForSyncWhenOnline:!0},{next:function(i){r(),!i.exists&&i.metadata.fromCache?e(new T(S.UNAVAILABLE,"Failed to get document because the client is offline.")):i.exists&&i.metadata.fromCache&&n&&"server"===n.source?e(new T(S.UNAVAILABLE,'Failed to get document from server. (However, this document does exist in the local cache. Run again without setting source to "server" to retrieve the cached document.)')):t(i)},error:e})},t}(),Oo=function(){function t(t,e){this.hasPendingWrites=t,this.fromCache=e}return t.prototype.isEqual=function(t){return this.hasPendingWrites===t.hasPendingWrites&&this.fromCache===t.fromCache},t}(),Lo=function(){function t(t,e,n,r,i){this._firestore=t,this._key=e,this._document=n,this._fromCache=r,this._hasPendingWrites=i}return t.prototype.data=function(t){return x("DocumentSnapshot.data",arguments,0,1),t=Bo("DocumentSnapshot.data",t),this._document?this.convertObject(this._document.data,Sn.fromSnapshotOptions(t,this._firestore._areTimestampsInSnapshotsEnabled())):void 0},t.prototype.get=function(t,e){if(x("DocumentSnapshot.get",arguments,1,2),e=Bo("DocumentSnapshot.get",e),this._document){var n=this._document.data.field(bo("DocumentSnapshot.get",t))
if(null!==n)return this.convertValue(n,Sn.fromSnapshotOptions(e,this._firestore._areTimestampsInSnapshotsEnabled()))}},Object.defineProperty(t.prototype,"id",{get:function(){return this._key.path.lastSegment()},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"ref",{get:function(){return new xo(this._key,this._firestore)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"exists",{get:function(){return null!==this._document},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"metadata",{get:function(){return new Oo(this._hasPendingWrites,this._fromCache)},enumerable:!0,configurable:!0}),t.prototype.isEqual=function(e){if(!(e instanceof t))throw G("isEqual","DocumentSnapshot",1,e)
...
return t.internalValue.map(function(t){return n.convertValue(t,e)})},t}(),Po=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return s.__extends(e,t),e.prototype.data=function(e){var n=t.prototype.data.call(this,e)
return w("object"===r(n),"Document in a QueryDocumentSnapshot should exist"),n},e}(Lo),qo=function(){function t(t,e){this._query=t,this.firestore=e}return t.prototype.where=function(e,n,r){var i,o,a
if(R("Query.where",arguments,3),Q("Query.where",3,r),"in"!==n&&"array-contains-any"!==n){(function(t,e,n,r){if(!e.some(function(t){return t===r}))throw new T(S.INVALID_ARGUMENT,"Invalid value "+B(r)+" provided to function "+t+"() for its "+W(n)+" argument. Acceptable values: "+e.join(", "))})("Query.where",["<","<=","==",">=",">","array-contains"],2,n)}var u=bo("Query.where",e),c=Hr.fromString(n)
if(u.isKeyField()){if(c===Hr.ARRAY_CONTAINS||c===Hr.ARRAY_CONTAINS_ANY)throw new T(S.INVALID_ARGUMENT,"Invalid Query. You can't perform '"+c.toString()+"' queries on FieldPath.documentId().")
if(c===Hr.IN){this.validateDisjunctiveFilterElements(r,c)
var h=[]
try{for(var l=s.__values(r),f=l.next();!f.done;f=l.next()){var d=f.value
h.push(this.parseDocumentIdValue(d))}}catch(t){i={error:t}}finally{try{f&&!f.done&&(o=l.return)&&o.call(l)}finally{if(i)throw i.error}}a=new Fn(h)}else a=this.parseDocumentIdValue(r)}else c!==Hr.IN&&c!==Hr.ARRAY_CONTAINS_ANY||this.validateDisjunctiveFilterElements(r,c),a=this.firestore._dataConverter.parseQueryValue("Query.where",r)
var p=Yr.create(u,c,a)
return this.validateNewFilter(p),new t(this._query.addFilter(p),this.firestore)},t.prototype.orderBy=function(e,n){var r
if(x("Query.orderBy",arguments,1,2),L("Query.orderBy","non-empty string",2,n),void 0===n||"asc"===n)r=ei.ASCENDING
else{if("desc"!==n)throw new T(S.INVALID_ARGUMENT,"Function Query.orderBy() has unknown direction '"+n+"', expected 'asc' or 'desc'.")
r=ei.DESCENDING}if(null!==this._query.startAt)throw new T(S.INVALID_ARGUMENT,"Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().")
...
return this.firestore===e.firestore&&this._query.isEqual(e._query)},t.prototype.boundFromDocOrFields=function(t,e,n,r){if(Q(t,1,e),e instanceof Lo){if(n.length>0)throw new T(S.INVALID_ARGUMENT,"Too many arguments provided to "+t+"().")
var i=e
...
return new Ln(this.firestore._databaseId,new ht(e))}if(t instanceof xo){var n=t
...
x("QuerySnapshot.forEach",arguments,1,2),O("QuerySnapshot.forEach","function",1,t),this._snapshot.docs.forEach(function(r){t.call(e,n.convertToDocumentImpl(r))})},Object.defineProperty(t.prototype,"query",{get:function(){return new qo(this._originalQuery,this._firestore)},enumerable:!0,configurable:!0}),t.prototype.docChanges=function(t){t&&(K("QuerySnapshot.docChanges",t,["includeMetadataChanges"]),q("QuerySnapshot.docChanges","boolean","includeMetadataChanges",t.includeMetadataChanges))
...
return n.docChanges.map(function(e){var o=new Po(t,e.doc.key,e.doc,n.fromCache,n.mutatedKeys.has(e.doc.key))
...
return n.docChanges.filter(function(t){return e||t.type!==Ar.Metadata}).map(function(e){var r=new Po(t,e.doc.key,e.doc,n.fromCache,n.mutatedKeys.has(e.doc.key)),i=-1,a=-1
...
return this._firestore===e._firestore&&this._originalQuery.isEqual(e._originalQuery)&&this._snapshot.isEqual(e._snapshot)},t.prototype.convertToDocumentImpl=function(t){return new Po(this._firestore,t.key,t,this.metadata.fromCache,this._snapshot.mutatedKeys.has(t.key))},t}()
s.__spread(["length","forEach","map"],"undefined"!=typeof Symbol?[Symbol.iterator]:[]).forEach(function(t){try{Object.defineProperty(Fo.prototype.docChanges,t,{get:function(){return function(){throw new T(S.INVALID_ARGUMENT,'QuerySnapshot.docChanges has been changed from a property into a method, so usages like "querySnapshot.docChanges" should become "querySnapshot.docChanges()"')}()}})}catch(t){}})
var Vo=function(t){function e(e,n){var r=t.call(this,zr.atPath(e),n)||this
...
var e=st.fromString(t)
return xo.forPath(this._query.path.child(e),this.firestore)},e.prototype.add=function(t){R("CollectionReference.add",arguments,1),O("CollectionReference.add","object",1,t)
var e=this.doc()
return e.set(t).then(function(){return e})},e}(qo)
function Uo(t,e){if(void 0===e)return{merge:!1}
...
for(var o=0;o<r.length;++o)if(!i(r[o]))throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires all "+e+" elements to be "+n+", but the value at index "+o+" was: "+B(r[o]))}(t,e,n,r,i)}(t,"mergeFields","a string or a FieldPath",e.mergeFields,function(t){return"string"==typeof t||t instanceof Hi}),void 0!==e.mergeFields&&void 0!==e.merge)throw new T(S.INVALID_ARGUMENT,"Invalid options passed to function "+t+'(): You cannot specify both "merge" and "mergeFields".')
return e}function Bo(t,e){return void 0===e?{}:(K(t,e,["serverTimestamps"]),F(t,0,"serverTimestamps",e.serverTimestamps,["estimate","previous","none"]),e)}function Qo(t,e){L(t,"object",1,e),e&&(K(t,e,["source"]),F(t,0,"source",e.source,["default","server","cache"]))}function Ko(t,e,n){if(e instanceof xo){if(e.firestore!==n)throw new T(S.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.")
return e}throw G(t,"DocumentReference",1,e)}function Go(t){switch(t){case Ar.Added:return"added"
case Ar.Modified:case Ar.Metadata:return"modified"
case Ar.Removed:return"removed"
default:return v("Unknown change type: "+t)}}var Wo=I(ko,"Use firebase.firestore() instead."),jo=I(Ro,"Use firebase.firestore().runTransaction() instead."),zo=I(Mo,"Use firebase.firestore().batch() instead."),Ho=I(xo,"Use firebase.firestore().doc() instead."),Yo=I(Lo),Xo=I(Po),Jo=I(qo),Zo=I(Fo),$o=I(Vo,"Use firebase.firestore().collection() instead."),ta={Firestore:Wo,GeoPoint:jr,Timestamp:St,Blob:et,Transaction:jo,WriteBatch:zo,DocumentReference:Ho,DocumentSnapshot:Yo,Query:Jo,QueryDocumentSnapshot:Xo,QuerySnapshot:Zo,CollectionReference:$o,FieldPath:Hi,FieldValue:co,setLogLevel:ko.setLogLevel,CACHE_SIZE_UNLIMITED:Do}
...
break
case h.ErrorCode.TIMEOUT:y(ia,'RPC "'+t+'" timed out'),a(new T(S.DEADLINE_EXCEEDED,"Request time out"))
break
case h.ErrorCode.HTTP_ERROR:var n=s.getStatus()
y(ia,'RPC "'+t+'" failed with status:',n,"response text:",s.getResponseText()),n>0?a(new T(function(t){switch(t){case 200:return S.OK
...
default:return t>=200&&t<300?S.OK:t>=400&&t<500?S.FAILED_PRECONDITION:t>=500&&t<600?S.INTERNAL:S.UNKNOWN}}(n),"Server responded with status "+s.getStatusText())):(y(ia,'RPC "'+t+'" failed'),a(new T(S.UNAVAILABLE,"Connection failed.")))
break
