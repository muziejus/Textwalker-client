...
return!0}function k(t,e){if(0!==e.length)throw new T(S.INVALID_ARGUMENT,"Function "+t+"() does not support arguments, but was called with "+G(e.length,"argument")+".")}function R(t,e,n){if(e.length!==n)throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires "+G(n,"argument")+", but was called with "+G(e.length,"argument")+".")}function M(t,e,n){if(e.length<n)throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires at least "+G(n,"argument")+", but was called with "+G(e.length,"argument")+".")}function O(t,e,n,r){if(e.length<n||e.length>r)throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires between "+n+" and "+r+" arguments, but was called with "+G(e.length,"argument")+".")}function L(t,e,n,r){V(t,e,j(n)+" argument",r)}function P(t,e,n,r){void 0!==r&&L(t,e,n,r)}function x(t,e,n,r){V(t,e,n+" option",r)}function q(t,e,n,r){void 0!==r&&x(t,e,n,r)}function F(t,e,n,r,i){void 0!==r&&function(t,e,n,r,i){for(var o=[],a=0,s=i;a<s.length;a++){var u=s[a]
if(u===r)return
o.push(U(u))}var c=U(r)
throw new T(S.INVALID_ARGUMENT,"Invalid value "+c+" provided to function "+t+'() for option "'+n+'". Acceptable values: '+o.join(", "))}(t,0,n,r,i)}function V(t,e,n,i){if(!("object"===e?B(i):"non-empty string"===e?"string"==typeof i&&""!==i:r(i)===e)){var o=U(i)
throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires its "+n+" to be of type "+e+", but it was: "+o)}}function B(t){return"object"===r(t)&&null!==t&&(Object.getPrototypeOf(t)===Object.prototype||null===Object.getPrototypeOf(t))}function U(t){if(void 0===t)return"undefined"
...
return e?"a custom "+e+" object":"an object"}return"function"==typeof t?"a function":v("Unknown wrong type: "+r(t))}function Q(t,e,n){if(void 0===n)throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires a valid "+j(e)+" argument, but it was undefined.")}function K(t,e,n){N(e,function(e,r){if(n.indexOf(e)<0)throw new T(S.INVALID_ARGUMENT,"Unknown option '"+e+"' passed to function "+t+"(). Available options: "+n.join(", "))})}function W(t,e,n,r){var i=U(r)
return new T(S.INVALID_ARGUMENT,"Function "+t+"() requires its "+j(n)+" argument to be a "+e+", but it was: "+i)}function j(t){switch(t){case 1:return"first"
...
return!0}function X(t){return t+"\0"}function J(){if("undefined"==typeof Uint8Array)throw new T(S.UNIMPLEMENTED,"Uint8Arrays are not available in this environment.")}function Z(){if(!w.getPlatform().base64Available)throw new T(S.UNIMPLEMENTED,"Blobs are unavailable in Firestore in this environment.")}var $,tt=function(){function t(t){Z(),this._binaryString=t}return t.fromBase64String=function(e){R("Blob.fromBase64String",arguments,1),L("Blob.fromBase64String","string",1,e),Z()
try{return new t(w.getPlatform().atob(e))}catch(t){throw new T(S.INVALID_ARGUMENT,"Failed to construct Blob from Base64 string: "+t)}},t.fromUint8Array=function(e){if(R("Blob.fromUint8Array",arguments,1),J(),!(e instanceof Uint8Array))throw W("Blob.fromUint8Array","Uint8Array",1,e)
...
case pt:n+=pt+gt
break
default:n+=o}}return n}function wt(t){return t+pt+mt}function Et(t){var e=t.length
...
return Ht(t).iterate({index:Oe.userMutationsIndex,range:i},function(t,e,i){e.userId===n.userId&&(b(e.batchId>=r,"Should have found mutation after "+r),o=n.serializer.fromDbMutationBatch(e)),i.done()}).next(function(){return o})},t.prototype.getHighestUnacknowledgedBatchId=function(t){var e=IDBKeyRange.upperBound([this.userId,Number.POSITIVE_INFINITY]),n=-1
...
return Yt(t).iterate({range:i},function(r,i,a){var s=r[0],u=r[1],c=r[2],h=Et(u)
...
return e.forEach(function(e){var o=Le.prefixForPath(n.userId,e.path),a=IDBKeyRange.lowerBound(o),s=Yt(t).iterate({range:a},function(t,i,o){var a=t[0],s=t[1],u=t[2],c=Et(s)
...
return Yt(t).iterate({range:a},function(t,e,o){var a=t[0],u=t[1],c=t[2],h=Et(u)
...
o.push(i.delete(d)),c.push(f.key)}return Kt.waitFor(o).next(function(){return c})}function zt(t){return t instanceof Uint8Array?(b("YES"===process.env.USE_MOCK_PERSISTENCE,"Persisting non-string stream tokens is only supported with mock persistence."),t.toString()):t}function Ht(t){return hn.getStore(t,Oe.store)}function Yt(t){return hn.getStore(t,Le.store)}function Xt(t){return hn.getStore(t,Me.store)}var Jt,Zt=1
...
return Se(t).get(Ie(e)).next(function(t){return t?n.serializer.fromDbRemoteDocument(t):null})},t.prototype.getSizedEntry=function(t,e){var n=this
return Se(t).get(Ie(e)).next(function(t){return t?{maybeDocument:n.serializer.fromDbRemoteDocument(t),size:Ce(t)}:null})},t.prototype.getEntries=function(t,e){var n=this,r=Mt()
...
return Se(t).iterate({range:r},function(t,e,r){for(var a=ht.fromSegments(t);o&&ht.comparator(o,a)<0;)n(o,null),o=i.getNext()
...
return Se(t).iterate({range:a},function(t,o,a){if(t.length===i){var s=n.serializer.fromDbRemoteDocument(o)
...
return a.iterate({range:i},function(t,r){if(o&&(o=!1,e._lastProcessedDocumentChangeId+1!==r.id))return e.synchronizeLastDocumentChangeId(a).next(function(){return Kt.reject(new T(S.DATA_LOSS,be))})
...
return this._lastProcessedDocumentChangeId=0,t.iterate({keysOnly:!0,reverse:!0},function(t,n,r){e._lastProcessedDocumentChangeId=t,r.done()})},t.prototype.newChangeBuffer=function(){return new t.RemoteDocumentChangeBuffer(this)},t.prototype.getSize=function(t){return this.getMetadata(t).next(function(t){return t.byteSize})},t.prototype.getMetadata=function(t){return Ee(t).get(Fe.key).next(function(t){return b(!!t,"Missing document cache metadata"),t})},t.prototype.setMetadata=function(t,e){return Ee(t).put(Fe.key,e)},t.RemoteDocumentChangeBuffer=function(t){function e(e){var n=t.call(this)||this
...
if(b(void 0!==s,"Cannot modify a document that wasn't read (for "+o+")"),a){var u=e.documentCache.serializer.toDbRemoteDocument(a),c=Ce(u)
...
function Ee(t){return hn.getStore(t,Fe.store)}function Se(t){return hn.getStore(t,qe.store)}function Te(t){return hn.getStore(t,je.store)}function Ie(t){return t.path.toArray()}function Ce(t){var e
...
return r.loadAll(Oe.userMutationsIndex,i).next(function(r){return Kt.forEach(r,function(r){b(r.userId===n.userId,"Cannot process batch "+r.batchId+" from unexpected user")
...
return new ke(e.seconds,e.nanoseconds)},t.prototype.fromDbTimestamp=function(t){var e=new St(t.seconds,t.nanoseconds)
...
e=e.add(new ht(Et(i)))}return e},t.prototype.fromDbTarget=function(t){var e,n=this.fromDbTimestamp(t.readTime)
return e=void 0!==t.query.documents?this.remoteSerializer.fromDocumentsTarget(t.query):this.remoteSerializer.fromQueryTarget(t.query),new Xe(e,t.targetId,We.Listen,t.lastListenSequenceNumber,n,t.resumeToken)},t.prototype.toDbTarget=function(t){b(We.Listen===t.purpose,"Only queries with purpose "+We.Listen+" may be stored, got "+t.purpose)
...
return r.simpleDbTransaction=e,r.currentSequenceNumber=n,r}return u.__extends(e,t),e}(function(){}),hn=function(){function t(e,n,r,i,o,a,s){if(this.persistenceKey=e,this.clientId=n,this.queue=i,this.multiClientParams=s,this._started=!1,this.isPrimary=!1,this.networkEnabled=!0,this.windowUnloadHandler=null,this.inForeground=!1,this.documentVisibilityHandler=null,this.clientMetadataRefresher=null,this.lastGarbageCollectionTime=Number.NEGATIVE_INFINITY,this.primaryStateListener=function(t){return Promise.resolve()},!t.isAvailable())throw new T(S.UNIMPLEMENTED,un)
if(this.referenceDelegate=new yn(this,a),this.dbName=e+t.MAIN_DATABASE,this.serializer=new Je(o),this.document=r.document,this.allowTabSynchronization=void 0!==s,this.queryCache=new ue(this.referenceDelegate,this.serializer),this.indexManager=new He,this.remoteDocumentCache=new we(this.serializer,this.indexManager,this.allowTabSynchronization),!r.window||!r.window.localStorage)throw new T(S.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.")
...
return b(!this.started,"IndexedDbPersistence double-started!"),b(null!==this.window,"Expected 'window' to be defined"),ee.openOrCreate(this.dbName,Ne,new Ae(this.serializer)).then(function(e){return t.simpleDb=e,t.updateClientMetadataAndTryBecomePrimary()}).then(function(){return t.attachVisibilityHandler(),t.attachWindowUnloadHook(),t.scheduleClientMetadataAndPrimaryLeaseRefreshes(),t.startRemoteDocumentCache()}).then(function(){return t.simpleDb.runTransaction("readonly",[Ue.store],function(e){return le(e).next(function(e){var n=t.multiClientParams?t.multiClientParams.sequenceNumberSyncer:void 0
...
if(!e.isLocalClient(n)){if(!n.allowTabSynchronization)throw new T(S.FAILED_PRECONDITION,sn)
...
function ln(t){return u.__awaiter(this,void 0,void 0,function(){return u.__generator(this,function(e){if(!function(t){return t.code===S.FAILED_PRECONDITION&&t.message===an}(t))throw t
...
0===o?(i!==ot.INVALID&&e(new ht(Et(n)),i),i=s,n=a):i=ot.INVALID}).next(function(){i!==ot.INVALID&&e(new ht(Et(n)),i)})},t.prototype.getCacheSize=function(t){return this.db.getRemoteDocumentCache().getSize(t)},t}()
...
return null===t?"null":t.toString()},t.prototype.defaultCompareTo=function(t){return b(this.typeOrder!==t.typeOrder,"Default compareTo should not be used for values of same type."),H(this.typeOrder,t.typeOrder)},t}(),wn=function(t){function e(){var e=t.call(this)||this
...
var n,r},e}(bn)
function Tn(t,e){return t===e?0!==t||1/t==1/e:t!=t&&e!=e}var In,Cn=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return u.__extends(e,t),e.prototype.isEqual=function(t){return t instanceof e&&Tn(this.internalValue,t.internalValue)},e}(Sn),Dn=function(t){function e(){return null!==t&&t.apply(this,arguments)||this}return u.__extends(e,t),e.prototype.isEqual=function(t){return t instanceof e&&Tn(this.internalValue,t.internalValue)},e.NAN=new e(NaN),e.POSITIVE_INFINITY=new e(1/0),e.NEGATIVE_INFINITY=new e(-1/0),e}(Sn),_n=function(t){function e(e){var n=t.call(this)||this
...
return 0!==n?n:ht.comparator(this.key,t.key)}return this.defaultCompareTo(t)},e}(bn),Mn=function(t){function e(e){var n=t.call(this)||this
...
if(i)return i}return H(this.internalValue.length,t.internalValue.length)}return this.defaultCompareTo(t)},e.prototype.toString=function(){return"["+this.internalValue.map(function(t){return t.toString()}).join(",")+"]"},e}(bn),Pn=function(){function t(t){this.fields=t}return t.fromSet=function(e){return new t(e)},t.fromArray=function(e){var n=new Nt(ct.comparator)
...
e instanceof pe&&(u=e.field(a.field)),null===u&&n instanceof pe&&(u=n.field(a.field)),r.push(s.applyToLocalView(u,t))}return r},e.prototype.transformObject=function(t,e){b(e.length===this.fieldTransforms.length,"TransformResults length mismatch.")
...
return r.key=e,r.precondition=n,r.type=In.Delete,r}return u.__extends(e,t),e.prototype.applyToRemoteDocument=function(t,e){return this.verifyKeyMatches(t),b(null==e.transformResults,"Transform results received by DeleteMutation."),new me(this.key,e.version,{hasCommittedMutations:!0})},e.prototype.applyToLocalView=function(t,e,n){return this.verifyKeyMatches(t),this.precondition.isValidFor(t)?(t&&b(t.key.isEqual(this.key),"Can only apply mutation to document with same key"),new me(this.key,Tt.forDeletedDoc())):t},e.prototype.extractBaseValue=function(t){return null},e.prototype.isEqual=function(t){return t instanceof e&&this.key.isEqual(t.key)&&this.precondition.isEqual(t.precondition)},e}(Vn),Wn=function(){function t(t,e,n){this.remoteDocumentCache=t,this.mutationQueue=e,this.indexManager=n}return t.prototype.getDocument=function(t,e){var n=this
...
for(var m=0,y=c.mutations;m<y.length;m++)f=y[m],a=a.add(f.key)}return e.localDocuments.getDocuments(n,a).next(function(t){return{affectedDocuments:t,removedBatchIds:i,addedBatchIds:o}})})})},t.prototype.localWrite=function(t){var e=this,n=St.now(),r=t.reduce(function(t,e){return t.add(e.key)},Ft())
...
return this.persistence.runTransaction("Get new document changes","readonly",function(e){return t.remoteDocuments.getNewDocumentChanges(e)})},t.RESUME_TOKEN_MAX_AGE_MICROS=3e8,t}(),Hn=function(){function t(t,e){this.indexManager=t,this.referenceDelegate=e,this.mutationQueue=[],this.nextBatchId=1,this.lastStreamToken=E(),this.batchesByDocumentKey=new Nt(Gn.compareByKey)}return t.prototype.checkEmpty=function(t){return Kt.resolve(0===this.mutationQueue.length)},t.prototype.acknowledgeBatch=function(t,e,n){var r=e.batchId,i=this.indexOfExistingBatchId(r,"acknowledged")
...
return this.credentials.getToken().then(function(r){return n.connection.invokeStreamingRPC(t,e,r)}).catch(function(t){throw t.code===S.UNAUTHENTICATED&&n.credentials.invalidateToken(),t})},t}(),vr=function(){function t(t){this.datastore=t,this.readVersions=xt(),this.mutations=[],this.committed=!1,this.lastWriteError=null,this.writtenDocs=new Set}return t.prototype.lookup=function(t){return u.__awaiter(this,void 0,void 0,function(){var e,n=this
return u.__generator(this,function(r){switch(r.label){case 0:if(this.ensureCommitNotCalled(),this.mutations.length>0)throw new T(S.INVALID_ARGUMENT,"Firestore transactions require all reads to be executed before all writes.")
...
if(t=this.readVersions,this.mutations.forEach(function(e){t=t.remove(e.key)}),!t.isEmpty())throw new T(S.INVALID_ARGUMENT,"Every document read in a transaction must also be written.")
...
return Fn.updateTime(e)}return Fn.exists(!0)},t.prototype.write=function(t){this.ensureCommitNotCalled(),this.mutations=this.mutations.concat(t)},t.prototype.ensureCommitNotCalled=function(){b(!this.committed,"A transaction object cannot be used after its update callback has been invoked.")},t}()
...
var br,wr=function(){function t(t,e){this.asyncQueue=t,this.onlineStateHandler=e,this.state=fr.Unknown,this.watchStreamFailures=0,this.onlineStateTimer=null,this.shouldWarnClientIsOffline=!0}return t.prototype.handleWatchStreamStart=function(){var t=this
0===this.watchStreamFailures&&(this.setAndBroadcast(fr.Unknown),b(null===this.onlineStateTimer,"onlineStateTimer shouldn't be started yet"),this.onlineStateTimer=this.asyncQueue.enqueueAfterDelay($.OnlineStateTimeout,1e4,function(){return t.onlineStateTimer=null,b(t.state===fr.Unknown,"Timer should be canceled if we transitioned to a different state."),t.logClientOfflineWarningIfNecessary("Backend didn't respond within 10 seconds."),t.setAndBroadcast(fr.Offline),Promise.resolve()}))},t.prototype.handleWatchStreamFailure=function(t){this.state===fr.Online?(this.setAndBroadcast(fr.Unknown),b(0===this.watchStreamFailures,"watchStreamFailures must be 0"),b(null===this.onlineStateTimer,"onlineStateTimer must be null")):(this.watchStreamFailures++,this.watchStreamFailures>=1&&(this.clearOnlineStateTimer(),this.logClientOfflineWarningIfNecessary("Connection failed 1 times. Most recent error: "+t.toString()),this.setAndBroadcast(fr.Offline)))},t.prototype.set=function(t){this.clearOnlineStateTimer(),this.watchStreamFailures=0,t===fr.Online&&(this.shouldWarnClientIsOffline=!1),this.setAndBroadcast(t)},t.prototype.setAndBroadcast=function(t){t!==this.state&&(this.state=t,this.onlineStateHandler(t))},t.prototype.logClientOfflineWarningIfNecessary=function(t){var e="Could not reach Cloud Firestore backend. "+t+"\nThis typically indicates that your device does not have a healthy Internet connection at the moment. The client will operate in offline mode until it is able to successfully connect to the backend."
...
function Er(t){switch(t){case S.OK:return v("Treated status OK as error")
...
default:return v("Unknown status code: "+t)}}function Sr(t){if(void 0===t)return y("GRPC error has no .code"),S.UNKNOWN
switch(t){case br.OK:return S.OK
case br.CANCELLED:return S.CANCELLED
case br.UNKNOWN:return S.UNKNOWN
case br.DEADLINE_EXCEEDED:return S.DEADLINE_EXCEEDED
case br.RESOURCE_EXHAUSTED:return S.RESOURCE_EXHAUSTED
case br.INTERNAL:return S.INTERNAL
case br.UNAVAILABLE:return S.UNAVAILABLE
case br.UNAUTHENTICATED:return S.UNAUTHENTICATED
case br.INVALID_ARGUMENT:return S.INVALID_ARGUMENT
case br.NOT_FOUND:return S.NOT_FOUND
case br.ALREADY_EXISTS:return S.ALREADY_EXISTS
case br.PERMISSION_DENIED:return S.PERMISSION_DENIED
case br.FAILED_PRECONDITION:return S.FAILED_PRECONDITION
case br.ABORTED:return S.ABORTED
case br.OUT_OF_RANGE:return S.OUT_OF_RANGE
case br.UNIMPLEMENTED:return S.UNIMPLEMENTED
case br.DATA_LOSS:return S.DATA_LOSS
default:return v("Unknown status code: "+t)}}function Tr(t){if(void 0===t)return br.OK
switch(t){case S.OK:return br.OK
case S.CANCELLED:return br.CANCELLED
case S.UNKNOWN:return br.UNKNOWN
case S.DEADLINE_EXCEEDED:return br.DEADLINE_EXCEEDED
case S.RESOURCE_EXHAUSTED:return br.RESOURCE_EXHAUSTED
case S.INTERNAL:return br.INTERNAL
case S.UNAVAILABLE:return br.UNAVAILABLE
case S.UNAUTHENTICATED:return br.UNAUTHENTICATED
case S.INVALID_ARGUMENT:return br.INVALID_ARGUMENT
case S.NOT_FOUND:return br.NOT_FOUND
case S.ALREADY_EXISTS:return br.ALREADY_EXISTS
case S.PERMISSION_DENIED:return br.PERMISSION_DENIED
case S.FAILED_PRECONDITION:return br.FAILED_PRECONDITION
case S.ABORTED:return br.ABORTED
case S.OUT_OF_RANGE:return br.OUT_OF_RANGE
case S.UNIMPLEMENTED:return br.UNIMPLEMENTED
case S.DATA_LOSS:return br.DATA_LOSS
default:return v("Unknown status code: "+t)}}!function(t){t[t.OK=0]="OK",t[t.CANCELLED=1]="CANCELLED",t[t.UNKNOWN=2]="UNKNOWN",t[t.INVALID_ARGUMENT=3]="INVALID_ARGUMENT",t[t.DEADLINE_EXCEEDED=4]="DEADLINE_EXCEEDED",t[t.NOT_FOUND=5]="NOT_FOUND",t[t.ALREADY_EXISTS=6]="ALREADY_EXISTS",t[t.PERMISSION_DENIED=7]="PERMISSION_DENIED",t[t.UNAUTHENTICATED=16]="UNAUTHENTICATED",t[t.RESOURCE_EXHAUSTED=8]="RESOURCE_EXHAUSTED",t[t.FAILED_PRECONDITION=9]="FAILED_PRECONDITION",t[t.ABORTED=10]="ABORTED",t[t.OUT_OF_RANGE=11]="OUT_OF_RANGE",t[t.UNIMPLEMENTED=12]="UNIMPLEMENTED",t[t.INTERNAL=13]="INTERNAL",t[t.UNAVAILABLE=14]="UNAVAILABLE",t[t.DATA_LOSS=15]="DATA_LOSS"}(br||(br={}))
...
return new t(Tt.MIN,i,Bt(),Rt(),Ft())},t}(),Rr=function(){function t(t,e,n,r,i){this.resumeToken=t,this.current=e,this.addedDocuments=n,this.modifiedDocuments=r,this.removedDocuments=i}return t.createSynthesizedTargetChangeForCurrentChange=function(e,n){return new t(E(),n,Ft(),Ft(),Ft())},t}(),Mr=function(t,e,n,r){this.updatedTargetIds=t,this.removedTargetIds=e,this.key=n,this.newDoc=r},Or=function(t,e){this.targetId=t,this.existenceFilter=e}
!function(t){t[t.NoChange=0]="NoChange",t[t.Added=1]="Added",t[t.Removed=2]="Removed",t[t.Current=3]="Current",t[t.Reset=4]="Reset"}(_r||(_r={}))
var Lr=function(t,e,n,r){void 0===n&&(n=E()),void 0===r&&(r=null),this.state=t,this.targetIds=e,this.resumeToken=n,this.cause=r},Pr=function(){function t(){this.pendingResponses=0,this.documentChanges=Fr(),this._resumeToken=E(),this._current=!1,this._hasPendingChanges=!0}return Object.defineProperty(t.prototype,"current",{get:function(){return this._current},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"resumeToken",{get:function(){return this._resumeToken},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"isPending",{get:function(){return 0!==this.pendingResponses},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"hasPendingChanges",{get:function(){return this._hasPendingChanges},enumerable:!0,configurable:!0}),t.prototype.updateResumeToken=function(t){t.length>0&&(this._hasPendingChanges=!0,this._resumeToken=t)},t.prototype.toTargetChange=function(){var t=Ft(),e=Ft(),n=Ft()
...
break
case _r.Removed:r.recordTargetResponse(),r.isPending||e.removeTarget(n),b(!t.cause,"WatchChangeAggregator does not handle errored targets")
break
...
b(!this.targetStates[t].isPending,"Should only reset active targets"),this.targetStates[t]=new Pr,this.metadataProvider.getRemoteKeysForTarget(t).forEach(function(n){e.removeDocumentFromTarget(t,n,null)})},t.prototype.targetContainsDocument=function(t,e){return this.metadataProvider.getRemoteKeysForTarget(t).has(e)},t}()
...
return u.__generator(this,function(r){switch(r.label){case 0:return this.onlineStateTracker.set(fr.Online),t instanceof Lr&&t.state===_r.Removed&&t.cause?[2,this.handleTargetError(t)]:(t instanceof Mr?this.watchChangeAggregator.handleDocumentChange(t):t instanceof Or?this.watchChangeAggregator.handleExistenceFilter(t):(b(t instanceof Lr,"Expected watchChange to be an instance of WatchTargetChange"),this.watchChangeAggregator.handleTargetChange(t)),e.isEqual(Tt.MIN)?[3,3]:[4,this.localStore.getLastRemoteSnapshotVersion()])
...
return u.__generator(this,function(n){return void 0===t&&b(!this.shouldStartWriteStream(),"Write stream was stopped gracefully while still needed."),t&&this.writePipeline.length>0?[2,(this.writeStream.handshakeComplete?this.handleWriteError(t):this.handleHandshakeError(t)).then(function(){e.shouldStartWriteStream()&&e.startWriteStream()})]:[2]})})},t.prototype.handleHandshakeError=function(t){return u.__awaiter(this,void 0,void 0,function(){return u.__generator(this,function(e){return Er(t.code)?(m(Vr,"RemoteStore error before completed handshake; resetting stream token: ",this.writeStream.lastStreamToken),this.writeStream.lastStreamToken=E(),[2,this.localStore.setLastStreamToken(E()).catch(ln)]):[2]})})},t.prototype.handleWriteError=function(t){return u.__awaiter(this,void 0,void 0,function(){var e,n=this
return u.__generator(this,function(r){return Er(i=t.code)&&i!==S.ABORTED?(e=this.writePipeline.shift(),this.writeStream.inhibitBackoff(),[2,this.syncEngine.rejectFailedWrite(e.batchId,t).then(function(){return n.fillWritePipeline()})]):[2]
...
case 4:return[2]}})})},t}(),Ur=function(){function t(t,e){if(R("GeoPoint",arguments,2),L("GeoPoint","number",1,t),L("GeoPoint","number",2,e),!isFinite(t)||t<-90||t>90)throw new T(S.INVALID_ARGUMENT,"Latitude must be a number between -90 and 90, but was: "+t)
...
return i.field=e,i.op=n,i.value=r,i}return u.__extends(e,t),e.create=function(t,n,r){if(t.isKeyField())return n===Kr.IN?(b(r instanceof Ln,"Comparing on key with IN, but filter value not an ArrayValue"),b(r.internalValue.every(function(t){return t instanceof Rn}),"Comparing on key with IN, but an array value was not a RefValue"),new Gr(t,r)):(b(r instanceof Rn,"Comparing on key, but filter value not a RefValue"),b(n!==Kr.ARRAY_CONTAINS&&n!==Kr.ARRAY_CONTAINS_ANY,"'"+n.toString()+"' queries don't make sense on document keys."),new jr(t,n,r))
if(r.isEqual(wn.INSTANCE)){if(n!==Kr.EQUAL)throw new T(S.INVALID_ARGUMENT,"Invalid query. Null supports only equality comparisons.")
return new e(t,n,r)}if(r.isEqual(Dn.NAN)){if(n!==Kr.EQUAL)throw new T(S.INVALID_ARGUMENT,"Invalid query. NaN supports only equality comparisons.")
return new e(t,n,r)}return n===Kr.ARRAY_CONTAINS?new zr(t,r):n===Kr.IN?(b(r instanceof Ln,"IN filter has invalid value: "+r.toString()),new Hr(t,r)):n===Kr.ARRAY_CONTAINS_ANY?(b(r instanceof Ln,"ARRAY_CONTAINS_ANY filter has invalid value: "+r.toString()),new Yr(t,r)):new e(t,n,r)},e.prototype.matches=function(t){var e=t.field(this.field)
...
if(i.field.isKeyField())b(o instanceof Rn,"Bound has a non-key value where the key path is being used."),n=ht.comparator(o.key,e.key)
else{var a=e.field(i.field)
b(void 0!==a,"Field should exist since document matched the orderBy already."),n=o.compareTo(a)}if(i.dir===Xr.DESCENDING&&(n*=-1),0!==n)break}return this.before?n<=0:n<0},t.prototype.isEqual=function(t){if(null===t)return!1
...
return new Cn(r)}return r=n.internalValue+this.operand.internalValue,new Dn(r)},t.prototype.applyToRemoteDocument=function(t,e){return b(null!==e,"Didn't receive transformResult for NUMERIC_ADD transform"),e},t.prototype.computeBaseValue=function(t){return t instanceof Sn?t:new Cn(0)},t.prototype.isEqual=function(e){return e instanceof t&&this.operand.isEqual(e.operand)},t}()
...
function fi(t,e){b(!or(t),e+" is missing")}function di(t){return"number"==typeof t?t:"string"==typeof t?Number(t):v("can't parse "+t)}var pi=function(){function t(t,e){this.databaseId=t,this.options=e}return t.prototype.emptyByteString=function(){return this.options.useProto3Json?"":new Uint8Array(0)},t.prototype.unsafeCastProtoByteString=function(t){return t},t.prototype.fromRpcStatus=function(t){var e=void 0===t.code?S.UNKNOWN:Sr(t.code)
...
return new St(e,n)},t.prototype.fromIso8601String=function(t){var e=0,n=li.exec(t)
...
return t.forEach(function(t){n.push(e.toValue(t))}),{values:n}},t.prototype.fromFound=function(t){b(!!t.found,"Tried to deserialize a found document from a missing document."),fi(t.found.name,"doc.found.name"),fi(t.found.updateTime,"doc.found.updateTime")
...
var y=t.filter,g=y.count||0,b=new ui(g),w=y.targetId
e=new Or(w,b)}return e},t.prototype.fromWatchTargetChangeState=function(t){return"NO_CHANGE"===t?_r.NoChange:"ADD"===t?_r.Added:"REMOVE"===t?_r.Removed:"CURRENT"===t?_r.Current:"RESET"===t?_r.Reset:v("Got unexpected TargetChange.state: "+t)},t.prototype.versionFromListenResponse=function(t){if(!("targetChange"in t))return Tt.MIN
...
if("setToServerValue"in t)b("REQUEST_TIME"===t.setToServerValue,"Unknown server value transform proto: "+JSON.stringify(t)),n=ei.instance
...
b(i instanceof Sn,"NUMERIC_ADD transform requires a NumberValue"),n=new ii(i)}else v("Unknown transform proto: "+JSON.stringify(t))
...
return Wr.create(n,Kr.EQUAL,wn.INSTANCE)
...
var n=e!==fr.Offline
return this.options.waitForSyncWhenOnline&&n?(b(t.fromCache,"Waiting for sync, but snapshot is not from cache"),!1):!t.docs.isEmpty()||e===fr.Offline},t.prototype.shouldRaiseEvent=function(t){if(t.docChanges.length>0)return!0
var e=this.snap&&this.snap.hasPendingWrites!==t.hasPendingWrites
return!(!t.syncStateChanged&&!e)&&!0===this.options.includeMetadataChanges},t.prototype.raiseInitialEvent=function(t){b(!this.raisedInitialEvent,"Trying to raise initial events for second time"),t=Ar.fromInitialDocuments(t.query,t.docs,t.mutatedKeys,t.fromCache),this.raisedInitialEvent=!0,this.queryObserver.next(t)},t}(),vi=function(){function t(t,e,n){this.targetId=t,this.addedKeys=e,this.removedKeys=n}return t.fromSnapshot=function(e,n){for(var r=Ft(),i=Ft(),o=0,a=n.docChanges;o<a.length;o++){var s=a[o]
switch(s.type){case Ir.Added:r=r.add(s.doc.key)
break
case Ir.Removed:i=i.add(s.doc.key)}}return new t(e,r,i)},t}(),bi=function(t){this.key=t},wi=function(t){this.key=t},Ei=function(){function t(t,e){this.query=t,this._syncedDocuments=e,this.syncState=null,this.current=!1,this.limboDocuments=Ft(),this.mutatedKeys=Ft(),this.documentSet=new Dr(t.docComparator.bind(t))}return Object.defineProperty(t.prototype,"syncedDocuments",{get:function(){return this._syncedDocuments},enumerable:!0,configurable:!0}),t.prototype.computeDocChanges=function(t,e){var n=this,r=e?e.changeSet:new Nr,i=e?e.documentSet:this.documentSet,o=e?e.mutatedKeys:this.mutatedKeys,a=i,s=!1,u=this.query.hasLimit()&&i.size===this.query.limit?i.last():null
...
a=a.delete(c.key),o=o.delete(c.key),r.track({type:Ir.Removed,doc:c})}return b(!s||!e,"View was refilled using docs that themselves needed refilling."),{documentSet:a,changeSet:r,needsRefill:s,mutatedKeys:o}},t.prototype.shouldWaitForSyncedDocument=function(t,e){return t.hasLocalMutations&&e.hasCommittedMutations&&!e.hasLocalMutations},t.prototype.applyChanges=function(t,e,n){var r=this
...
var n=[]
return e.forEach(function(e){t.limboDocuments.has(e)||n.push(new wi(e))}),this.limboDocuments.forEach(function(t){e.has(t)||n.push(new bi(t))}),n},t.prototype.synchronizeWithPersistedState=function(t,e){this._syncedDocuments=e,this.limboDocuments=Ft()
var n=this.computeDocChanges(t)
return this.applyChanges(n,!0)},t.prototype.computeInitialSnapshot=function(){return Ar.fromInitialDocuments(this.query,this.documentSet,this.mutatedKeys,this.syncState===Cr.Local)},t}(),Si=5,Ti=function(){function t(t,e,n,r){this.asyncQueue=t,this.remoteStore=e,this.updateFunction=n,this.deferred=r,this.retries=Si,this.backoff=new lr(this.asyncQueue,$.RetryTransaction)}return t.prototype.run=function(){this.runWithBackOff()},t.prototype.runWithBackOff=function(){var t=this
...
case 2:return i=u.sent(),o=new Ei(n,i),a=o.computeDocChanges(r),s=Rr.createSynthesizedTargetChangeForCurrentChange(t.targetId,e&&this.onlineState!==fr.Offline),b(0===(c=o.applyChanges(a,!0===this.isPrimary,s)).limboChanges.length,"View returned limbo docs before target ack from the server."),b(!!c.snapshot,"applyChanges for new view should always return a snapshot"),h=new Ii(n,t.targetId,o),this.queryViewsByQuery.set(n,h),this.queryViewsByTarget[t.targetId]=h,[2,c.snapshot]}})})},t.prototype.synchronizeViewAndComputeSnapshot=function(t){return u.__awaiter(this,void 0,void 0,function(){var e,n,r
...
case 1:return b(!!(s=this.queryViewsByTarget[t]),"Unknown targetId: "+t),[4,this.localStore.releaseQuery(s.query,!1).then(function(){return c.removeAndCleanupQuery(s)}).catch(ln)]
...
case 4:return(c=o=u.sent()).code!==S.DATA_LOSS||c.message!==be?[3,6]:(a=[],_(this.queryViewsByTarget,function(t){return a.push(t)}),[4,this.synchronizeQueryViewsAndRaiseSnapshots(a)])
...
return this.error&&(t.error={code:this.error.code,message:this.error.message}),JSON.stringify(t)},t}(),Pi=function(){function t(t,e,n){this.targetId=t,this.state=e,this.error=n,b(void 0!==n==("rejected"===e),"QueryTargetMetadata must contain an error iff state is 'rejected'")}return t.fromWebStorageEntry=function(e,n){var i=JSON.parse(n),o="object"===r(i)&&-1!==["not-current","current","rejected"].indexOf(i.state)&&(void 0===i.error||"object"===r(i.error)),a=void 0
...
return console.warn("Error enabling offline persistence. Falling back to persistence disabled: "+t),r.startMemoryPersistence()}):(e.resolve(),this.startMemoryPersistence())},t.prototype.canFallback=function(t){return t instanceof T?t.code===S.FAILED_PRECONDITION||t.code===S.UNIMPLEMENTED:!("undefined"!=typeof DOMException&&t instanceof DOMException)||22===t.code||20===t.code||11===t.code},t.prototype.verifyNotTerminated=function(){if(this.asyncQueue.isShuttingDown)throw new T(S.FAILED_PRECONDITION,"The client has already been terminated.")},t.prototype.startIndexedDbPersistence=function(t,e){var n=this,r=hn.buildStoragePrefix(this.databaseInfo),i=new pi(this.databaseInfo.databaseId,{useProto3Json:!0})
return Promise.resolve().then(function(){return u.__awaiter(n,void 0,void 0,function(){var n,o
return u.__generator(this,function(a){switch(a.label){case 0:if(e.synchronizeTabs&&!Vi.isAvailable(this.platform))throw new T(S.UNIMPLEMENTED,"IndexedDB persistence is only available on platforms that support LocalStorage.")
...
return this.verifyNotTerminated(),this.asyncQueue.enqueue(function(){return e.localStore.readDocument(t)}).then(function(t){if(t instanceof pe)return t
...
return this.verifyNotTerminated(),this.asyncQueue.enqueue(function(){return e.localStore.executeQuery(t)}).then(function(e){var n=Ft(),r=new Ei(t,n),i=r.computeDocChanges(e)
...
!function(t,e,n,r){if(!(e instanceof Array)||e.length<1)throw new T(S.INVALID_ARGUMENT,"Function FieldPath() requires its fieldNames argument to be an array with at least "+G(1,"element")+".")}(0,t)
for(var n=0;n<t.length;++n)if(L("FieldPath","string",n,t[n]),0===t[n].length)throw new T(S.INVALID_ARGUMENT,"Invalid field name at argument $(i + 1). Field names must not be empty.")
...
l=vo(t,h)}if(!r.contains(l))throw new T(S.INVALID_ARGUMENT,"Field '"+l+"' is specified in your field mask but missing from your input data.")
...
null==s&&(s=wn.INSTANCE),n.push(s),r++}return new Ln(n)},t.prototype.parseSentinelFieldValue=function(t,e){if(!ho(e.dataSource))throw e.createError(t._methodName+"() can only be used with update() and set()")
...
e.fieldTransforms.push(new xn(e.path,a))}else v("Unknown FieldValue type: "+t)},t.prototype.parseScalarValue=function(t,e){if(null===t)return wn.INSTANCE
if("number"==typeof t)return ar(t)?new Cn(t):new Dn(t)
if("boolean"==typeof t)return En.of(t)
if("string"==typeof t)return new _n(t)
if(t instanceof Date)return new Nn(St.fromDate(t))
if(t instanceof St)return new Nn(new St(t.seconds,1e3*Math.floor(t.nanoseconds/1e3)))
...
function mo(t){return!("object"!==r(t)||null===t||t instanceof Array||t instanceof Date||t instanceof St||t instanceof Ur||t instanceof tt||t instanceof fo||t instanceof to)}function yo(t,e,n){if(!mo(n)||!B(n)){var r=U(n)
...
throw new T(S.INVALID_ARGUMENT,"Function "+t+"() called with invalid data. Field path arguments must be of type string or FieldPath.")}function vo(t,e){try{return function(t){if(t.search(Gi)>=0)throw new T(S.INVALID_ARGUMENT,"Invalid field path ("+t+"). Paths must not contain '~', '*', '/', '[', or ']'")
try{return new(ji.bind.apply(ji,[void 0].concat(t.split("."))))}catch(e){throw new T(S.INVALID_ARGUMENT,"Invalid field path ("+t+"). Paths must not be empty, begin with '.', end with '.', or contain '..'")}}(e)._internalPath}catch(e){var n=bo(e)
throw new T(S.INVALID_ARGUMENT,"Function "+t+"() called with invalid data. "+n)}}function bo(t){return t instanceof Error?t.message:t.toString()}var wo="firestore.googleapis.com",Eo=!0,So=!0,To=!1,Io=en.COLLECTION_DISABLED,Co=function(){function t(t){if(void 0===t.host){if(void 0!==t.ssl)throw new T(S.INVALID_ARGUMENT,"Can't provide ssl option if host option is not set")
this.host=wo,this.ssl=Eo}else x("settings","non-empty string","host",t.host),this.host=t.host,q("settings","boolean","ssl",t.ssl),this.ssl=D(t.ssl,Eo)
if(K("settings",t,["host","ssl","credentials","timestampsInSnapshots","cacheSizeBytes","experimentalForceLongPolling"]),q("settings","object","credentials",t.credentials),this.credentials=t.credentials,q("settings","boolean","timestampsInSnapshots",t.timestampsInSnapshots),!0===t.timestampsInSnapshots?y("\n  The timestampsInSnapshots setting now defaults to true and you no\n  longer need to explicitly set it. In a future release, the setting\n  will be removed entirely and so it is recommended that you remove it\n  from your firestore.settings() call now."):!1===t.timestampsInSnapshots&&y("\n  The timestampsInSnapshots setting will soon be removed. YOU MUST UPDATE\n  YOUR CODE.\n\n  To hide this warning, stop using the timestampsInSnapshots setting in your\n  firestore.settings({ ... }) call.\n\n  Once you remove the setting, Timestamps stored in Cloud Firestore will be\n  read back as Firebase Timestamp objects instead of as system Date objects.\n  So you will also need to update code expecting a Date to instead expect a\n  Timestamp. For example:\n\n  // Old:\n  const date = snapshot.get('created_at');\n  // New:\n  const timestamp = snapshot.get('created_at'); const date =\n  timestamp.toDate();\n\n  Please audit all existing usages of Date when you enable the new\n  behavior."),this.timestampsInSnapshots=D(t.timestampsInSnapshots,So),q("settings","number","cacheSizeBytes",t.cacheSizeBytes),void 0===t.cacheSizeBytes)this.cacheSizeBytes=en.DEFAULT_CACHE_SIZE_BYTES
else{if(t.cacheSizeBytes!==Io&&t.cacheSizeBytes<en.MINIMUM_CACHE_SIZE_BYTES)throw new T(S.INVALID_ARGUMENT,"cacheSizeBytes must be at least "+en.MINIMUM_CACHE_SIZE_BYTES)
...
if(!o.projectId)throw new T(S.INVALID_ARGUMENT,"Must provide projectId")
this._databaseId=new it(o.projectId,o.database),this._persistenceKey="[DEFAULT]",this._credentials=new Hi}this._settings=new Co({}),this._dataConverter=this.createDataConverter(this._databaseId)}return t.prototype.settings=function(t){if(R("Firestore.settings",arguments,1),L("Firestore.settings","object",1,t),C(t,"persistence"))throw new T(S.INVALID_ARGUMENT,'"persistence" is now specified with a separate call to firestore.enablePersistence().')
var e=new Co(t)
if(this._firestoreClient&&!this._settings.isEqual(e))throw new T(S.FAILED_PRECONDITION,"Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.")
...
return u.__generator(this,function(r){switch(r.label){case 0:if(r.trys.push([0,2,,3]),void 0!==this._firestoreClient&&!this._firestoreClient.clientTerminated)throw new T(S.FAILED_PRECONDITION,"Persistence cannot be cleared after this Firestore instance is initialized.")
return[4,hn.clearPersistence(e)]
case 1:return r.sent(),n.resolve(),[3,3]
case 2:return t=r.sent(),n.reject(t),[3,3]
case 3:return[2]}})})}),n.promise},t.prototype.terminate=function(){return this.app._removeServiceInstance("firestore"),this.INTERNAL.delete()},Object.defineProperty(t.prototype,"_isTerminated",{get:function(){return this.ensureClientConfigured(),this._firestoreClient.clientTerminated},enumerable:!0,configurable:!0}),t.prototype.waitForPendingWrites=function(){return this.ensureClientConfigured(),this._firestoreClient.waitForPendingWrites()},t.prototype.ensureClientConfigured=function(){return this._firestoreClient||this.configureClient(new Qi),this._firestoreClient},t.prototype.makeDatabaseInfo=function(){return new nt(this._databaseId,this._persistenceKey,this._settings.host,this._settings.ssl,this._settings.forceLongPolling)},t.prototype.configureClient=function(t){b(!!this._settings.host,"FirestoreSettings.host is not set"),b(!this._firestoreClient,"configureClient() called multiple times")
var e=this.makeDatabaseInfo()
return this._firestoreClient=new Ki(w.getPlatform(),e,this._credentials,this._queue),this._firestoreClient.start(t)},t.prototype.createDataConverter=function(t){return new po(function(e){if(e instanceof Ao){var n=t,r=e.firestore._databaseId
...
return new it(n)},Object.defineProperty(t.prototype,"app",{get:function(){if(!this._firebaseApp)throw new T(S.FAILED_PRECONDITION,"Firestore was not initialized using the Firebase SDK. 'app' is not available")
...
break
default:throw new T(S.INVALID_ARGUMENT,"Invalid log level: "+t)}},t.prototype._areTimestampsInSnapshotsEnabled=function(){return this._settings.timestampsInSnapshots},t}(),_o=function(){function t(t,e){this._firestore=t,this._transaction=e}return t.prototype.get=function(t){var e=this
...
return this._mutations=this._mutations.concat(new Kn(e._key,Fn.NONE)),this},t.prototype.commit=function(){return u.__awaiter(this,void 0,void 0,function(){return u.__generator(this,function(t){return this.verifyNotCommitted(),this._committed=!0,this._mutations.length>0?[2,this._firestore.ensureClientConfigured().write(this._mutations)]:[2]})})},t.prototype.verifyNotCommitted=function(){if(this._committed)throw new T(S.FAILED_PRECONDITION,"A write batch can no longer be used after commit() has been called.")},t}(),Ao=function(){function t(t,e){this._key=t,this.firestore=e,this._firestoreClient=this.firestore.ensureClientConfigured()}return t.forPath=function(e,n){if(e.length%2!=0)throw new T(S.INVALID_ARGUMENT,"Invalid document reference. Document references must have an even number of segments, but "+e.canonicalString()+" has "+e.length)
return new t(new ht(e),n)},Object.defineProperty(t.prototype,"id",{get:function(){return this._key.path.lastSegment()},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"parent",{get:function(){return new Po(this._key.path.popLast(),this.firestore)},enumerable:!0,configurable:!0}),Object.defineProperty(t.prototype,"path",{get:function(){return this._key.path.canonicalString()},enumerable:!0,configurable:!0}),t.prototype.collection=function(t){if(R("DocumentReference.collection",arguments,1),L("DocumentReference.collection","non-empty string",1,t),!t)throw new T(S.INVALID_ARGUMENT,"Must provide a non-empty collection name to collection()")
...
var i=new Wi({next:function(t){if(e.next){b(t.docs.size<=1,"Too many documents returned on a document query")
...
return b("object"===r(n),"Document in a QueryDocumentSnapshot should exist"),n},e}(Ro),Oo=function(){function t(t,e){this._query=t,this.firestore=e}return t.prototype.where=function(e,n,r){if(R("Query.where",arguments,3),Q("Query.where",3,r),"in"!==n&&"array-contains-any"!==n){(function(t,e,n,r){if(!e.some(function(t){return t===r}))throw new T(S.INVALID_ARGUMENT,"Invalid value "+U(r)+" provided to function "+t+"() for its "+j(n)+" argument. Acceptable values: "+e.join(", "))})("Query.where",["<","<=","==",">=",">","array-contains"],2,n)}var i,o=go("Query.where",e),a=Kr.fromString(n)
if(o.isKeyField()){if(a===Kr.ARRAY_CONTAINS||a===Kr.ARRAY_CONTAINS_ANY)throw new T(S.INVALID_ARGUMENT,"Invalid Query. You can't perform '"+a.toString()+"' queries on FieldPath.documentId().")
...
r=Xr.DESCENDING}if(null!==this._query.startAt)throw new T(S.INVALID_ARGUMENT,"Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().")
...
return this.validateNewOrderBy(o),new t(this._query.addOrderBy(o),this.firestore)},t.prototype.limit=function(e){if(R("Query.limit",arguments,1),L("Query.limit","number",1,e),e<=0)throw new T(S.INVALID_ARGUMENT,"Invalid Query. Query limit ("+e+") is invalid. Limit must be positive.")
...
return this.firestore===e.firestore&&this._query.isEqual(e._query)},t.prototype.boundFromDocOrFields=function(t,e,n,r){if(Q(t,1,e),e instanceof Ro){if(n.length>0)throw new T(S.INVALID_ARGUMENT,"Too many arguments provided to "+t+"().")
var i=e
...
if(s instanceof An)throw new T(S.INVALID_ARGUMENT,'Invalid query. You are trying to start or end a query using a document for which the field "'+a.field+'" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)')
if(null===s){var u=a.field.canonicalString()
throw new T(S.INVALID_ARGUMENT,"Invalid query. You are trying to start or end a query using a document for which the field '"+u+"' (used as the orderBy) does not exist.")}r.push(s)}}return new Jr(r,n)},t.prototype.boundFromFields=function(t,e,n){var i=this._query.explicitOrderBy
...
return new Rn(this.firestore._databaseId,n._key)}throw new T(S.INVALID_ARGUMENT,"Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: "+U(t)+".")},t.prototype.validateDisjunctiveFilterElements=function(t,e){if(!Array.isArray(t)||0===t.length)throw new T(S.INVALID_ARGUMENT,"Invalid Query. A non-empty array is required for '"+e.toString()+"' filters.")
...
return b(e.type===Ir.Added,"Invalid event type for first snapshot"),b(!r||n.query.docComparator(r,e.doc)<0,"Got added events in wrong order"),r=e.doc,{type:"added",doc:o,oldIndex:-1,newIndex:i++}})}var o=n.oldDocs
...
return t.isEmpty()?null:new Ao(new ht(t),this.firestore)},enumerable:!0,configurable:!0}),Object.defineProperty(e.prototype,"path",{get:function(){return this._query.path.canonicalString()},enumerable:!0,configurable:!0}),e.prototype.doc=function(t){if(O("CollectionReference.doc",arguments,0,1),0===arguments.length&&(t=z.newId()),L("CollectionReference.doc","non-empty string",1,t),""===t)throw new T(S.INVALID_ARGUMENT,"Document path must be a non-empty string")
var e=st.fromString(t)
...
if(K(t,e,["merge","mergeFields"]),q(t,"boolean","merge",e.merge),function(t,e,n,r,i){void 0!==r&&function(t,e,n,r,i){if(!(r instanceof Array))throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires its "+e+" option to be an array, but it was: "+U(r))
for(var o=0;o<r.length;++o)if(!i(r[o]))throw new T(S.INVALID_ARGUMENT,"Function "+t+"() requires all "+e+" elements to be "+n+", but the value at index "+o+" was: "+U(r[o]))}(t,e,n,r,i)}(t,"mergeFields","a string or a FieldPath",e.mergeFields,function(t){return"string"==typeof t||t instanceof ji}),void 0!==e.mergeFields&&void 0!==e.merge)throw new T(S.INVALID_ARGUMENT,"Invalid options passed to function "+t+'(): You cannot specify both "merge" and "mergeFields".')
return e}function qo(t,e){return void 0===e?{}:(K(t,e,["serverTimestamps"]),F(t,0,"serverTimestamps",e.serverTimestamps,["estimate","previous","none"]),e)}function Fo(t,e){P(t,"object",1,e),e&&(K(t,e,["source"]),F(t,0,"source",e.source,["default","server","cache"]))}function Vo(t,e,n){if(e instanceof Ao){if(e.firestore!==n)throw new T(S.INVALID_ARGUMENT,"Provided document reference is from a different Firestore instance.")
...
break
case h.ErrorCode.TIMEOUT:m(ta,'RPC "'+t+'" timed out'),a(new T(S.DEADLINE_EXCEEDED,"Request time out"))
break
...
if(r&&r.status&&r.message){var i=(u=r.status.toLowerCase().replace("_","-"),Object.values(S).indexOf(u)>=0?u:S.UNKNOWN)
a(new T(i,r.message))}else a(new T(S.UNKNOWN,"Server responded with status "+s.getStatus()))}else m(ta,'RPC "'+t+'" failed'),a(new T(S.UNAVAILABLE,"Connection failed."))
break
...
var i=r.status,o=function(t){var e=br[i]
if(void 0!==e)return Sr(e)}(),s=r.message
void 0===o&&(o=S.INTERNAL,s="Unknown error status: "+i+" with message "+r.message),u=!0,l.callOnClose(new T(o,s)),a.close()}else m(ta,"WebChannel received:",e),l.callOnMessage(e)}}),setTimeout(function(){l.callOnOpen()},0),l},t.prototype.makeUrl=function(t){var e=ea[t]
...
function oa(t){(function(t){t.INTERNAL.registerService("firestore",function(t){return new Do(t)},function(t){b(t&&"object"===r(t),"shallowCopy() expects object parameter.")
var e={}
for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])
return e}(Xo))})(t)}w.setPlatform(new ia),oa(a),e.registerFirestore=oa},194:function(t,e,n){"use strict"
...
return Array.prototype.unshift.apply(n,r),t.apply(e,n)}}return function(){return t.apply(e,arguments)}}function w(t,e,n){return(w=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?v:b).apply(null,arguments)}function E(t,e){var n=Array.prototype.slice.call(arguments,1)
...
e.removeEventListener?e.removeEventListener(n,r,t.capture):e.detachEvent?e.detachEvent(Et(n),r):e.addListener&&e.removeListener&&e.removeListener(r),(n=It(e))?(pt(n,t),0==n.b&&(n.src=null,e[yt]=null)):ft(t)}}}function Et(t){return t in gt?gt[t]:gt[t]="on"+t}function St(t,e){var n=t.listener,r=t.da||t.src
return t.Z&&wt(t),n.call(r,e)}function Tt(t,e){return!!t.X||St(t,rt?new st(e,this):e=new st(e||h("window.event"),this))}function It(t){return(t=t[yt])instanceof dt?t:null}var Ct="__closure_events_fn_"+(1e9*Math.random()>>>0)
...
var me=45e3,ye={},ge={}
function ve(t,e,n){t.F=1,t.f=Ke(xe(e)),t.l=n,t.H=!0,we(t,null)}function be(t,e,n,r){t.F=1,t.f=Ke(xe(e)),t.l=null,t.H=n,we(t,r)}function we(t,e){t.v=S(),Te(t),t.D=xe(t.f),Qe(t.D,"t",t.V),t.A=0,t.a=t.g.$(t.g.Y()?e:null),0<t.J&&(t.B=new Wt(w(t.Ka,t,t.a),t.J)),Ht(t.I,t.a,"readystatechange",t.eb),e=t.h?q(t.h):{},t.l?(t.w||(t.w="POST"),e["Content-Type"]="application/x-www-form-urlencoded",t.a.ca(t.D,t.w,t.l,e)):(t.w="GET",t.a.ca(t.D,t.w,null,e)),$t(1)}function Ee(t,e,n){for(var r=!0;!t.m&&t.A<n.length;){var i=Se(t,n)
if(i==ge){4==e&&(t.c=4,ee(14),r=!1)
break}if(i==ye){t.c=4,ee(15),r=!1
break}Ne(t,i)}4==e&&0==n.length&&(t.c=1,ee(16),r=!1),t.b=t.b&&r,r||(_e(t),De(t))}function Se(t,e){var n=t.A,r=e.indexOf("\n",n)
return-1==r?ge:(n=Number(e.substring(n,r)),isNaN(n)?ye:(r+=1)+n>e.length?ge:(e=e.substr(r,n),t.A=r+n,e))}function Te(t){t.R=S()+t.O,Ie(t,t.O)}function Ie(t,e){if(null!=t.i)throw Error("WatchDog timer not null")
...
break t}this.s=!0,Ne(this,s)}this.H?(Ee(this,e,o),G&&this.b&&3==e&&(Ht(this.I,this.P,"tick",this.cb),this.P.start())):Ne(this,o),4==e&&_e(this),this.b&&!this.m&&(4==e?this.g.na(this):(this.b=!1,Te(this)))}else 400==i&&0<o.indexOf("Unknown SID")?(this.c=3,ee(12)):(this.c=0,ee(13)),_e(this),De(this)}}}catch(t){}},i.cb=function(){if(this.a){var t=xn(this.a),e=this.a.aa()
this.A<e.length&&(Ce(this),Ee(this,t,e),this.b&&4!=t&&Te(this))}},i.cancel=function(){this.m=!0,_e(this)},i.bb=function(){this.i=null
var t=S()
...
return D(t.a.C(),function(t){e=e.concat(t.j)}),e}return N(t.c)}function En(){}function Sn(){this.a=new En}function Tn(t,e,n){var r=n||""
...
this.c=wn(this),this.b?(this.b.cancel(),this.b=null):this.a&&0!=this.a.a.c&&(D(this.a.C(),function(t){t.cancel()}),(t=this.a.a).b={},t.a.length=0,t.c=0)},En.prototype.stringify=function(t){return s.JSON.stringify(t,void 0)},En.prototype.parse=function(t){return s.JSON.parse(t,void 0)}
var Cn=s.JSON.parse
...
e=t.j,bn(this.b,t),n=1}if(this.m=t.o,0!=this.u)if(t.b)1==n?(e=S()-t.v,Jt.dispatchEvent(new ne(Jt,t.l?t.l.length:0,e,this.A)),Kn(this)):zn(this)
else{var r=t.c
